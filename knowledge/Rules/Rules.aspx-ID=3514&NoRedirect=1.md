# Psychic Duels - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3514&NoRedirect=1.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

[Source [Dark Archives (Remastered) pg. 200](../Source/Sources.aspx-ID=293.md)
...
[Finite](../Trait/Traits.aspx-ID=603.md)[Metamorphic](../Trait/Traits.aspx-ID=649.md)[Subjective Gravity](../Trait/Traits.aspx-ID=705.md)
...
- A participant can escape the duel by attaining a certain
- goal, ending it early as a draw. This is especially
- common in a duel between a powerful psychic and
- someone with weak psychic capabilities.
- Participants can leave the duel immediately if their
- physical body is disturbed or harmed.

## Initiative and Dueling Actions

Each duelist rolls initiative normally and proceeds in that initiative order, like a spellcasting duel rather than a combat duel. Each duelist can roll a [Deception](../Skill/Skills.aspx-ID=38.md), [Diplomacy](../Skill/Skills.aspx-ID=39.md), [Intimidation](../Skill/Skills.aspx-ID=40.md), or [Occultism](../Skill/Skills.aspx-ID=44.md) check instead of Perception. If the participant is trained at the skill they rolled for initiative, they gain the psychic center of that skill—a mental state corresponding to the skill. The GM might allow [Lore](../Skill/Skills.aspx-ID=41.md) skills for initiative in a psychic duel; these give the Occultism psychic center unless the GM determines otherwise. All participants gain the Psychic Defense reaction, which they can use while psychically centered. Its specific effect depends on the user's psychic center and using it expends the state. Each participant also has the Recenter action, which lets them change or assume a psychic center.

### Psychic Defense [reaction]

[Concentrate](../Trait/Traits.aspx-ID=561.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [Dark Archives (Remastered) pg. 201](../Source/Sources.aspx-ID=293.md)
...
- Empathic Orbit (Diplomacy) Displaying empathy, you sow doubt in your attacker to diminish their resolve for psychic combat. The opponent is [stupefied](../Condition/Conditions.aspx-ID=94.md) 1 until the end of their next turn or stupefied 2 if you're legendary in Diplomacy. You gain the benefit matching your psychic center against the triggering manifestation. Then your psychic center is expended.
...
- Rational Labyrinth (Occultism) Analytically breaking down the attack, you realign your mind's defenses into a puzzle designed to confound it. You gain a +2 status bonus to your Will save or Will DC, or a +4 status bonus if the effect has the [emotion](../Trait/Traits.aspx-ID=590.md) trait.
- Sensory Phantasm (Deception) Using your guile, you send psychic illusions through your mental link to your foe, making yourself harder to pinpoint. You're [concealed](../Condition/Conditions.aspx-ID=62.md) against the opponent until the end of its next turn.

### Recenter [one-action]

[Concentrate](../Trait/Traits.aspx-ID=561.md)
Source [Dark Archives (Remastered) pg. 201](../Source/Sources.aspx-ID=293.md)
...
Change Strike Damage: Though Strikes use their normal attribute modifiers to represent thoughtform versions of the attacker's prowess, any physical attribute modifier to damage is replaced with the attacker's highest mental attribute modifier. A creature stat block typically doesn't list a breakdown of its Strike damage, but the GM can find the difference between its Strength modifier and highest mental attribute modifier to adjust the damage.
...
Any creature in a psychic duel can cast two spells, both heightened to half the participant's level, rounded up. They can cast the [daze](../Spell/Spells.aspx-ID=1482.md) cantrip at will and get a second spell that can be cast once during the duel. They choose from the following when they roll initiative: [fear](../Spell/Spells.aspx-ID=1524.md), [phantom pain](../Spell/Spells.aspx-ID=1632.md), or a common summoning spell (typically [summon animal](../Spell/Spells.aspx-ID=1694.md), [summon construct](../Spell/Spells.aspx-ID=1696.md), [summon fey](../Spell/Spells.aspx-ID=1700.md), or summon lesser servitor for a 1st-rank spell). If the creature can't cast spells, they gain these as innate occult spells until the end of the psychic duel. If they can already cast spells, they add these to their other spells and temporarily gain any spell slots necessary to cast them (even if they can't cast spells of that rank yet) that can be used only for the additional spell. Natural psychic spells use the higher of the caster's spell DC or class DC for their spell DC, and that number – 10 for spell attack rolls.
...
Changing location is usually easy within a psychic duel, as a participant can move at the speed of thought. It typically takes only a single action to move to any location the participant wants and range of attacks and spells rarely matter much. You can usually run a psychic duel without a grid. Functions of positioning and movement still matter, but have a more flexible appearance. For instance, a participant can [Hide](../Action/Actions.aspx-ID=2404.md), but this likely means shaping the imaginary environment around them to create a visual screen, glowing phenomenon, or even psychic static. Likewise, spells that [immobilize](../Condition/Conditions.aspx-ID=81.md) or [grab](../Action/Actions.aspx-ID=2376.md) a creature can prevent the easy movement detailed above.

[<< Mindscape Statistics](./Rules.aspx-ID=3513.md)
