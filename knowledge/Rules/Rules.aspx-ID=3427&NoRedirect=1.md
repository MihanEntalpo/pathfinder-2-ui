# Designing Troops - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3427&NoRedirect=1.htm`
...
Source [Battlecry! pg. 170](../Source/Sources.aspx-ID=268.md)

While [swarms](../Trait/Traits.aspx-ID=707.md) work well for creatures that are particularly small or not especially intelligent, troops are an ideal way to portray tactical groupings of foes sized similarly to most PCs. In addition to the creature creation guidelines from GM Core, consider the following elements when building troops for your campaign.
