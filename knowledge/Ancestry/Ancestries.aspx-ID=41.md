# Azarketi - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=41.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Azarketi Details](./Ancestries.aspx-ID=41.md) | Azarketi Feats | Universal Ancestry Feats | Azarketi Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Azarketi](./Ancestries.aspx-ID=41.md)
...
[Alghollthu](../Language/Languages.aspx-ID=24.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Aklo](../Language/Languages.aspx-ID=13.md), [Aquan](../Language/Languages.aspx-ID=14.md), [Azlanti](../Language/Languages.aspx-ID=49.md), [Draconic](../Language/Languages.aspx-ID=2.md), [Elven](../Language/Languages.aspx-ID=4.md), and [Undercommon](../Language/Languages.aspx-ID=11.md) and any other languages to which you have access (such as the languages prevalent in your region).
