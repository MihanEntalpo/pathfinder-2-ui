# Dragon Turtle Armor - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4059.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Dragon Turtle ArmorItem 12

## This Item may contain spoilers from the Season of Ghosts Adventure Path

Uncommon Invested Magical
Source [Season of Ghosts (Hardcover) pg. 296](../Source/Sources.aspx-ID=294.md)
Price 2,000 gp
Usage worn armor; Bulk 4
Base Armor [Full Plate](../Armor/Armor.aspx-ID=50.md)

---

This [+1 resilient](./Equipment.aspx-ID=2804.md) [full plate](../Armor/Armor.aspx-ID=50.md) is crafted from the most colorful fragments chipped from scales of a dragon turtle’s shell, traditionally incorporating that motif in the form of a thicker, sturdier backplate. While wearing this armor, you aren’t [off-guard](../Condition/Conditions.aspx-ID=58.md) from creatures that [flank](../Rules/Rules.aspx-ID=2375.md) you, and you ignore the armor’s Speed penalty when you [Swim](../Action/Actions.aspx-ID=2381.md) and its check penalty to [Athletics](../Skill/Skills.aspx-ID=36.md) checks to Swim.
