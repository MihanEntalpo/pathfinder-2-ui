...
Source HTML: `docs/aonprd/Equipment.aspx-Category=23&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+item_subcategory+level+price+bulk+usage+spoilers.htm`
...
Source [Core Rulebook pg. 580](../Source/Sources.aspx-ID=1.md)
...
Quick display options: [Short](./Equipment.aspx-Category=23&sort=level-asc+price-asc+name-asc&display=short.md) | [Table](./Equipment.aspx-Category=23&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+item_subcategory+level+price+bulk+usage+spoilers.md)
