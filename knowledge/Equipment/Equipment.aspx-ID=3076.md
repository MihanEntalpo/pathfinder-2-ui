# Demon Mask - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3076.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Demon MaskItem 4+

[Invested](../Trait/Traits.aspx-ID=637.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 288](../Source/Sources.aspx-ID=218.md)
...
Activate—Leering Mask [two-actions] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Frequency once per day; Effect The mask casts a fear spell with a DC of 20.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Demon Mask (Greater)Item 10

Source [GM Core pg. 288](../Source/Sources.aspx-ID=218.md)
Price 900 gp
The mask grants a +2 item bonus. It casts 3rd-rank fear with a DC of 29.
