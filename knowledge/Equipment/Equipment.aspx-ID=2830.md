# Weapon Potency - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2830.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Weapon PotencyItem 2+
...
You can upgrade the weapon potency rune already etched on a weapon to a stronger version, increasing the values of the existing rune to those of the new rune. The Price of the upgrade is the difference between the two runes' prices.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Weapon Potency (+1)Item 2

Source [GM Core pg. 236](../Source/Sources.aspx-ID=218.md)
Price 35 gp
Craft Requirements You are an expert in Crafting.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Weapon Potency (+2)Item 10
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Weapon Potency (+3)Item 16
