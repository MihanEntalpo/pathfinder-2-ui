# Aqueous Orb - Spells - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Spells.aspx-ID=1443.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Aqueous Orb [two-actions] Spell 3

[Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) [Manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md) Water
Source [Player Core pg. 315](../Source/Sources.aspx-ID=216.md)
...
The creature can get free either by Swimming with a successful DC 10 [Athletics](../Skill/Skills.aspx-ID=36&Redirected=1.md) check or by Escaping against your spell DC. A freed creature exits the orb's space and can immediately breathe.
