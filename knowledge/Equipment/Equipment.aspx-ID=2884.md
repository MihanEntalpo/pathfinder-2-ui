# Cheetah's Elixir - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2884.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Cheetah's ElixirItem 1+
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Cheetah's Elixir (Lesser)Item 1

Source [GM Core pg. 246](../Source/Sources.aspx-ID=218.md)
Price 3 gp
The bonus is +5 feet, and the duration is 1 minute.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Cheetah's Elixir (Moderate)Item 5

Source [GM Core pg. 246](../Source/Sources.aspx-ID=218.md)
Price 25 gp
The bonus is +10 feet, and the duration is 10 minutes.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Cheetah's Elixir (Greater)Item 9
