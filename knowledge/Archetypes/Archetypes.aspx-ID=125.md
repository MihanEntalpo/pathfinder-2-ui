...
Source HTML: `docs/aonprd/Archetypes.aspx-ID=125.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Captivator](./Archetypes.aspx-ID=125.md)

### Legacy Content

Source [Grand Bazaar pg. 120](../Source/Sources.aspx-ID=100.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Captivator Dedication Feat 4

### Legacy Content

Archetype Dedication
Source [Grand Bazaar pg. 120](../Source/Sources.aspx-ID=100.md)
Archetype [Captivator](./Archetypes.aspx-ID=125.md)
Prerequisites Charisma 14; trained in [Deception](../Skill/Skills.aspx-ID=38&Redirected=1.md) or Diplomacy

---

Your ability to captivate others borders on the preternatural. You are seldom at a loss in social situations, and you can create minor [enchantments](../Trait/Traits.aspx-ID=61.md) or illusions. Choose Deception or Diplomacy. You become trained in that skill, or become an expert if you were already trained.

Choose two cantrips from the occult list; each cantrip must be from either the enchantment or illusion school. You gain access to the Cast a Spell activity and can cast these spells as occult innate spells. You're trained in occult spell attack rolls and spell DCs. If you have a hand free, you can usually replace material components with somatic components, so you don't need to use a spell [component pouch](../Equipment/Equipment.aspx-ID=33.md). Your key spellcasting ability for these spells is Charisma.

Special You can't select another dedication feat until you have gained two other feats from the captivator archetype.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Basic Captivator Spellcasting Feat 4
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Countercharm [reaction] Feat 8
...
Archetype [Captivator](./Archetypes.aspx-ID=125.md)
Prerequisites Basic Captivator Spellcasting
Trigger A creature Casts a Spell from the [enchantment](../Trait/Traits.aspx-ID=61.md) or illusion school.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Heightened Captivation Feat 8
...
You can infuse your [enchantments](../Trait/Traits.aspx-ID=61.md) and illusions with more power. Choose one of your spells granted by captivator archetype feats; this spell can't be from your highest level of non-cantrip captivator spells. The spell you choose is heightened to the highest level of captivator spell you can cast, not including cantrips. You can't later change the spell that is heightened by this feat.

Special You can select this feat more than once. Each time you select it, you choose a different spell.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Expert Captivator Spellcasting Feat 10
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Reactive Charm [reaction] Feat 10
...
You're so charming and distracting that when pressed, you can cast a simple enchantment in time to foil an attacker. You cast any of your 1st-level [enchantment](../Trait/Traits.aspx-ID=61.md) spells that normally take two actions or fewer to cast. This takes effect before the triggering spell or attack, and if the attacker is affected by your spell, it can make different decisions based on the effects (for instance, if you charm the attacker and it becomes friendly to you, it can choose a different target than you for its attack or spell). The attacking creature must be in range of your chosen spell, and if your spell requires targets, the attacking creature must be a valid target. Your spell affects only the attacking creature, even if it would normally affect more targets or an area.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Effortless Captivation [free-action] Feat 14
...
You maintain your innate [enchantments](../Trait/Traits.aspx-ID=61.md) and illusions with hardly a thought. You immediately gain the effects of the Sustain a Spell action, which you can use only to extend the duration of an enchantment or illusion spell.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Master Captivator Spellcasting Feat 16
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Look Again [one-action] Feat 18
