# Precious Material Shields - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=28&Subcategory=29.htm`
...
Source [Core Rulebook pg. 586](../Source/Sources.aspx-ID=1.md)
...
Click here for the full rules on Precious Material Shields.
