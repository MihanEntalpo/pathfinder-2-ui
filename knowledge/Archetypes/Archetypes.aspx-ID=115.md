# Artillerist - Archetypes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Archetypes.aspx-ID=115.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Artillerist](./Archetypes.aspx-ID=115.md)
...
Source [Guns & Gears pg. 128](../Source/Sources.aspx-ID=98.md)
...
By loading special ammunition in a particular way, you can make your [siege weapons](../SiegeWeapons/SiegeWeapons.aspx.md) do all manner of tricks that other siege engineers can barely even imagine. If you personally contribute an additional Load action to the siege weapon's loading, above the minimum, you can change a burst into a line twice as long as the size of the burst, or vice versa (so a 10-foot burst turns into a 20-foot line, or a 20-foot line turns into a 10-foot burst).

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Field Artillery [one-action] Feat 6

Archetype
Source [Guns & Gears pg. 129](../Source/Sources.aspx-ID=98.md)
Archetypes [Artillerist](./Archetypes.aspx-ID=115.md), [Munitions Master](./Archetypes.aspx-ID=329.md)
Prerequisites expert in Crafting

---

While castles are generally obliging enough to stay in one place, out in the field positioning is of paramount importance—a gun in the wrong place is worse than useless. You can Interact with an adjacent mounted [siege weapon](../SiegeWeapons/SiegeWeapons.aspx.md) to increase its Speed by 10 feet for one round.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Live Ammunition Feat 8
...
What you don't know about artillery isn't worth knowing and your mastery allows you to perform an impossible number of actions as part of a [siege weapon](../SiegeWeapons/SiegeWeapons.aspx.md)'s crew. You're permanently quickened. You can only use the extra action to Aim or Launch a siege weapon.
