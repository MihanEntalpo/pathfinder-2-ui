# Dawnsilver Armor - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2799.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Dawnsilver ArmorItem 12+
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Dawnsilver Armor (Standard-Grade)Item 12

Source [GM Core pg. 228](../Source/Sources.aspx-ID=218.md)
Price 1,600 gp (+160 gp per Bulk)
The initial raw materials must include dawnsilver worth at least 200 gp + 20 gp per Bulk.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Dawnsilver Armor (High-Grade)Item 19

Source [GM Core pg. 228](../Source/Sources.aspx-ID=218.md)
Price 32,000 gp (+3,200 gp per Bulk)
The initial raw materials must include dawnsilver worth at least 16,000 gp + 1,600 gp per Bulk.
