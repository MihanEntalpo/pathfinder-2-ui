# Grafts - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=114.htm`
...
Source [Howl of the Wild pg. 97](../Source/Sources.aspx-ID=226.md)
Grafts are living tissues that are implanted into a host, where they integrate with the hosts’ native biology.

Click here for the full rules on Grafts.
