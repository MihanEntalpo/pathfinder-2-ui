# Tanuki - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=90.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Tanuki Details](./Ancestries.aspx-ID=90.md) | Tanuki Feats | Universal Ancestry Feats | Tanuki Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Tanuki](./Ancestries.aspx-ID=90.md)

javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Tanuki01.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Tanuki01.webp%27javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Tanuki02.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Tanuki02.webp%27[Uncommon](../Trait/Traits.aspx-ID=721.md) [Humanoid](../Trait/Traits.aspx-ID=628.md) [Tanuki](../Trait/Traits.aspx-ID=830.md)
Source [Tian Xia Character Guide pg. 65](../Source/Sources.aspx-ID=230.md)
[PFS Note](../PFS/PFS.aspx.md) While several tanuki feats allow characters to disguise themselves as inanimate objects, doing so does not change a character’s mechanical statistics, such as AC or defenses.

A name for both a raccoon-like animal native to Minkai and sapient tanuki who possess shapeshifting powers. They are [common](../Trait/Traits.aspx-ID=557.md) in Minkai, the
Forest of Spirits, and Goka.
...
[Tanuki](../Language/Languages.aspx-ID=179.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Elven](../Language/Languages.aspx-ID=158.md), [Fey](../Language/Languages.aspx-ID=119.md), [Gnomish](../Language/Languages.aspx-ID=159.md), [Goblin](../Language/Languages.aspx-ID=160.md), [Kitsune](../Language/Languages.aspx-ID=86.md), [Tengu](../Language/Languages.aspx-ID=47.md), and any other languages to which you have access (such as the languages prevalent in your region).

## Change Shape

[one-action] ([concentrate](../Trait/Traits.aspx-ID=561.md), [polymorph](../Trait/Traits.aspx-ID=670.md), [primal](../Trait/Traits.aspx-ID=676.md), [tanuki](../Trait/Traits.aspx-ID=830.md)) You can transform into a mundane raccoon dog, using the statistics of [pest form](../Spell/Spells.aspx-ID=1626.md). This is a specific raccoon dog form that's the same age and body type as your true form and has roughly analogous physical traits, such as hair color. Using Change Shape counts as creating a disguise for the [Impersonate](../Action/Actions.aspx-ID=2388.md) use of [Deception](../Skill/Skills.aspx-ID=38.md). You lose any unarmed Strikes you gained from a tanuki heritage or ancestry feat in this form. You can remain in your raccoon dog form indefinitely, and you can shift back to your tanuki form by using this action again.
