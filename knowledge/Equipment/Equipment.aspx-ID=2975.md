# Fear Gem - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2975.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Fear GemItem 4

[Consumable](../Trait/Traits.aspx-ID=564.md) [Emotion](../Trait/Traits.aspx-ID=590.md) [Fear](../Trait/Traits.aspx-ID=598.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Mental](../Trait/Traits.aspx-ID=647.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
Source [GM Core pg. 264](../Source/Sources.aspx-ID=218.md)
Price 20 gp
Usage affixed to a weapon; Bulk &mdash;
Activate [two-actions] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md))
