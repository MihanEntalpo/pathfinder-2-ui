# Crowbar - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2718.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)CrowbarItem 0+
...
When Forcing Open an object that doesn't have an easy grip, a crowbar makes it easier to gain the necessary leverage. Without a crowbar, prying something open takes a –2 item penalty to the [Athletics](../Skill/Skills.aspx-ID=36&Redirected=1.md) check to Force Open.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Crowbar (Levered)Item 3
