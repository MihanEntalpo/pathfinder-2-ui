# Wolf Fang - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2998.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Wolf FangItem 1

[Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Wolf_Fang.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Wolf_Fang.webp%27Source [GM Core pg. 267](../Source/Sources.aspx-ID=218.md)
Price 4 gp
Usage affixed to armor; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger You successfully Trip a foe
