# Propulsive Leap - Feats - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Feats.aspx-ID=8029.htm`
...
# [Propulsive Leap](./Feats.aspx-ID=8029.md) [one-action] Feat 10

## This Feat may contain spoilers from the Gatewalkers Adventure Path

Rare Deviant Magical
Source [Gatewalkers Player's Guide (Remastered) pg. 10](../Source/Sources.aspx-ID=287.md), [Dark Archives (Remastered) pg. 101](../Source/Sources.aspx-ID=293.md)
...
Awakening You can use your propulsion as a makeshift weapon. The first time each round you Fly starting from the ground, all creatures adjacent to you take 1d4 damage for every 2 levels you have, with a [basic](../Rules/Rules.aspx-ID=2297.md) Reflex save.
