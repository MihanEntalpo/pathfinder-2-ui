...
Source HTML: `docs/aonprd/Rules.aspx-ID=2221.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

[>](./Rules.aspx-ID=2263.md)

# [Chapter 7: Spells](./Rules.aspx-ID=2221.md)

Source [Player Core pg. 297](../Source/Sources.aspx-ID=216.md)
...
## [Spell Slots](./Rules.aspx-ID=2222.md)
...
Each prepared spell is expended after a single casting, so if you want to cast a particular spell more than once in a day, you need to prepare that spell multiple times. The exception to this rule is for spells with the [cantrip](../Trait/Traits.aspx-ID=550.md) trait; once you prepare a cantrip, you can cast it as many times as you want until the next time you prepare spells.
...
## [Cantrips](./Rules.aspx-ID=2227.md)
...
## [Focus Spells](./Rules.aspx-ID=2228.md)
...
## [Casting Spells](./Rules.aspx-ID=2233.md)
...
A spell with the subtle trait can be cast without incantations and doesn't have obvious manifestations. Most of these spells enhance your subterfuge or stealth, such as invisibility. Some abilities, like the [Conceal Spell](../Feat/Feats.aspx-ID=4997.md) feat, allow you to make spells subtle even if they wouldn't normally be.
