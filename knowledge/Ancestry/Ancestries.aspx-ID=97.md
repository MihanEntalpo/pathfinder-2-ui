# Reflection - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=97.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Reflection Details](./Ancestries.aspx-ID=97.md) | Reflection Feats | Universal Ancestry Feats

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Reflection](./Ancestries.aspx-ID=97.md) ([Versatile Heritage](../Heritage/Heritages.aspx-ID=428.md))

[Rare](../Trait/Traits.aspx-ID=683.md) [Reflection](../Trait/Traits.aspx-ID=902.md)
Source [Dark Archives (Remastered) pg. 119](../Source/Sources.aspx-ID=293.md)
[PFS Note](../PFS/PFS.aspx.md) Characters with the Reflection versatile heritage may not be a Reflection of any known and named NPC in Pathfinder canon. Your appearance may be used to strengthen your character’s story and roleplay, but cannot be used to impact gameplay during Organized Play adventures.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)[Reflection](../Heritage/Heritages.aspx-ID=428.md)

Source [Dark Archives (Remastered) pg. 120](../Source/Sources.aspx-ID=293.md)
Ancestry Page [Reflection](./Ancestries.aspx-ID=97.md)
You were created as a duplicate of another creature, intentionally or accidentally, though you might not know of your origins. Other than a minor mark or two, you look just like your progenitor. You gain the [reflection](../Trait/Traits.aspx-ID=902.md) trait, in addition to the traits from your ancestry. You don't need to attempt Deception checks to [Impersonate](../Action/Actions.aspx-ID=2388.md) your progenitor unless you're interacting with people who know them personally or you do something known to be out of character for them. The GM might require you to roll a Deception check in other circumstances, such as if you're mirror-risen and interacting with someone who has seen an accurate likeness of your progenitor and might notice a distinguishing feature on the reverse side. You can choose from reflection feats and feats from your ancestry whenever you gain an ancestry feat.
