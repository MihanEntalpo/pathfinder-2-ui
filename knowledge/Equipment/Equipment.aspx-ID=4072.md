# Taljjae Tassel - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4072.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Taljjae TasselItem 10

## This Item may contain spoilers from the Season of Ghosts Adventure Path

Uncommon Consumable Magical Talisman
Source [Season of Ghosts (Hardcover) pg. 299](../Source/Sources.aspx-ID=294.md)
Price 160 gp
Usage affixed to a weapon; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561.md)) Trigger Your Strike with the affixed weapon was a critical success.

---

The bright red tassels of the creature known as Taljjae are a ubiquitous motif in Hwanggot and are used as charms to pray for good fortune and reward for great effort. They adorn clothing, weapons, and even drinking gourds. These particular tassels carry within them a potent fraction of the mysterious fey’s power. When you activate a Taljjae tassel, your weapon gains the properties of the [grievous](./Equipment.aspx-ID=2841.md) rune for the duration of the triggering attack.
