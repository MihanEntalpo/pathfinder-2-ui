# Building Skirmish Encounters - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3453&NoRedirect=1.htm`
...
Source [Battlecry! pg. 163](../Source/Sources.aspx-ID=268.md)
...
- [Fiends](../Trait/Traits.aspx-ID=600.md) are attacking a holy site, and the PCs must keep them from desecrating it. Allied [clerics](../Class/Classes.aspx-ID=33.md) can seal one of four doorways each round, and the PCs can choose the order in which they do it. If all four doors are sealed, the site is safe and the objective met!
- Enemy [troops](../Trait/Traits.aspx-ID=849.md) are trying to reach a teleportation portal to join a siege of a major city. The PCs must block a narrow mountain pass to delay them until the portal has closed. Blocking any of the enemy troops is a partial success toward the objective, but the more they stop, the safer the city will be.
...
- [Troops](../Trait/Traits.aspx-ID=849.md) are stationed at the estate of a powerful political figurehead. Get past the guards and assassinate this leader.
...
- [Siege engines](../Trait/Traits.aspx-ID=457.md) are laying waste to allied forces and keeping them holed up in a crumbling castle. Disable or destroy the siege engines to give your allies the chance to rush forward and take the fight to the enemy.
...
Despite all the focus on [troops](../Trait/Traits.aspx-ID=849.md) versus troops, non-troop monsters still work in skirmish encounters, so you might throw in a manticore, dragon, or other creature for more variety. They can add surprise tactics and shake up the expected style of the encounter, and they don’t have the same weaknesses to troops’ offensive abilities that other troops do. Creatures that can [Fly](../Action/Actions.aspx-ID=2312.md), [Burrow](../Action/Actions.aspx-ID=2310.md), or use other movement modes are especially useful. Individual humanoids, especially Medium or smaller creatures, are usually a poor addition to the encounter unless they’re leading a troop.
