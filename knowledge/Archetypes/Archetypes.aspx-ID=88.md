# Ghost Hunter - Archetypes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Archetypes.aspx-ID=88.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Ghost Hunter](./Archetypes.aspx-ID=88.md)

### Legacy Content

Source [Pathfinder #163: Ruins of Gauntlight pg. 81](../Source/Sources.aspx-ID=71.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Ghost Hunter Dedication Feat 2
...
Source [Pathfinder #163: Ruins of Gauntlight pg. 81](../Source/Sources.aspx-ID=71.md)
Archetype [Ghost Hunter](./Archetypes.aspx-ID=88.md)
...
Choose two cantrips from the occult spell list. Each cantrip must have the [divination](../Trait/Traits.aspx-ID=47.md), [enchantment](../Trait/Traits.aspx-ID=61.md), or [necromancy](../Trait/Traits.aspx-ID=117.md) trait. You can cast these spells as innate occult spells. You gain access to the Cast a Spell activity if you didn't have it already. You're trained in occult spell attack rolls and spell DCs. You can usually replace material components with somatic components, so you don't need a spell component pouch. Your key spellcasting ability for these spells is Charisma.

Special You can't select another dedication feat until you have gained two other feats from the ghost hunter archetype.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Grave's Voice Feat 4
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Investigate Haunting Feat 4
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Spirit Spells Feat 4
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Peer Beyond Feat 8
