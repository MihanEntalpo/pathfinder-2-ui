# Armor - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=198&NoRedirect=1.htm`
...
Source [Core Rulebook pg. 274](../Source/Sources.aspx-ID=1.md)
...
| Cloth (explorer’s clothing, padded armor)
| 1
| 4
| 2

| Leather (hide, leather, studded leather)
| 4
| 16
| 8

| Metal (breastplate, chain mail, chain shirt, full plate, half plate, scale mail, splint mail)
| 9
| 36
| 18
...
Armor can a number of traits, found under "Armor Traits" in the [Traits](../Trait/Traits.aspx.md) section.

### Armor Specialization Effects

Certain class features can grant you additional benefits with certain armors. This is called an armor specialization effect. The exact effect depends on which armor group your armor belongs to, as listed below. Only medium and heavy armors have armor specialization effects. See [here](../ArmorGroups/ArmorGroups.aspx.md) for details on each armor specialization effect.
