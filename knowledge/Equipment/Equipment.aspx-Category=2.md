# Services - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=2.htm`
...
Source [Core Rulebook pg. 294](../Source/Sources.aspx-ID=1.md)
The services listed on Table 6–14 describe expenditures for common services and consumables.

Click here for the full rules on Services.
