# Command an Animal - Actions - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Actions.aspx-ID=2400.htm`

# [Actions](./Actions.aspx.md) | [Activities](./Activities.aspx.md)

---

# [Command an Animal](./Actions.aspx-ID=2400.md) [one-action]

[Auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md) [Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)
Source [Player Core pg. 242](../Source/Sources.aspx-ID=216.md)
Skill [Nature (Untrained)](../Skill/Skills.aspx-ID=43.md)
...
You automatically fail if the animal is hostile or unfriendly to you. If the animal is helpful to you, increase your degree of success by one step. You might be able to Command an Animal more easily with a feat like Ride. Most animals know the Drop Prone, Leap, Seek, Stand, [Stride](./Actions.aspx-ID=2305&Redirected=1.md), and [Strike](./Actions.aspx-ID=2306&Redirected=1.md) basic actions. If an animal knows an activity, such as a horse's Gallop, you can Command the Animal to perform the activity, but you must spend as many actions on Command an Animal as the activity's number of actions. You can also spend multiple actions to Command the Animal to perform that number of basic actions on its next turn; for instance, you could spend 3 actions to Command an Animal to Stride three times or to Stride twice and then make a Strike.
...
If you have a pet, [animal companion](../Rules/Rules.aspx-ID=2113.md), [familiar](../Rules/Rules.aspx-ID=2121.md), or similar minion, you can command it much more effectively.
