# Behold the Weave - Spells - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Spells.aspx-ID=2601.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Behold the Weave [two-actions] Spell 3

[Concentrate](../Trait/Traits.aspx-ID=561.md) [Incapacitation](../Trait/Traits.aspx-ID=631.md) [Manipulate](../Trait/Traits.aspx-ID=645.md) [Prediction](../Trait/Traits.aspx-ID=674.md)
Source [Dark Archives (Remastered) pg. 181](../Source/Sources.aspx-ID=293.md)
Traditions [divine](./Spells.aspx-Tradition=2.md), [occult](./Spells.aspx-Tradition=3.md)
