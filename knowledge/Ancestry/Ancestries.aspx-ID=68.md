# Nephilim - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=68.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Nephilim Details](./Ancestries.aspx-ID=68.md) | Nephilim Feats | Universal Ancestry Feats

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Nephilim](./Ancestries.aspx-ID=68.md) ([Versatile Heritage](../Heritage/Heritages.aspx-ID=280.md))

javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Nephilim01.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Nephilim01.webp%27javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Nephilim02.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Nephilim02.webp%27[Uncommon](../Trait/Traits.aspx-ID=721.md) [Nephilim](../Trait/Traits.aspx-ID=518.md)
Source [Player Core pg. 78](../Source/Sources.aspx-ID=216.md)
[PFS Note](../PFS/PFS.aspx.md) All Pathfinder agents have access this heritage. The nephilim trait is interchangeable with either the aasimar or tiefling trait and vice versa, but aasimar characters may not treat that trait as interchangeable with the tiefling trait (or vice versa).
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)[Nephilim](../Heritage/Heritages.aspx-ID=280.md)

Uncommon
Source [Player Core pg. 78](../Source/Sources.aspx-ID=216.md)
Ancestry Page [Nephilim](./Ancestries.aspx-ID=68.md)
