# Disguise Kit - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2720.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Disguise KitItem 0+

Source [Player Core pg. 288](../Source/Sources.aspx-ID=216.md)
Price 2 gp
Hands 2; Bulk L

---

This small wooden box contains cosmetics, false facial hair, spirit gum, and a few simple wigs. You usually need a disguise kit to set up a disguise in order to Impersonate someone using the [Deception](../Skill/Skills.aspx-ID=38&Redirected=1.md) skill. If you've crafted a large number of disguises, you can replenish your cosmetics supply with replacement cosmetics suitable for the type of your disguise kit. You can draw and replace a worn disguise kit as part of the action that uses it.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Disguise Kit (Replacement Cosmetics)Item 0

Source [Player Core pg. 288](../Source/Sources.aspx-ID=216.md)
Price 1 sp

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Disguise Kit (Elite)Item 3
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Disguise Kit (Elite Cosmetics)Item 3
