# Wands - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=34.htm`
...
Source [Core Rulebook pg. 597](../Source/Sources.aspx-ID=1.md)
...
Click here for the full rules on Wands.
