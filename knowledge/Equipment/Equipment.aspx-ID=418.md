# Brooch of Shielding - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=418.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Brooch of ShieldingItem 2

### Legacy Content

Uncommon [Abjuration](../Trait/Traits.aspx-ID=2.md) Invested Magical
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Brooch_of_Shielding.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Brooch_of_Shielding.webp%27Source [Core Rulebook pg. 607](../Source/Sources.aspx-ID=1.md)
Price 30 gp
