# Arboreal Boots - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3056.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Arboreal BootsItem 5+

[Invested](../Trait/Traits.aspx-ID=637.md) [Primal](../Trait/Traits.aspx-ID=676.md)
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Boots_of_Elvenkind.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Boots_of_Elvenkind.webp%27Source [GM Core pg. 285](../Source/Sources.aspx-ID=218.md)
...
Source [GM Core pg. 285](../Source/Sources.aspx-ID=218.md)
Price 160 gp

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Arboreal Boots (Greater)Item 9

Source [GM Core pg. 285](../Source/Sources.aspx-ID=218.md)
Price 700 gp
The boots grant a +2 bonus. You also gain a 10-foot climb Speed while climbing plants or fungi and don't need to use your hands to Climb them.
