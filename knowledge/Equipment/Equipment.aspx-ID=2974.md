# Fade Band - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2974.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Fade BandItem 12
...
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger An attack misses you; Requirements You are trained in Stealth

---

This thin, silvery wire wraps around your armor. When you activate the band, it casts a 2nd-rank [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md) spell on you.
