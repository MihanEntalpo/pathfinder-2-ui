# Coerce - Actions - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Actions.aspx-ID=2394.htm`

# [Actions](./Actions.aspx.md) | [Activities](./Activities.aspx.md)

---

# [Coerce](./Actions.aspx-ID=2394.md)

[Auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md) [Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) Emotion [Exploration](../Trait/Traits.aspx-ID=595.md) Linguistic Mental
Source [Player Core pg. 240](../Source/Sources.aspx-ID=216.md)
Skill [Intimidation (Untrained)](../Skill/Skills.aspx-ID=40.md)
...
Your influence on NPCs is measured with a set of attitudes that reflect how they view your character. These are only a brief summary of a creature's disposition. The GM will supply additional nuance based on the history and beliefs of the characters you're interacting with, and their attitudes can change in accordance with the story. The attitudes are detailed in the [Conditions Appendix](../Rules/Rules.aspx-ID=2455.md) and are summarized here.
