# Vanishing Coin - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2996.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Vanishing CoinItem 10

[Consumable](../Trait/Traits.aspx-ID=564.md) [Illusion](../Trait/Traits.aspx-ID=629.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
Source [GM Core pg. 267](../Source/Sources.aspx-ID=218.md)
Price 160 gp
Usage affixed to armor; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger You attempt a Stealth check for initiative, but you haven't rolled yet; Requirements You are trained in Stealth

---

This copper coin dangles from a leather strip strung through a hole drilled in the center. Until activated, the coin becomes invisible for a few seconds at random intervals every few minutes. When you activate the coin, it casts a 2nd-rank [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md) spell on you, lasting until the end of your next turn.
