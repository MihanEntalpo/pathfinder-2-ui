# Centaur - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=73.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Centaur Details](./Ancestries.aspx-ID=73.md) | Centaur Feats | Universal Ancestry Feats | Centaur Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Centaur](./Ancestries.aspx-ID=73.md)

javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Centaur01.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Centaur01.webp%27javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Centaur02.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Centaur02.webp%27Uncommon Beast [Centaur](../Trait/Traits.aspx-ID=747.md) Humanoid
Source [Howl of the Wild pg. 29](../Source/Sources.aspx-ID=226.md)
Centaurs are half-human, half-horse nomads who range wild and free across their ancestral lands. They're survivalists with a long history of teaching and instruction who stand firm in the face of danger using their skill at archery, herbalism, and magic.
...
The beliefs of a centaur often depend on where and how they were raised. Many centaurs follow the [Green Faith](../Deity/Deities.aspx-ID=298.md) or worship deities who share their respect for nature, such as Cernunnos, [Erastil](../Deity/Deities.aspx-ID=282.md), or [Gozreh](../Deity/Deities.aspx-ID=284.md). Others feel kinship with [Desna](../Deity/Deities.aspx-ID=281.md), goddess of travel. Healers and herbalists favor Immonhiel or [Pharasma](../Deity/Deities.aspx-ID=290.md). In urban areas, Kurgess and [Gorum](../Deity/Deities.aspx-ID=283.md) are favorites, depending on the centaur's temperament and profession.
...
[Fey](../Language/Languages.aspx-ID=119.md)
Additional languages equal to your Intelligence modifier (if positive). Choose from [Arboreal](../Language/Languages.aspx-ID=26.md), [Cyclops](../Language/Languages.aspx-ID=30.md), [Dwarven](../Language/Languages.aspx-ID=157.md), [Elven](../Language/Languages.aspx-ID=158.md), [Gnomish](../Language/Languages.aspx-ID=159.md), [Halfling](../Language/Languages.aspx-ID=161.md), [Jotun](../Language/Languages.aspx-ID=162.md) and any other languages to which you have access (such as the languages prevalent in your region).
