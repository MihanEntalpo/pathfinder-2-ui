# Intimidating Glare - Feats - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Feats.aspx-ID=5162.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Intimidating Glare](./Feats.aspx-ID=5162.md) Feat 1

General Skill
Source [Player Core pg. 257](../Source/Sources.aspx-ID=216.md)

Prerequisites trained in Intimidation

---

You can [Demoralize](../Action/Actions.aspx-ID=2395.md) with a mere glare. When you do, Demoralize loses the [auditory](../Trait/Traits.aspx-ID=541.md) trait and gains the [visual](../Trait/Traits.aspx-ID=727.md) trait, and you don’t take a penalty if the creature doesn’t understand your language.
