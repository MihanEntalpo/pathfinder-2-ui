# Whisper of the First Lie - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3118.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Whisper of the First LieItem 20

[Rare](../Trait/Traits.aspx-ID=683.md) [Invested](../Trait/Traits.aspx-ID=637.md) [Magical](../Trait/Traits.aspx-ID=644.md)
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Whisper_of_the_First_Lie.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Whisper_of_the_First_Lie.webp%27Source [GM Core pg. 297](../Source/Sources.aspx-ID=218.md)
Price 60,000 gp
...
Activate—Release the Lie [three-actions] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md), [manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Effect You unstopper the vial and release the lie, creating the effect of a fabricated truth (DC 47). The vial is emptied and can never be activated again.
