# Champion - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=58.htm`
...
## [Champion Details](./Classes.aspx-ID=58.md) | [Champion Feats](../Feat/Feats.aspx-Traits=24.md) | Champion Focus Spells | Champion Kits | Champion Sample Builds | [Causes](../Causes/Causes.aspx.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Champion

Source [Player Core 2 pg. 86](../Source/Sources.aspx-ID=227.md)
...
[Flourish](../Trait/Traits.aspx-ID=606.md): Actions with the flourish trait are special techniques that require too much exertion for you to perform frequently. You can use only one action with the flourish trait per round.

[Sanctified](../Trait/Traits.aspx-ID=519.md): If you are holy or unholy, your sanctified actions and spells gain the same trait.
...
Trained in [Religion](../Skill/Skills.aspx-ID=46.md)
...
As a champion, you are a warrior in the name of a deity you revere above all others. The most common [deities](../Deity/Deities.aspx.md) in Pathfinder have edicts, areas of concern, and the benefits you get for being a devotee of that deity. Choose one [deity](../Deity/Deities.aspx.md).
...
If you perform enough acts that are anathema to your deity, you lose the magical abilities that come from your connection to your deity. The class features that you lose are determined by the GM, but they likely include your holy or unholy trait, your focus pool, and your blessing of the devoted. These abilities can be regained only if you repent by conducting an [atone](../Ritual/Rituals.aspx-ID=108.md) ritual. If your deity doesn't require the specific sanctification you had, your GM might let you retrain your sanctification and cause while still following the same deity.

### Sanctification

Depending on your deity, their sanctification can make you [holy](../Trait/Traits.aspx-ID=517.md) or [unholy](../Trait/Traits.aspx-ID=521.md). This commits you to one side of a struggle over souls. Whether you become holy, unholy, or neither will limit your choice of causes, devotion spells, and feats.
...
You're surrounded by an aura in a 15-foot emanation. It has the [aura](../Trait/Traits.aspx-ID=542.md) and [divine](../Trait/Traits.aspx-ID=579.md) traits. Any follower of your deity within the aura immediately knows you're a champion of your deity. This aura is used as the range for your champion's reaction and for various other effects. You can suppress or resume the aura as a single action, which has the [concentrate](../Trait/Traits.aspx-ID=561.md) trait, and it ends if you fall unconscious.
...
Causes can be found [here](../Causes/Causes.aspx.md).
...
[Focus spells](../Rules/Rules.aspx-ID=2228.md) are automatically heightened to half your level rounded up. Certain feats give you more focus spells. The maximum Focus Points your focus pool can hold is equal to the number of focus spells you have, but can never be more than 3 points.
...
You gain the [Shield Block](../Feat/Feats.aspx-ID=5212.md) general feat, a reaction that lets you reduce damage with your shield.
...
Blessed Armament: Select one weapon or [handwraps of mighty blows](../Equipment/Equipment.aspx-ID=3086.md). You gain that armament's critical specialization effect, and you grant the armament a property rune of your choice from the following list: [fearsome](../Equipment/Equipment.aspx-ID=2837.md), [ghost touch](../Equipment/Equipment.aspx-ID=2840.md), [returning](../Equipment/Equipment.aspx-ID=2845.md), [shifting](../Equipment/Equipment.aspx-ID=2846.md), or [vitalizing](../Equipment/Equipment.aspx-ID=2852.md). During your daily preparations, you can change the spirit to inhabit a different armament, grant a different rune, or both.

Blessed Shield: In your hands, a shield gains the minor [reinforcing](../Equipment/Equipment.aspx-ID=2811.md) rune. As you go up in level, the shield gains the reinforcing rune of your level (lesser at 7th level, moderate at 10th level, greater at 13th level, major at 16th level, and supreme at 19th level). If your shield already has the appropriate reinforcing rune for your level, or if it's a [sturdy shield](../Equipment/Equipment.aspx-ID=2828.md) of the same level as the appropriate reinforcing rune, the shield's Hardness instead increases by 1.
