# Predator's Claw - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2990.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Predator's ClawItem 1
...
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger You critically succeed at an attack roll with the affixed weapon.
