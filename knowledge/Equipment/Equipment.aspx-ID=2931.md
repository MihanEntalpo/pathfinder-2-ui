# Nectar of Purification - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2931.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Nectar of PurificationItem 1

[Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Oil](../Trait/Traits.aspx-ID=663.md)
...
A shimmering liquid, nectar of purification is often stored in bottles similar to those used for vinegar. This oil casts a 1st- rank [cleanse cuisine](../Spell/Spells.aspx-ID=1468.md) spell over any food or drink onto which it's poured. The nectar evaporates as it takes effect, leaving the taste and texture of the food or drink unaltered.
