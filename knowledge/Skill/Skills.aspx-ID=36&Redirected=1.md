...
Source HTML: `docs/aonprd/Skills.aspx-ID=36&Redirected=1.htm`
...
# [Athletics (Str)](./Skills.aspx-ID=36.md)

Source [Player Core pg. 234](../Source/Sources.aspx-ID=216.md)
Athletics allows you to perform deeds of physical prowess. Most Athletics actions let you move about the environment (Climb, [High Jump](../Action/Actions.aspx-ID=2377&Redirected=1.md), [Long Jump](../Action/Actions.aspx-ID=2378&Redirected=1.md), Swim) or control your opponent's movement in combat ([Grapple](../Action/Actions.aspx-ID=2376&Redirected=1.md), Reposition, Shove, Trip, and Disarm). Escape: When you use the Escape basic action, you can use your Athletics modifier instead of your unarmed attack modifier.

Item Bonuses

### Related Feats

To see a list of Feats related to Athletics, [click here](../Feat/Feats.aspx-Traits=144&Skill=Athletics.md).

# Athletics Untrained Actions

## [Climb](../Action/Actions.aspx-ID=2374.md) [one-action]
...
When you fall more than 5 feet, you take falling damage when you land, which is bludgeoning damage equal to half the distance you fell. If you take any damage from a fall, you're knocked prone when you land. You can [Grab an Edge](../Action/Actions.aspx-ID=2313.md) as a reaction to reduce or eliminate the damage from some falls. More detailed rules for falling damage appear here.

## [Force Open](../Action/Actions.aspx-ID=2375.md) [one-action]
...
Using your body, a lever, or some other tool, you attempt to forcefully open a door, window, container or heavy gate. With a high enough result, you can even smash through walls. Without a crowbar, prying something open takes a –2 item penalty to the [Athletics](./Skills.aspx-ID=36&Redirected=1.md) check to Force Open.
...
## [Grapple](../Action/Actions.aspx-ID=2376.md) [one-action]

[Attack](../Trait/Traits.aspx-ID=540&Redirected=1.md)
Source [Player Core pg. 235](../Source/Sources.aspx-ID=216.md)
Requirements You have at least one free hand and your target is no more than one size larger than you.

---

Attempt an [Athletics](./Skills.aspx-ID=36&Redirected=1.md) check against the target's Fortitude DC. You can Grapple a target you already have [grabbed](../Condition/Conditions.aspx-ID=77&Redirected=1.md) or [restrained](../Condition/Conditions.aspx-ID=90&Redirected=1.md) without having a hand free.
...
Critical Failure If you already had the target grabbed or restrained, it breaks free. Your target can either grab you, as if it succeeded at using the Grapple action against you, or force you to fall and land [prone](../Condition/Conditions.aspx-ID=88&Redirected=1.md).

## [High Jump](../Action/Actions.aspx-ID=2377.md) [two-actions]
...
Critical Failure You make a normal horizontal Leap, then fall and land [prone](../Condition/Conditions.aspx-ID=88&Redirected=1.md).

### Leap

The Leap basic action is used for [High Jump](../Action/Actions.aspx-ID=2377&Redirected=1.md) and Long Jump. A horizontal Leap lets you jump up to 10 feet horizontally if your Speed is at least 15 feet, or up to 15 feet horizontally if your Speed is at least 30 feet. You land in the space where your Leap ends (meaning you can typically clear a 5-foot gap if your Speed is between 15 feet and 30 feet, or a 10-foot gap if your Speed is 30 feet or more).

A vertical Leap lets you jump up to 3 feet vertically and 5 feet horizontally onto an elevated surface.

## [Reposition](../Action/Actions.aspx-ID=2379.md) [one-action]

[Attack](../Trait/Traits.aspx-ID=540&Redirected=1.md)
Source [Player Core pg. 235](../Source/Sources.aspx-ID=216.md)
Requirements You either have at least one hand free, or you're [grabbing](../Condition/Conditions.aspx-ID=77&Redirected=1.md) or [restraining](../Condition/Conditions.aspx-ID=90&Redirected=1.md) the target. The target can't be more than one size larger than you.

---

You muscle a creature or object around. Attempt an [Athletics](./Skills.aspx-ID=36&Redirected=1.md) check against the target's Fortitude DC.
...
## [Shove](../Action/Actions.aspx-ID=2380.md) [one-action]
...
You push a creature away from you. Attempt an [Athletics](./Skills.aspx-ID=36&Redirected=1.md) check against your target's Fortitude DC.
...
Critical Failure You lose your balance, fall, and land [prone](../Condition/Conditions.aspx-ID=88&Redirected=1.md).

### Forced Movement

[Reposition](../Action/Actions.aspx-ID=2379.md) and Shove force a creature to move. When an effect forces you to move, or if you start falling, the distance you move is defined by the effect that moved you, not by your Speed. Because you're not acting to move, this doesn't trigger reactions triggered by movement. See Forced Movement for full details.

## [Swim](../Action/Actions.aspx-ID=2381.md) [one-action]
...
You attempt an [Athletics](./Skills.aspx-ID=36&Redirected=1.md) check to move a maximum distance of 10 feet through water. The GM determines the DC based on the turbulence or danger of the water; in most instances of calm water, you get an automatic critical success. If your land Speed is 40 feet or higher, increase the maximum possible distance by 5 feet for every 20 feet of Speed above 20 feet.
...
## [Trip](../Action/Actions.aspx-ID=2382.md) [one-action]

[Attack](../Trait/Traits.aspx-ID=540&Redirected=1.md)
Source [Player Core pg. 236](../Source/Sources.aspx-ID=216.md)
Requirements You have at least one hand free. Your target can't be more than one size larger than you.

---

You try to knock a creature to the ground. Attempt an [Athletics](./Skills.aspx-ID=36&Redirected=1.md) check against the target's Reflex DC.

Critical Success The target falls, lands [prone](../Condition/Conditions.aspx-ID=88&Redirected=1.md), and takes 1d6 bludgeoning damage.
Success The target falls and lands prone.
Critical Failure You lose your balance, fall, and land prone.

# Athletics Trained Actions

## [Disarm](../Action/Actions.aspx-ID=2383.md) [one-action]
...
You try to knock an item out of a creature's grasp. Attempt an [Athletics](./Skills.aspx-ID=36&Redirected=1.md) check against the target's Reflex DC.
