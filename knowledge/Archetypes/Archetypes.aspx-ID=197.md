# Shieldmarshal - Archetypes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Archetypes.aspx-ID=197.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Shieldmarshal](./Archetypes.aspx-ID=197.md)

### Legacy Content

Source [Impossible Lands pg. 108](../Source/Sources.aspx-ID=146.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Shieldmarshal Dedication Feat 2

### Legacy Content

Uncommon Archetype Dedication
Source [Impossible Lands pg. 109](../Source/Sources.aspx-ID=146.md)
[PFS Note](../PFS/PFS.aspx.md) As usual for archetypes, players who take the Shieldmarshal dedication feat can't select another dedication feat until they have gained two other feats from the Shieldmarshal archetype.
Archetype [Shieldmarshal](./Archetypes.aspx-ID=197.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Consolidated Overlay Panopticon [one-action] Feat 4
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Equitable Defense [reaction] Feat 8
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Counterclockwork Focus [one-action] Feat 10
