# Vashu's Ninth Life - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4102.htm`
...
## [Base Weapons](../Weapon/Weapons.aspx.md) ([Critical Specializations](../WeaponGroups/WeaponGroups.aspx.md)) | [Basic Magic Weapons](./Equipment.aspx-Category=37&Subcategory=39.md) | [Beast Guns](./Equipment.aspx-Category=37&Subcategory=74.md) | [Precious Material Weapons](./Equipment.aspx-Category=37&Subcategory=38.md) | [Specific Magic Weapons](./Equipment.aspx-Category=37&Subcategory=40.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Vashu's Ninth LifeItem 9

## This Item may contain spoilers from the Season of Ghosts Adventure Path

Unique Magical
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Vashus_Ninth_Life.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Vashus_Ninth_Life.webp%27Source [Season of Ghosts (Hardcover) pg. 306](../Source/Sources.aspx-ID=294.md)
Price 700 gp
Usage held in 1 hand; Bulk 1
Base Weapon [Katana](../Weapon/Weapons.aspx-ID=411.md)

---

This [+1 striking](./Equipment.aspx-ID=2861.md) [ghost touch](./Equipment.aspx-ID=2840.md) [katana](../Weapon/Weapons.aspx-ID=411.md) is made from a whisker stolen from the king of cats over 300 years ago by a [catfolk](../Ancestry/Ancestries.aspx-ID=77.md) [rogue](../Class/Classes.aspx-ID=37.md) named Vashu Vigaru. He sought the magic of the whisker to preternaturally extend his life, and some believe he still lives, having successfully divested himself of the sword to escape the king’s wrath in the end.

Activate—Whisker's Sense [free-action] ([concentrate](../Trait/Traits.aspx-ID=561.md)); Frequency once per hour; Trigger Your turn ends; Effect You extend your senses through the blade, allowing you to react to nearby movement. Vashu’s Ninth Life gains the [parry](../Trait/Traits.aspx-ID=667.md) trait and raises itself into parrying position, granting you a +1 circumstance bonus to AC until the start of your next turn.

Activate—Full of Life [reaction] ([concentrate](../Trait/Traits.aspx-ID=561.md)); Frequency once per day; Trigger You slay a living creature with Vashu’s Ninth Life; Effect A portion of the slain creature’s life force travels through the blade and into your soul, bolstering your own life. You gain the benefits of the [Diehard](../Feat/Feats.aspx-ID=5140.md) feat for 1 minute. This causes you to die from the [dying](../Condition/Conditions.aspx-ID=69.md) condition at dying 5 rather than dying 4.
