# Troops in Skirmishes - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3445&NoRedirect=1.htm`
...
If both happen at the same time, the troop rolls only one rout check. To attempt its rout check, the troop rolls a Will save against the standard DC for the level of the enemy that damaged it. This is an [emotion](../Trait/Traits.aspx-ID=590.md), [fear](../Trait/Traits.aspx-ID=598.md), and [mental](../Trait/Traits.aspx-ID=647.md) effect.
Critical Success The troop is unaffected.
Success The troop is [frightened](../Condition/Conditions.aspx-ID=76.md) 1.
...
Because of the traits on a rout check, some troops are entirely immune to them, in particular [mindless](../Trait/Traits.aspx-ID=652.md) hordes like zombies or clockwork constructs. NPCs often use these kinds of troops due to this advantage, but PCs might also be able to raise skeleton infantry or build a similar fearless army.

## Loosing a Troop

When a leader’s troop is defeated, the leader remains on the battlefield and can place themself anywhere within the space their troop occupied. If the troop is forced to retreat in some way, such as after gaining the [fleeing](../Condition/Conditions.aspx-ID=74.md) condition, the leader can usually choose to stay behind, abandoning their troop. If they exercise this option, they can’t become the leader of that troop again in the same encounter.
...
Take the Lead [two-actions] ([auditory](../Trait/Traits.aspx-ID=541.md), [concentrate](../Trait/Traits.aspx-ID=561.md), [linguistic](../Trait/Traits.aspx-ID=642.md)) Requirements You aren’t leading a troop, and you’re adjacent to an allied troop that had a leader at the start of the encounter but has since lost its leader; Effect You try to become the leader of the troop. Attempt a [Diplomacy](../Skill/Skills.aspx-ID=39.md) check against the easy DC for the troop’s level.
Success You become the leader of the troop until the end of this combat and immediately [Step](../Action/Actions.aspx-ID=2304.md) into its space. The troop doesn’t gain any special skirmish actions or bonds, even if it had one with its former leader or if you had one for a troop you’ve since lost.
