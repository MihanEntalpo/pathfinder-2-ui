# Gnome - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=61.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Gnome Details](./Ancestries.aspx-ID=61.md) | Gnome Feats | Universal Ancestry Feats | Gnome Heritages

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Gnome](./Ancestries.aspx-ID=61.md)

[Gnome](../Trait/Traits.aspx-ID=617.md) [Humanoid](../Trait/Traits.aspx-ID=628.md)
Source [Player Core pg. 51](../Source/Sources.aspx-ID=216.md)
...
[Gnomish](../Language/Languages.aspx-ID=5.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Draconic](../Language/Languages.aspx-ID=2.md), [Dwarven](../Language/Languages.aspx-ID=3.md), [Elven](../Language/Languages.aspx-ID=4.md), [Goblin](../Language/Languages.aspx-ID=6.md), [Jotun](../Language/Languages.aspx-ID=8.md), [Orcish](../Language/Languages.aspx-ID=9.md), and any other languages to which you have access (such as the languages prevalent in your region).
