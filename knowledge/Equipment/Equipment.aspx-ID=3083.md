# Eye of Fortune - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3083.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Eye of FortuneItem 13
...
Price 2,700 gp
Usage worn eyepiece; Bulk &mdash;
...
Activate—Luck Beyond Sight [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md), fortune)
; Trigger You attack a concealed or [hidden](../Condition/Conditions.aspx-ID=79&Redirected=1.md) creature and haven't attempted the flat check yet; Effect You can roll the flat check for the concealed or hidden condition twice and use the higher result.
