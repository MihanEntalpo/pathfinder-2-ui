# Goblin - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=62.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Goblin Details](./Ancestries.aspx-ID=62.md) | Goblin Feats | Universal Ancestry Feats | Goblin Heritages

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Goblin](./Ancestries.aspx-ID=62.md)

[Goblin](../Trait/Traits.aspx-ID=618.md) [Humanoid](../Trait/Traits.aspx-ID=628.md)
Source [Player Core pg. 55](../Source/Sources.aspx-ID=216.md)
...
[Goblin](../Language/Languages.aspx-ID=6.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Draconic](../Language/Languages.aspx-ID=2.md), [Dwarven](../Language/Languages.aspx-ID=3.md), [Gnomish](../Language/Languages.aspx-ID=5.md), [Halfling](../Language/Languages.aspx-ID=7.md), [Kholo](../Language/Languages.aspx-ID=122.md), [Orcish](../Language/Languages.aspx-ID=9.md), and any other languages to which you have access (such as the languages prevalent in your region).
