# Dimension of Time - Planes - Setting - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Planes.aspx-ID=46.htm`

# [Adventures](../Setting/Setting.aspx-Adventure=true.md) | [Articles](../Article/Articles.aspx.md) | [Deities](../Deity/Deities.aspx.md) | [Domains](../Domain/Domains.aspx.md) | [Languages](../Language/Languages.aspx.md) | [Planes](./Planes.aspx.md) | [Scenarios](../Setting/Setting.aspx-Group=40.md)

---

## [Dimensions](./Planes.aspx-Category=4.md) | [Inner Sphere Planes](./Planes.aspx-Category=1.md) | [Outer Sphere Planes](./Planes.aspx-Category=3.md) | [Transitive Planes](./Planes.aspx-Category=2.md)

---

There is a Legacy version here.

# [Dimension of Time](./Planes.aspx-ID=46.md)Dimension

[Erratic](../Trait/Traits.aspx-ID=592.md) [Static](../Trait/Traits.aspx-ID=702.md)
Source [GM Core pg. 181](../Source/Sources.aspx-ID=218.md)
Category Dimensions
Divinities unknown
