# Figurehead - Traits - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Traits.aspx-ID=512.htm`

# [Figurehead](./Traits.aspx-ID=512.md)
...
The figureheads presented [here](../Equipment/Equipment.aspx-Category=111.md) assume the vehicles they attach to are sailing ships or similar aquatic vessels, but figureheads might be modified or crafted to function on other vehicles instead.
