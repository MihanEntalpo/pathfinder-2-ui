# Red Thread Knot - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4106.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Red Thread KnotItem 7

## This Item may contain spoilers from the Season of Ghosts Adventure Path

Rare Invested Magical
Source [Season of Ghosts (Hardcover) pg. 307](../Source/Sources.aspx-ID=294.md)
Price 360 gp
...
Activate—Untie Fate [reaction] ([concentrate](../Trait/Traits.aspx-ID=561.md), [fortune](../Trait/Traits.aspx-ID=612.md)); Frequency once per day; Trigger You critically fail a save; Effect The knot unties one of its six knots, altering your fate in the process. Treat your saving throw as if you failed the check rather than critically failed the check. Once the sixth knot unties, it becomes a non-magical red thread.
