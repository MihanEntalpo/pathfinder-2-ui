# Exemplar - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=65.htm`
...
## [Exemplar Details](./Classes.aspx-ID=65.md) | [Exemplar Feats](../Feat/Feats.aspx-Traits=839.md) | Exemplar Sample Builds | [Ikons](../Ikons/Ikons.aspx.md) | [Epithets](../Epithet/Epithets.aspx.md)

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Exemplar

javascript:if(confirm(%27https://2e.aonprd.com/Images/Classes/Iconic_Nahoa.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Classes/Iconic_Nahoa.webp%27[Rare](../Trait/Traits.aspx-ID=683.md)
Source [War of Immortals pg. 28](../Source/Sources.aspx-ID=232.md)
[PFS Note](../PFS/PFS.aspx.md) All Pathfinder Society agents have access to the Exemplar class.
...
[Divine](../Trait/Traits.aspx-ID=579.md) [Exemplar](../Trait/Traits.aspx-ID=839.md)
Source [War of Immortals pg. 25](../Source/Sources.aspx-ID=232.md)

---

You shift your power, filling one of your ikons with your divine spark. That ikon softly glows with radiant light, emits subtle chimes as it moves, or is otherwise obviously empowered in a way that matches your growing divinity, granting the ikon the [divine](../Trait/Traits.aspx-ID=579.md) trait and granting you that ikon's immanence effects for as long as your divine spark is empowering it. Your spark is indivisible, so it can empower only one ikon at a time. You can also Shift Immanence to return your spark to the depths of your soul, leaving none of your ikons empowered.
...
At 1st level and every even-numbered level thereafter, you gain an [exemplar class feat](../Feat/Feats.aspx-Traits=839.md).
