# Preordained Spear - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3998.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Preordained SpearItem 9

## This Item may contain spoilers from the Myth-Speakers Adventure Path

Rare Magical [Mythic](../Trait/Traits.aspx-ID=835.md)
Source [Pathfinder #218: Titanbane pg. 69](../Source/Sources.aspx-ID=274.md)
Price 700 gp
Usage held in 1 hand; Bulk 1
Base Weapon [Spear](../Weapon/Weapons.aspx-ID=365.md)

---

This [+1 striking](./Equipment.aspx-ID=2861.md) [spear](../Weapon/Weapons.aspx-ID=365.md) seems to know when its wielder is about to die. Its wooden body bears countless carvings, leaving it thinner than most spears. While you are [doomed](../Condition/Conditions.aspx-ID=67.md), a preordained spear glows with a faint red light that gives you a haunted look and sheds dim light within 5 feet.

Activate—Delay Doom [one-action] ([manipulate](../Trait/Traits.aspx-ID=645.md)); Requirements Your name is not on the spear, and you have the [doomed](../Condition/Conditions.aspx-ID=67.md) condition; Effect Your name appears on the shaft of the preordained spear. Your doomed value decreases by 1, and you regain 1 [Mythic Point](../Rules/Rules.aspx-ID=3323.md). Your name fades from the spear the next time you make your [daily preparations](../Rules/Rules.aspx-ID=2575.md).
