# Pyrefeather Token - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3993.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Pyrefeather TokenItem 3

## This Item may contain spoilers from the Myth-Speakers Adventure Path

[Uncommon](../Trait/Traits.aspx-ID=721.md) [Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md) [Vitality](../Trait/Traits.aspx-ID=509.md)
Source [Pathfinder #216: The Acropolis Pyre pg. 82](../Source/Sources.aspx-ID=271.md)
Price 5 gp
Usage affixed to armor; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561.md)) Trigger You succeed at, fail, or critically fail a recovery check while [dying](../Condition/Conditions.aspx-ID=69.md) by 1.

---

This [pyrefowl](../Monster/Monsters.aspx-ID=3951.md) feather, accentuated with beadwork, stores a spark of the bird's self-healing power. When you Activate the token, you reduce the triggering recovery check's DC by 1, potentially improving your check's degree of success. You also gain 5 temporary Hit Points that last for 1 minute. You can Activate this talisman even while [unconscious](../Condition/Conditions.aspx-ID=95.md).
