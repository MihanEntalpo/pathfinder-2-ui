# Spider Root - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2905.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Spider RootItem 9

[Alchemical](../Trait/Traits.aspx-ID=528.md) [Consumable](../Trait/Traits.aspx-ID=564.md) [Contact](../Trait/Traits.aspx-ID=565.md) [Poison](../Trait/Traits.aspx-ID=669.md)
Source [GM Core pg. 250](../Source/Sources.aspx-ID=218.md), [Player Core 2 pg. 294](../Source/Sources.aspx-ID=227.md); There is a more recent version of this item. Click here to view.
Price 110 gp
...
A paste made by mashing the fine, threadlike roots of a certain creeper vine, spider root renders a victim clumsy and maladroit. Saving Throw DC 28 Fortitude; Onset 1 minute; Maximum Duration 6 minutes; Stage 1 3d6 poison damage and clumsy 1 (1 minute); Stage 2 4d6 poison damage and clumsy 2 (1 minute); Stage 3 6d6 poison damage and clumsy 3 (1 minute)
