# Eye of Apprehension - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2973.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Eye of ApprehensionItem 12

[Consumable](../Trait/Traits.aspx-ID=564.md) [Fortune](../Trait/Traits.aspx-ID=612.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
Source [GM Core pg. 264](../Source/Sources.aspx-ID=218.md)
Price 400 gp
Usage affixed to armor; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger You are about to roll Perception for initiative but haven't rolled yet; Requirements You are a master in Perception
