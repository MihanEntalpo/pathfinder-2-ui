# Ring of Lies - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3104.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Ring of LiesItem 10
...
Activate—Sweeten Lies [two-actions] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Frequency once per day; Effect Snapping your fingers on the hand that wears the ring causes the ring to cast [honeyed words](../Spell/Spells.aspx-ID=1558.md) on you with no visual manifestations of a spell being cast.
