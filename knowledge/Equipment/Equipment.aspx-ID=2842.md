# Holy - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2842.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)HolyItem 11

[Holy](../Trait/Traits.aspx-ID=517.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 238](../Source/Sources.aspx-ID=218.md)
Price 1,400 gp
Usage etched onto a weapon that isn't unholy; Bulk &mdash;
...
Activate—Holy Healing [reaction] [concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md), healing, [vitality](../Trait/Traits.aspx-ID=509.md); Frequency once per day; Trigger You critically succeed at a Strike against an unholy creature with the weapon; Effect You regain HP equal to double the unholy creature's level
