# Line Infantry - NPCs - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/NPCs.aspx-ID=3526&Weak=true&NoRedirect=1.htm`

# [All Creatures](../Creature/Creatures.aspx.md)[Abilities](../MonsterAbility/MonsterAbilities.aspx.md) | [Monsters](../Monster/Monsters.aspx.md) | [NPCs](./NPCs.aspx.md)[All](./NPCs.aspx.md) | Families | Theme TemplatesA | B | C | D | E | F | G | H | I | J | K | L | M | N | O | P | R | S | T | U | V | W | X | Z
...
## [Elite](./NPCs.aspx-ID=3526&Elite=true&NoRedirect=1.md) | [Normal](./NPCs.aspx-ID=3526&NoRedirect=1.md) | [Weak](./NPCs.aspx-ID=3526&Weak=true&NoRedirect=1.md)Proficiency without Level

### Print Stat Block

# Weak Line InfantryCreature 5

javascript:if(confirm(%27https://2e.aonprd.com/Images/Monsters/Line_Infantry.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Monsters/Line_Infantry.webp%27Gargantuan [Human](../Trait/Traits.aspx-ID=627.md) [Humanoid](../Trait/Traits.aspx-ID=628.md) Troop
...
[Recall Knowledge](../Rules/Rules.aspx-ID=2638.md) DC 20 &bull; Humanoid ([Society](../Skill/Skills.aspx-ID=47.md))
Perception +11
Languages [Common](../Language/Languages.aspx-ID=1.md)
Skills [Athletics](../Skill/Skills.aspx-ID=36.md) +13, [Warfare Lore](../Skill/Skills.aspx-ID=41.md) +10
Str +5, Dex +2, Con +3, Int +0, Wis +1, Cha +0

---

AC 22; Fort +13, Ref +12, Will +11
HP 76 (4 segments); Thresholds 64 (3 segments), 32 (2 segments); Weaknesses area damage 5, [splash](../Trait/Traits.aspx-ID=699.md) damage 5
No Retreat These soldiers have been extensively trained to hold their ground no matter the situation. If any effect would force the line infantry to move, reduce the distance by 5 feet. Any time they would be affected by the [fleeing](../Condition/Conditions.aspx-ID=74.md) condition, the line infantry is instead [slowed 2](../Condition/Conditions.aspx-ID=92.md) for the same duration.Troop Defenses
...
[three-actions] 3d6+10 slashing damageDrilled in Formations [one-action] Frequency once per round; Effect The line infantry uses Change Formation (see below in Military). A line infantry unit typically knows the marching column and wedge formations.
...
| [Hellknight Cavalry Brigade](./NPCs.aspx-ID=3530.md)
| 8
...
- Give the creature a [Stealth](../Skill/Skills.aspx-ID=48.md) modifier equal to the high skill value for its level. If you're in a hurry, use the creature's highest skill modifier.
- If the creature has the [Athletics](../Skill/Skills.aspx-ID=36.md) skill, reduce its modifier by 2.
- Reduce the damage of the creature's Strikes by 2, but give it the Sneak Attack ability.
Sneak Attack The creature deals 1d6 extra precision damage to [off-guard](../Condition/Conditions.aspx-ID=58.md) creatures.
- Add the Pounce ability.
Pounce [one-action] The creature Strides and makes a Strike at the end of that movement. If the creature began this action [hidden](../Condition/Conditions.aspx-ID=79.md), they remain hidden until after this ability's Strike.

## Troop Formations

Battle can be a complicated affair. Different situations call for varied arrangement of soldiers. You can add the Change Formation ability to a troop to give it more options, typically choosing two or three of the possible formations listed here. Troops with [animal](../Trait/Traits.aspx-ID=531.md) Intelligence (–4 or lower) or that aren't battle trained are typically unable to change formation without an outside force commanding them.

Change Formation [two-actions] ([concentrate](../Trait/Traits.aspx-ID=561.md), [move](../Trait/Traits.aspx-ID=658.md)) The troop reconfigures to assume one of the formations below they know. Using this action again ends any previous formation, and the troop can also use this action to revert to its default formation, ending any benefits and drawbacks.

- Loose Members of the troop fan out to cover more ground. Benefit Any weaknesses the troop has to area and [splash](../Trait/Traits.aspx-ID=699.md) damage are suppressed. Drawback Enemies' saving throws against the troop's damaging effects are one degree of success better than they roll.
- Marching Column This formation traverses long distances more rapidly. Benefit The troop gains a +10 foot circumstance bonus to all its Speeds. Drawback The troop is [off-guard](../Condition/Conditions.aspx-ID=58.md) and takes a –2 penalty to Reflex saves.
...
Phalanx formations are classically seen using a [spear](../Weapon/Weapons.aspx-ID=365.md) as their weapon of choice. However, feel free to swap out this weapon for something more appropriate to the local culture. For example, a phalanx comprised of worshippers of [Gozreh](../Deity/Deities.aspx-ID=284.md) might wield [tridents](../Weapon/Weapons.aspx-ID=401.md) instead of spears.
