# Bracelet of Dashing - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3060.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Bracelet of DashingItem 3
...
Activate—Jangling Dash [one-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Frequency once per day; Effect You gain a +10-foot status bonus to Speed for 1 minute.
