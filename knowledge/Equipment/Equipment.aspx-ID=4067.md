# Ugly Cute's Gift - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4067.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Ugly Cute's GiftItem 4

## This Item may contain spoilers from the Season of Ghosts Adventure Path

Unique Magical
Source [Season of Ghosts (Hardcover) pg. 297](../Source/Sources.aspx-ID=294.md)
Price 60 gp
Usage held in 1 hand; Bulk 1
Base Weapon [Spiked Gauntlet](../Weapon/Weapons.aspx-ID=366.md)

---

This spiky, stony fragment shed from Ugly Cute’s carapace fits comfortably over the hand. Though a little bulkier than the typical gauntlet, it still functions as a [+1](./Equipment.aspx-ID=2830.md) [spiked gauntlet](../Weapon/Weapons.aspx-ID=366.md).

Activate—Ugly Cute's Favor [two-actions] ([concentrate](../Trait/Traits.aspx-ID=561.md), [manipulate](../Trait/Traits.aspx-ID=645.md)); Frequency once per day; Effect You draw upon Ugly Cute’s latent spiritual energy to infuse the gauntlet with forceful power. For 1 minute, Ugly Cute’s gift gains the advantages of a [ghost touch](./Equipment.aspx-ID=2840.md) property rune and deals an additional 2 spirit damage on a successful Strike.
