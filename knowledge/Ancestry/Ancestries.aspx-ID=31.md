# Fleshwarp - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=31.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Fleshwarp Details](./Ancestries.aspx-ID=31.md) | Fleshwarp Feats | Universal Ancestry Feats | Fleshwarp Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Fleshwarp](./Ancestries.aspx-ID=31.md)

### Legacy Content

Rare Aberration [Fleshwarp](../Trait/Traits.aspx-ID=338.md) Humanoid
...
Additional languages equal to your Intelligence modifier (if positive). Choose from [Aklo](../Language/Languages.aspx-ID=13.md), [Draconic](../Language/Languages.aspx-ID=2.md), [Dwarven](../Language/Languages.aspx-ID=3.md), [Elven](../Language/Languages.aspx-ID=4.md), Goblin, [Undercommon](../Language/Languages.aspx-ID=11.md), and any other languages to which you have access (such as the languages prevalent in your region).
