# Troops - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3364&NoRedirect=1.htm`
...
Their troop defenses protect them to some degree against effects that have individual targets, and instead of standard Strikes, the troop has special actions representing their coordinated attacks. This usually includes an ability that attacks in an [emanation](./Rules.aspx-ID=2387.md), acting as the troop's equivalent of a melee Strike.
