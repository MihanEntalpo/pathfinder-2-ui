# Construct Companions - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=1600&NoRedirect=1.htm`
...
# [Construct Companions](./Rules.aspx-ID=1600.md)

Source [Guns & Gears pg. 32](../Source/Sources.aspx-ID=98.md)

A construct companion is a loyal, semi-sentient construct who follows your orders obediently and is roughly as intelligent as an animal. Your construct companion has the [minion](../Trait/Traits.aspx-ID=653.md) trait, and you gain the Command a Construct action.
...
([auditory](../Trait/Traits.aspx-ID=541.md), [concentrate](../Trait/Traits.aspx-ID=561.md)) You instruct your construct companion to act as you instruct it, and according to its programming. Your construct companion gains 2 actions during this turn.
...
Your construct companion is trained in its unarmed attacks, unarmored defense, all saving throws, Perception, [Acrobatics](../Skill/Skills.aspx-ID=34&Redirected=1.md), and [Athletics](../Skill/Skills.aspx-ID=36&Redirected=1.md). Construct companions can't use abilities that require greater Intelligence, such as Coerce or Decipher Writing, even if trained in the appropriate skill, unless they have an ability that allows it.
...
Because it’s a construct, your construct companion is immune to bleed, [death](../Trait/Traits.aspx-ID=571.md) effects, [disease](../Trait/Traits.aspx-ID=578.md), [doomed](../Condition/Conditions.aspx-ID=67.md), [drained](../Condition/Conditions.aspx-ID=68.md), [fatigued](../Condition/Conditions.aspx-ID=73.md), [healing](../Trait/Traits.aspx-ID=623.md), [nonlethal](../Trait/Traits.aspx-ID=661.md) attacks, paralyzed, [poison](../Trait/Traits.aspx-ID=669.md), [sickened](../Condition/Conditions.aspx-ID=91.md), [unconscious](../Condition/Conditions.aspx-ID=95.md), [vitality](../Trait/Traits.aspx-ID=509.md), and [void](../Trait/Traits.aspx-ID=510.md). It does not need to eat or breathe. Because the construct isn’t a living creature, effects that heal living creatures can’t help it recover Hit Points. Restoring Hit Points to it requires using the Repair action or other means that can restore Hit Points to objects and nonliving creatures.
...
- Increase its proficiency ranks in Intimidation, [Stealth](../Skill/Skills.aspx-ID=48&Redirected=1.md), and Survival to trained. If the construct is your innovation and it was already trained in those skills from a modification, increase its proficiency rank in those skills to expert.
...
- Increase its proficiency ranks in [Athletics](../Skill/Skills.aspx-ID=36&Redirected=1.md) and [Acrobatics](../Skill/Skills.aspx-ID=34&Redirected=1.md) to expert.
...
- Increase its proficiency ranks for [Athletics](../Skill/Skills.aspx-ID=36&Redirected=1.md), [Acrobatics](../Skill/Skills.aspx-ID=34&Redirected=1.md), saving throws, and Perception to master.
...
(
Source [Core Rulebook pg. 214](../Source/Sources.aspx-ID=1.md)
)
