# Android - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=27.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Android Details](./Ancestries.aspx-ID=27.md) | Android Feats | Universal Ancestry Feats | Android Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Android](./Ancestries.aspx-ID=27.md)

### Legacy Content

Rare [Android](../Trait/Traits.aspx-ID=334.md) Humanoid
Source Ancestry Guide pg. 69
...
[Androffan](../Language/Languages.aspx-ID=62.md)
Additional languages equal to your Intelligence modifier (if positive). Choose from [Abyssal](../Language/Languages.aspx-ID=12.md), Celestial, [Draconic](../Language/Languages.aspx-ID=2.md), [Dwarven](../Language/Languages.aspx-ID=3.md), [Undercommon](../Language/Languages.aspx-ID=11.md), [Utopian](../Language/Languages.aspx-ID=36.md), and any other languages to which you have access (such as the languages prevalent in your region).
