# Geas - Rituals - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rituals.aspx-ID=118.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)GeasRitual 3

[Uncommon](../Trait/Traits.aspx-ID=721.md) [Curse](../Trait/Traits.aspx-ID=566.md) [Mental](../Trait/Traits.aspx-ID=647.md)
Source [Player Core pg. 393](../Source/Sources.aspx-ID=216.md)
...
Critical Failure The geas fails, and you are instead affected by the geas you were attempting to place on the target. You are considered an unwilling target, so the geas can be counteracted with a [cleanse affliction](../Spell/Spells.aspx-ID=1467.md) spell.
