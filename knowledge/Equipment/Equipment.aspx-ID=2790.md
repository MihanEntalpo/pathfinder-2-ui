# Invisibility - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2790.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)InvisibilityItem 8+

[Illusion](../Trait/Traits.aspx-ID=629.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 226](../Source/Sources.aspx-ID=218.md)
Usage etched onto light armor; Bulk &mdash;

---

Light seems to partially penetrate this armor.

Activate—Go Invisible [one-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Frequency once per day; Effect With a thought, you become invisible for 1 minute, gaining the effects of a 2nd-rank [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md) spell.

Craft Requirements Supply one casting of [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md).
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Invisibility (Greater)Item 10
