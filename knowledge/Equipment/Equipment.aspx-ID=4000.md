# Worldscale Shield - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4000.htm`
...
## [Base Shields](../Shield/Shields.aspx.md) | [Precious Material Shields](./Equipment.aspx-Category=28&Subcategory=29.md) | [Specific Shields](./Equipment.aspx-Category=28&Subcategory=30.md)

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Worldscale ShieldItem 8
...
Activate—Absorb Blow [free-action] Trigger You would take physical damage (bludgeoning, piercing, or slashing) from an attack and you have your worldscale shield [Raised](../Action/Actions.aspx-ID=2316.md); Effect Spend 1 [Mythic Point](../Rules/Rules.aspx-ID=3323.md). The worldscale shield completely absorbs the blow, preventing all damage that you would have taken from the attack. The worldscale shield breaks. If it was already [broken](../Condition/Conditions.aspx-ID=60.md), it is destroyed.
