# Stone Bullet - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2928.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Stone BulletItem 15

[Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 256](../Source/Sources.aspx-ID=218.md)
Price 1,300 gp
Ammunition [sling bullet](../Weapon/Weapons.aspx-ID=442.md); Bulk &mdash;
Activate [one-action] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md))

---

This sling bullet looks like a petrified serpent's eye. A creature hit by an activated stone bullet is subject to the effects of a 6th-rank [petrify](../Spell/Spells.aspx-ID=1628.md) spell (DC 34).

Craft Requirements Supply one casting of [petrify](../Spell/Spells.aspx-ID=1628.md).
