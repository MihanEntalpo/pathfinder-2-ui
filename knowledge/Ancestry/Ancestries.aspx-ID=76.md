# Surki - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=76.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Surki Details](./Ancestries.aspx-ID=76.md) | Surki Feats | Universal Ancestry Feats | Surki Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Surki](./Ancestries.aspx-ID=76.md)

javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Surki01.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Surki01.webp%27javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Surki02.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Surki02.webp%27Rare Humanoid [Surki](../Trait/Traits.aspx-ID=789.md)
Source [Howl of the Wild pg. 47](../Source/Sources.aspx-ID=226.md)
Surkis are only now emerging from the subterranean Darklands in a generational dig to the surface. This insectile and highly metamorphic species subsists on the latent magic in the world around them. Once they have refined enough, surkis are capable of developing unique adaptations that allow them to project magic in diverse ways, from digging claws to energized wings.
...
Among surki communities in Sarkoris, worship of [Gozreh](../Deity/Deities.aspx-ID=284.md) and Sturovenen has grown quickly. Surkis who dedicate themselves to a deity are more likely to choose one representing their own environment or the natural world as a whole. Deities whose domains include [travel](../Domain/Domains.aspx-ID=93.md) or change are also popular among surki devotees.
...
[Surki](../Language/Languages.aspx-ID=176.md)
Additional languages equal to your Intelligence modifier (if positive). Choose from [Elven](../Language/Languages.aspx-ID=158.md), [Fey](../Language/Languages.aspx-ID=119.md), [Sakvroth](../Language/Languages.aspx-ID=118.md), and any other languages to which you have access (such as the languages prevalent in your region).
