# Alchemical Other - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=6&Subcategory=64.htm`
...
Source [Core Rulebook pg. 1](../Source/Sources.aspx-ID=1.md)
Nethys Note: A holding category for alchemical items that do not fit in any other category, most notably non-consumable alchemical tools
