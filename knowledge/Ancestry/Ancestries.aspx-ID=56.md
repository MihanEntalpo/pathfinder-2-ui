# Vishkanya - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=56.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Vishkanya Details](./Ancestries.aspx-ID=56.md) | Vishkanya Feats | Universal Ancestry Feats | Vishkanya Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Vishkanya](./Ancestries.aspx-ID=56.md)

### Legacy Content

Rare Humanoid Vishkanya
Source [Impossible Lands pg. 59](../Source/Sources.aspx-ID=146.md)
...
Vishkanyan backgrounds commonly reflect the individual's or their family's role in the community, which can include artist, hunter, acolyte, or emissary. Those who leave to explore the world outside might be entertainers, gamblers, or guards. Their natural grace and agility make vishkanyas excellent rogues, monks, or rangers, although bards, swashbucklers, and alchemists are not unusual to see.
...
[Vishkanya](../Language/Languages.aspx-ID=103.md)
Additional languages equal to your Intelligence modifier (if positive). Choose from [Aklo](../Language/Languages.aspx-ID=13.md), [Aquan](../Language/Languages.aspx-ID=14.md), [Draconic](../Language/Languages.aspx-ID=2.md), [Elven](../Language/Languages.aspx-ID=4.md), [Goblin](../Language/Languages.aspx-ID=6.md), [Undercommon](../Language/Languages.aspx-ID=11.md), [Vanaran](../Language/Languages.aspx-ID=72.md), and any other languages to which you have access (such as the languages prevalent in your region).
