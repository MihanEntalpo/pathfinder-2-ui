...
Source HTML: `docs/aonprd/Rules.aspx-ID=1096&NoRedirect=1.htm`
...
A list of all relic aspects and gifts can be found here.
...
Armor (Major) energy-resistant or greater energy-resistant (cold or electricity), [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md); Armor (Grand) [ethereal](../Equipment/Equipment.aspx-ID=284.md)
Weapon (Minor) returning; Weapon (Major) dancing, shock, thundering; Weapon (Grand) greater shock, greater thundering

### Celestial

Weapon (Major) [anarchic](../Equipment/Equipment.aspx-ID=290.md) (azata-themed), [axiomatic](../Equipment/Equipment.aspx-ID=291.md) (archon-themed), holy
...
Armor (Major) fortification, malleable; Armor (Major) greater fortification; Weapon (Minor) shifting; Weapon (Major) extending or greater extending, serrating
...
Soul Seeds
(
Source [Secrets of Magic pg. 229](../Source/Sources.aspx-ID=96.md)
)
