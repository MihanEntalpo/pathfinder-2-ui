# Chapter 11: Crafting & Treasure - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=686&NoRedirect=1.htm`
...
The myriad types of items give their powerful boons in different ways. Some function automatically, while others need to be activated. While you need only swing a flaming greataxe to scorch foes, you need to invest a diadem of intellect for it to work, imbibe an elixir of life to heal yourself, activate slippers of spider climbing to walk up a wall, activate your [mail of luck](../Equipment/Equipment.aspx-ID=155.md) to protect yourself, and Cast a Spell using a magical scroll.
...
### [Activate an Item](../Action/Actions.aspx-ID=100.md)

Source [Core Rulebook pg. 532](../Source/Sources.aspx-ID=1.md)
...
- Command ([auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md), [concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md))
- Envision ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md))
- Interact ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md))
- Cast a Spell
...
This component is a specific utterance you must make in a loud and strong voice. Activate an Item gains the [auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md) and [concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) traits. You must be able to speak to provide this component.

### Envision

This component is a specific image or phenomenon you need to imagine. Activate an Item gains the [concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) trait.

### Interact

This component works like the [Interact](../Action/Actions.aspx-ID=2297&Redirected=1.md) basic action. Activate an Item gains the [manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md) trait and requires you to use your hands, just like with any Interact action.
...
Source [Core Rulebook pg. 534](../Source/Sources.aspx-ID=1.md)
...
Usage This entry describes whether the item is held, worn, or affixed to or etched onto another item; Bulk The item’s Bulk is listed here (the rules for Bulk appear on page 271). Runes don’t have a Bulk entry.
...
Magical: Items with this trait are imbued with magical energies. Each one radiates a magic aura infused with its dominant school of magic ([abjuration](../Trait/Traits.aspx-ID=2.md), [conjuration](../Trait/Traits.aspx-ID=33.md), [divination](../Trait/Traits.aspx-ID=47.md), [enchantment](../Trait/Traits.aspx-ID=61.md), [evocation](../Trait/Traits.aspx-ID=65.md), illusion, [necromancy](../Trait/Traits.aspx-ID=117.md), or [transmutation](../Trait/Traits.aspx-ID=157.md)). A character can craft these items only if she has the Magical Crafting feat .
...
For example, if you throw a lesser acid flask and hit your target, that creature takes 1 acid damage, 1d6 [persistent acid damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md), and 1 acid splash damage. All other creatures within 5 feet of it take 1 acid splash damage. On a critical hit, the target takes 2 acid damage and 2d6 persistent acid damage, but the splash damage is still 1. If you miss, the target and all creatures within 5 feet take only 1 splash damage. If you critically fail, no one takes any damage.
...
The most common special armors are suits of armor with some combination of armor potency and resilient runes. The magic armor stat block provides a quick reference for these types of armor.

### Specific Magic Armor

These suits of armor have abilities far different from what can be gained by etching runes. A specific magic armor lists its [fundamental runes](../Equipment/Equipment.aspx-Category=23&Subcategory=24.md), which you can upgrade, add, or transfer as normal. You can't etch or transfer any [property runes](../Equipment/Equipment.aspx-Category=23&Subcategory=26.md) onto a specific armor that it doesn't already have or remove its property runes.
...
## [Held Items](./Rules.aspx-ID=728.md)
...
Accessory Runes
(
Source [Grand Bazaar pg. 88](../Source/Sources.aspx-ID=100.md)
)
...
Staves are also staff weapons. They can be etched with [fundamental runes](../Equipment/Equipment.aspx-Category=23&Subcategory=25.md) but not [property runes](../Equipment/Equipment.aspx-Category=23&Subcategory=27.md). This doesn't alter any of their spellcasting abilities.

### Related Rules

Personal Staves
(
Source [Secrets of Magic pg. 166](../Source/Sources.aspx-ID=96.md)
)
...
These weapons have abilities far different from what can be gained by simply etching runes. A specific magic weapon lists its [fundamental runes](../Equipment/Equipment.aspx-Category=23&Subcategory=25.md), which you can upgrade, add, or transfer as normal. You can't etch or transfer any [property runes](../Equipment/Equipment.aspx-Category=23&Subcategory=27.md) onto a specific weapon that it doesn't already have, and you can't remove its property runes.

## [Worn Items](./Rules.aspx-ID=768.md)
...
Fulus
(
Source [Secrets of Magic pg. 158](../Source/Sources.aspx-ID=96.md)
)

Grimoires
(
Source [Secrets of Magic pg. 162](../Source/Sources.aspx-ID=96.md)
)

Magical Tattoos
(
Source [Secrets of Magic pg. 164](../Source/Sources.aspx-ID=96.md)
)
...
Spell Catalysts
(
Source [Secrets of Magic pg. 168](../Source/Sources.aspx-ID=96.md)
)

Spellhearts
(
Source [Secrets of Magic pg. 170](../Source/Sources.aspx-ID=96.md)
)
...
Mobility Devices
(
Source [Guns & Gears pg. 90](../Source/Sources.aspx-ID=98.md)
)

Gadgets
(
Source [Guns & Gears pg. 66](../Source/Sources.aspx-ID=98.md)
)
...
(
Source [Grand Bazaar pg. 104](../Source/Sources.aspx-ID=100.md)
)
