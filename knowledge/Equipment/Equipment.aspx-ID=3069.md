# Cloak of Illusions - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3069.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Cloak of IllusionsItem 7+

[Invested](../Trait/Traits.aspx-ID=637.md) [Magical](../Trait/Traits.aspx-ID=644.md)
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Cloak_of_Elvenkind.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Cloak_of_Elvenkind.webp%27Source [GM Core pg. 287](../Source/Sources.aspx-ID=218.md)
Usage worn cloak; Bulk L

---

This cloak flows, covering and concealing the wearer's body. The cloak allows you to cast [figment](../Spell/Spells.aspx-ID=1528.md) as an occult innate cantrip. Although naturally a dull gray, while invested the cloak picks up colors and patterns from its surroundings, granting a +1 item bonus to Stealth checks.

Activate—Draw Hood [two-actions] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Frequency once per day; Effect You draw the hood up and gain the effects of [invisibility](../Spell/Spells.aspx-ID=1577.md), with the spell's normal duration or until you pull the hood back down, whichever comes first.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Cloak of IllusionsItem 7

Source [GM Core pg. 287](../Source/Sources.aspx-ID=218.md)
Price 360 gp

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Cloak of Illusions (Greater)Item 12

Source [GM Core pg. 287](../Source/Sources.aspx-ID=218.md)
Price 1,750 gp
The cloak grants a +2 item bonus and the effects of 4th-rank [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md).
