# Life in the Academy - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=1467&NoRedirect=1.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

# [Life in the Academy](./Rules.aspx-ID=1467.md)

Source [Pathfinder #169: Kindled Magic pg. 61](../Source/Sources.aspx-ID=94.md)
...
| Cascade Bearers
| Arcana, Occultism, Religion
| Academia Lore
| Canny Acumen

| Emerald Boughs
| [Deception](../Skill/Skills.aspx-ID=38&Redirected=1.md), Diplomacy, Society
| Specific settlement (such as Nantambu Lore)
| Adopted Ancestry

| Rain-Scribes
| Medicine, Nature, Survival
| Specific terrain (such as Forest Lore)
| Fleet
...
Downtime
Source [Pathfinder #169: Kindled Magic pg. 63](../Source/Sources.aspx-ID=94.md)
...
At 5th level in a branch, you gain greater influence, making it easier to collaborate, hoodwink, or browbeat members of that branch. You gain a +1 circumstance bonus on [Deception](../Skill/Skills.aspx-ID=38&Redirected=1.md), Diplomacy, Intimidation, and Performance checks to interact with members of the branch.
