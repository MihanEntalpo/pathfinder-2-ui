# Bargain Hunter - Feats - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Feats.aspx-ID=5123.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Bargain Hunter](./Feats.aspx-ID=5123.md) Feat 1

General Skill
Source [Player Core pg. 252](../Source/Sources.aspx-ID=216.md)

Prerequisites trained in Diplomacy

---

You can Earn Income using [Diplomacy](../Skill/Skills.aspx-ID=39.md), spending your days hunting for bargains and reselling at a profit. You can also spend time specifically sniffing out a great bargain on an item; this works as if you were using Earn Income with Diplomacy, except instead of gaining money, you purchase the item at a discount equal to the money you would have gained, gaining the item for free if your earned income equals or exceeds its cost. Finally, if you select Bargain Hunter during character creation at 1st level, you start play with an additional 2 gp.
