# Animal Companions - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3379&NoRedirect=1.htm`
...
Level -1: compsognathus, eagle, [flash beetle](../Monster/Monsters.aspx-ID=2852.md), [giant centipede](../Monster/Monsters.aspx-ID=2875.md), giant rat, guard dog, viper
...
Level 2: [boar](../Monster/Monsters.aspx-ID=2854.md), crocodile, deinonychus, giant ant, giant monitor lizard, giant viper, hippogriff, leopard, pteranodon, slurk, war horse
Level 3: ankhrav, dire wolf, giant mantis, giant scorpion, giant wasp, gorilla, grizzly bear, [hell hound](../Monster/Monsters.aspx-ID=3047.md), hyaenodon, lion, pachycephalosaurus, snapping flytrap
Level 4: [daeodon](../Monster/Monsters.aspx-ID=2855.md), giant stag beetle, griffon, rhinoceros, tiger
Level 5: giant frilled lizard, giant moray eel
Level 6: cave bear, giant tarantula, smilodon, woolly rhinoceros
Level 8: krooth
Level 9: [greater hell hound](../Monster/Monsters.aspx-ID=3048.md)
Level 10: gezullon

## Riding Animal Companions

An NPC can ride a creature that works alongside them as long as the creature is at least one size larger than the rider. Generally, a creature that is carrying a rider can use only its land Speed and can't grant its support benefit. However, certain creatures that have been trained to be ridden, such as horses and riding drakes, ignores those restrictions.
...
Ape The ape threatens the NPC's foes with menacing growls. Until the start of the NPC's next turn, if the NPC hits and deals damage to a creature in the ape's reach, the creature becomes [frightened 1](../Condition/Conditions.aspx-ID=76.md).

Badger The badger digs around a foe's position, upending the ground and interfering with its footing. Until the start of the NPC's next turn, if the NPC hits and deals damage to a creature the badger threatens, the target can't use a Step action (unless it can Step through [difficult terrain](./Rules.aspx-ID=2366&Redirected=1.md)) until it moves from its current position.
...
Bird The bird pecks at foes' eyes when the NPC creates an opening. Until the start of the NPC's next turn, the NPC's Strikes that damage a creature that the bird threatens also deal 1d4 [persistent bleed damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md) (or 2d4 if the bird is 8th level or higher), and the target is [dazzled](../Condition/Conditions.aspx-ID=65.md) until the bleed damage ends.

Boar The boar gores the NPC's foes. Until the start of the NPC's next turn, the NPC's Strikes that damage a creature in the boar's reach deal an extra 1d6 [persistent bleed damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md) (or 2d6 if the boar is 8th level or higher).

Cat The cat throws enemies off-balance when the NPC creates an opening. Until the start of the NPC's next turn, the NPC's Strikes that deal damage to a creature within the cat's reach make the target [off-guard](../Condition/Conditions.aspx-ID=58.md) until the end of the NPC's next turn.

Crocodile The crocodile clamps its jaws on a foe, refusing to let go. Until the start of the NPC's next turn, if the NPC's Strike damages a creature in the crocodile's reach, the crocodile can latch onto the creature. While thus attached, the crocodile can move along with the target whenever the target moves until the end of the NPC's next turn. The crocodile can latch onto only one creature in this way, and it must release the creature to make a jaws Strike. If the target is smaller than the crocodile, it takes a –10-foot circumstance penalty to its Speeds and can't [Fly](../Action/Actions.aspx-ID=2312.md) while the crocodile is latched on.
...
Horse Until the start of the NPC's next turn, if the NPC is mounted on the horse and moved 10 feet or more on the action before a melee Strike, the NPC gains a circumstance bonus to the damage roll equal to double the number of weapon damage dice. If the NPC's weapon already has the [jousting](../Trait/Traits.aspx-ID=638.md) weapon trait, instead increase the trait's damage bonus by 2 per die.

Scorpion The scorpion drips poison from its stinger when the NPC creates an opening. Until the start of the NPC's next turn, the NPC's Strikes that damage a creature in the scorpion's reach deal an extra 1d6 [persistent poison damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md) (or 2d6 if the scorpion is 8th level or higher).
