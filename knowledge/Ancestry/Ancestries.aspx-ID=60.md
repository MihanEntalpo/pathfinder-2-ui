# Elf - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=60.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Elf Details](./Ancestries.aspx-ID=60.md) | Elf Feats | Universal Ancestry Feats | Elf Heritages

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Elf](./Ancestries.aspx-ID=60.md)

[Elf](../Trait/Traits.aspx-ID=588.md) [Humanoid](../Trait/Traits.aspx-ID=628.md)
Source [Player Core pg. 47](../Source/Sources.aspx-ID=216.md)
...
[Elven](../Language/Languages.aspx-ID=4.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Draconic](../Language/Languages.aspx-ID=2.md), [Empyrean](../Language/Languages.aspx-ID=115.md), [Fey](../Language/Languages.aspx-ID=119.md), [Gnomish](../Language/Languages.aspx-ID=5.md), [Goblin](../Language/Languages.aspx-ID=6.md), [Kholo](../Language/Languages.aspx-ID=122.md), [Orcish](../Language/Languages.aspx-ID=9.md), and any other languages to which you have access (such as the languages prevalent in your region).
