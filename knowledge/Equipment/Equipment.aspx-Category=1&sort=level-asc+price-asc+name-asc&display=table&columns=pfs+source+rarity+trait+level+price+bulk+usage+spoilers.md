# Adventuring Gear - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=1&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+price+bulk+usage+spoilers.htm`
...
Source [Core Rulebook pg. 287](../Source/Sources.aspx-ID=1.md)
These items follow special rules or require more detail.

Quick display options: [Short](./Equipment.aspx-Category=1&sort=level-asc+price-asc+name-asc&display=short.md) | [Table](./Equipment.aspx-Category=1&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+price+bulk+usage+spoilers.md)
