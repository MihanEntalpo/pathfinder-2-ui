# Gunslinger - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=20.htm`
...
## [Gunslinger Details](./Classes.aspx-ID=20.md) | [Gunslinger Feats](../Feat/Feats.aspx-Traits=406.md) | Gunslinger Sample Builds | [Ways](../Ways/Ways.aspx.md)

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Gunslinger

Uncommon
Source [Guns & Gears pg. 105](../Source/Sources.aspx-ID=98.md)
Access: The following regions have access to gunslingers: Ustalav, the Shackles, Alkenstar, Tian Xia, Arcadia
[PFS Note](../PFS/PFS.aspx.md) All Pathfinder Society agents have access to the Gunslinger class.
...
| 19
| General feat, medium armor mastery, perception legend, skill increase
...
Gunslinger ways can be found [here](../Ways/Ways.aspx.md).
...
You have steady precision with guns and crossbows and can use weapons that incorporate them effectively. You deal an extra +2 precision damage with Strikes made using [crossbows](../WeaponGroups/WeaponGroups.aspx-ID=17.md) that don't have the [repeating](../Trait/Traits.aspx-ID=374.md) trait, and deal an extra 1d4 precision damage on Strikes with [firearms](../WeaponGroups/WeaponGroups.aspx-ID=16.md) that don't have the repeating trait.
...
If you are using a [combination](../Trait/Traits.aspx-ID=417.md) weapon whose ranged form is a firearm or crossbow, you use your proficiency with firearms and crossbows for attacks made with the melee portion of that weapon.
