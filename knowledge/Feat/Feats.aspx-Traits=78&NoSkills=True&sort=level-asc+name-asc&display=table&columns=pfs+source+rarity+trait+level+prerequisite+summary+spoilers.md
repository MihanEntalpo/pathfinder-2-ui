# General Feats (No Skill Feats) - Archives of Nethys: Pathfinder 2nd Edition Database - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Feats.aspx-Traits=78&NoSkills=True&sort=level-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+prerequisite+summary+spoilers.htm`
...
# General Feats (No Skill Feats)

Source [Player Core pg. 249](../Source/Sources.aspx-ID=216.md)
All kinds of experiences and training can shape your character beyond what you learn by advancing in your class.

Click here for the full rules on Feats.

Quick display options: [Short](./Feats.aspx-Traits=78&NoSkills=True&sort=level-asc+name-asc&display=short.md) | [Table](./Feats.aspx-Traits=78&NoSkills=True&sort=level-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+prerequisite+summary+spoilers.md) | [Grouped by Level](./Feats.aspx-Traits=78&NoSkills=True&sort=level-asc+name-asc&display=grouped&group-fields=level&link-layout=vertical-with-summary.md)
