# Ort - Monsters - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Monsters.aspx-ID=2905&Weak=true.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Ort (Drudge Devil)
...
# [Weak Ort](./Monsters.aspx-ID=2905.md)Creature -1

javascript:if(confirm(%27https://2e.aonprd.com/Images/Monsters/Ort.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Monsters/Ort.webp%27Medium [Devil](../Trait/Traits.aspx-ID=575.md) [Fiend](../Trait/Traits.aspx-ID=600.md) [Mindless](../Trait/Traits.aspx-ID=652.md) [Unholy](../Trait/Traits.aspx-ID=521.md)
...
[Recall Knowledge](../Rules/Rules.aspx-ID=2638.md) DC 13 &bull; Fiend ([Religion](../Skill/Skills.aspx-ID=46.md))
Perception +-2; [greater darkvision](../MonsterAbility/MonsterAbilities.aspx-ID=59.md)
Skills [Athletics](../Skill/Skills.aspx-ID=36&Redirected=1.md) +4
Str +2, Dex +0, Con +3, Int -5, Wis +0, Cha -3

---

AC 11; Fort +7, Ref +4, Will +0
HP 20; Immunities [fire](../Domain/Domains.aspx-ID=76.md), [mental](../Trait/Traits.aspx-ID=647.md); Resistances physical 3 (except silver), [poison](../Trait/Traits.aspx-ID=669.md) 5; Weaknesses [holy](../Trait/Traits.aspx-ID=517.md) 3

---

Speed 20 feet
Melee [one-action] claw +6 [+2/-2] (agile, magical, [unholy](../Trait/Traits.aspx-ID=521.md)), Damage 1d4-2+2 slashingSubservience Orts have little drive of their own, but other devils can take command of them. A non-ort [devil](../Trait/Traits.aspx-ID=575.md) can issue a command to all orts within 60 feet of it with a single action, which has the [auditory](../Trait/Traits.aspx-ID=541.md) and [concentrate](../Trait/Traits.aspx-ID=561.md) traits. The devil picks one of the following orders orts can understand, and the orts follow that order. The command and its effects end once the commander is out of the ort's sight, when a new command is issued by the same or another devil, or when the ort dies.
