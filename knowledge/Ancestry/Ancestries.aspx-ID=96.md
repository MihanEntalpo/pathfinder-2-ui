# Dragonet - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=96.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Dragonet Details](./Ancestries.aspx-ID=96.md) | Dragonet Feats | Universal Ancestry Feats | Dragonet Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Dragonet](./Ancestries.aspx-ID=96.md)

javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Fey_Dragonet_Ancest.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Fey_Dragonet_Ancest.webp%27javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/House_Drake_Ancestry.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/House_Drake_Ancestry.webp%27Rare [Dragon](../Trait/Traits.aspx-ID=581.md) [Dragonet](../Trait/Traits.aspx-ID=893.md)
Source [Draconic Codex pg. 208](../Source/Sources.aspx-ID=277.md)
...
### Dragonet Adventurers

Dragonets’ reasons for adventuring are as varied as they are. Some set out to defend their home, while others have an insatiable curiosity about new places or interesting people. Some seek treasure, and others might have bonded with a spellcaster, only to strike out on their own when the spellcaster retired or died.

Even in cities, many dragonets tend to live somewhat apart from society and have solitary backgrounds, such as a [charlatan](../Background/Backgrounds.aspx-ID=415.md), courier, [criminal](../Background/Backgrounds.aspx-ID=417.md), [scholar](../Background/Backgrounds.aspx-ID=440.md), [street urchin](../Background/Backgrounds.aspx-ID=442.md), or [tinkerer](../Background/Backgrounds.aspx-ID=444.md). Those who live outside cities may have grown up a [hermit](../Background/Backgrounds.aspx-ID=429.md), [hunter](../Background/Backgrounds.aspx-ID=430.md), [nomad](../Background/Backgrounds.aspx-ID=436.md), or scavenger. Dragonets often rely on their own natural abilities, instead of equipment, and tend to be [rangers](../Class/Classes.aspx-ID=36.md), [rogues](../Class/Classes.aspx-ID=37.md), and [swashbucklers](../Class/Classes.aspx-ID=63.md). Those more magically inclined are likely [druids](../Class/Classes.aspx-ID=34.md) or [sorcerers](../Class/Classes.aspx-ID=62.md), though many house drakes become [wizards](../Class/Classes.aspx-ID=39.md). Especially curious dragonets find success as [investigators](../Class/Classes.aspx-ID=59.md).

### Tiny PCs

Your Tiny dragonet can enter another creature’s space, which is important because your melee Strikes typically have no reach, meaning you must enter a creature’s space to attack it. Like other Tiny creatures, you don’t automatically receive lesser [cover](../Rules/Rules.aspx-ID=2372.md) from being in a larger creature’s space, but circumstances might allow you to [Take Cover](../Action/Actions.aspx-ID=2307.md). You can purchase weapons, armor, and other items for your size with the same statistics as normal gear, except that melee weapons have a reach of 0 for them (or a reach 5 feet shorter than normal if they have the [reach](../Trait/Traits.aspx-ID=684.md) trait). Remember to adjust the Bulk of items and the PC’s Bulk limit for Tiny size.

Your agile claws let you manipulate items as easily as other ancestries use arms and hands. You can use armor built for humanoids normally, with just a few adjustments to your form, but can’t wear barding.
...
[Common](../Language/Languages.aspx-ID=155.md)
[Draconic](../Language/Languages.aspx-ID=156.md)
...
Your mouth bristles with razor-sharp teeth. You gain a [jaws](../Weapon/Weapons.aspx-ID=356.md) unarmed attack that deals 1d4 piercing damage. Your jaws are in the brawling group and have the [finesse](../Trait/Traits.aspx-ID=602.md) and [unarmed](../Trait/Traits.aspx-ID=719.md) traits.
