# Spy - NPCs - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/NPCs.aspx-ID=3421&Elite=true.htm`
...
# [Elite Spy](./NPCs.aspx-ID=3421.md)Creature 7
...
Skills [Acrobatics](../Skill/Skills.aspx-ID=34.md) +16, [Deception](../Skill/Skills.aspx-ID=38.md) +18, [Diplomacy](../Skill/Skills.aspx-ID=39.md) +16, [Intimidation](../Skill/Skills.aspx-ID=40.md) +16, [Local Court Lore](../Skill/Skills.aspx-ID=41.md) +18, [Society](../Skill/Skills.aspx-ID=47.md) +16, [Stealth](../Skill/Skills.aspx-ID=48.md) +18, [Thievery](../Skill/Skills.aspx-ID=50.md) +16
Str +0, Dex +4, Con +0, Int +2, Wis +2, Cha +4
Noble's Ally The spy has positioned themself to seem a trusted ally, gaining a +2 circumstance bonus to [Gather Information](../Action/Actions.aspx-ID=2391.md) or to [Make an Impression](../Action/Actions.aspx-ID=2392.md) among the nobles of that court.
Items +1 [rapier](../Weapon/Weapons.aspx-ID=391.md), dagger (4), disguise kit, [fine clothes](../Equipment/Equipment.aspx-ID=2715.md), leather armor, [thieves' toolkit](../Equipment/Equipment.aspx-ID=2758.md)
