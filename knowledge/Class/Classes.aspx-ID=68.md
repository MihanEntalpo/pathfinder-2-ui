# Psychic - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=68.htm`

# [Alchemist](./Classes.aspx-ID=56.md) | [Animist](./Classes.aspx-ID=64.md) | [Barbarian](./Classes.aspx-ID=57.md) | [Bard](./Classes.aspx-ID=32.md) | [Champion](./Classes.aspx-ID=58.md) | [Cleric](./Classes.aspx-ID=33.md) | [Commander](./Classes.aspx-ID=66.md) | [Druid](./Classes.aspx-ID=34.md) | [Exemplar](./Classes.aspx-ID=65.md) | [Fighter](./Classes.aspx-ID=35.md) | [Guardian](./Classes.aspx-ID=67.md) | [Gunslinger](./Classes.aspx-ID=20.md) | [Inventor](./Classes.aspx-ID=19.md) | [Investigator](./Classes.aspx-ID=59.md) | [Kineticist](./Classes.aspx-ID=23.md) | [Magus](./Classes.aspx-ID=17.md) | [Monk](./Classes.aspx-ID=60.md) | [Oracle](./Classes.aspx-ID=61.md) | [Psychic](./Classes.aspx-ID=68.md) | [Ranger](./Classes.aspx-ID=36.md) | [Rogue](./Classes.aspx-ID=37.md) | [Sorcerer](./Classes.aspx-ID=62.md) | [Summoner](./Classes.aspx-ID=18.md) | [Swashbuckler](./Classes.aspx-ID=63.md) | [Thaumaturge](./Classes.aspx-ID=69.md) | [Witch](./Classes.aspx-ID=38.md) | [Wizard](./Classes.aspx-ID=39.md)[Animal Companions](../AnimalCompanions/AnimalCompanions.aspx.md) | [Construct Companions](../ConstructCompanions/ConstructCompanions.aspx.md) | [Eidolons](../Eidolons/Eidolons.aspx.md) | [Familiar Abilities](../Familiar/Familiars.aspx.md) | [Specific Familiars](../Familiar/Familiars.aspx-Specific=true.md) | [Undead Companions](../AnimalCompanions/AnimalCompanions.aspx-Undead=true.md)

---

## [Psychic Details](./Classes.aspx-ID=68.md) | Psychic Feats | Psychic Psi Cantrips | Psychic Sample Builds | [Conscious Minds](../ConsciousMinds/ConsciousMinds.aspx.md) | [Subconscious Minds](../SubconsciousMinds/SubconsciousMinds.aspx.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Psychic

Source [Dark Archives (Remastered) pg. 9](../Source/Sources.aspx-ID=293.md)
...
Trained in [Occultism](../Skill/Skills.aspx-ID=44.md)
...
| 1
| Ancestry and background, attribute boosts, initial proficiencies, psychic spellcasting, spell repertoire, psi cantrips and psi amps, Unleash Psyche, subconscious mind, conscious mind
...
You access the vast well of power that resides within your own mind, calling forth psychic magic with nothing but thought and will. You are a spellcaster and can cast occult spells using the [Cast a Spell](../Rules/Rules.aspx-ID=2233.md) activity. You don't need to utter incantations to cast your spells, instead exerting your mind toward your intended effect as described in your subconscious mind class feature. Your spells still have clear and noticeable visual and auditory manifestations, as normal for a spellcaster. Each day, you can cast one 1st-rank spell. You must know spells to cast them, and you learn them via the spell repertoire class feature. The number of spells you can cast each day is called your spell slots.

As you increase in level as a psychic, your number of spells per day increases, as does the highest rank of spells you can cast, as shown on the Psychic Spells per Day table. Some of your spells require you to attempt a spell attack roll to see how effective they are, or have your enemies roll against your spell DC (typically by attempting a saving throw), Since your key attribute is determined by your subconscious mind, your spell attack rolls and spell DCs use the modifier for the attribute stated in your subconscious mind.
...
You add to this spell repertoire as you increase in level. Each time you get a spell slot (see the Psychic Spells per Day table), you add a spell to your spell repertoire of the same rank. At 2nd level, you select another 1st-rank spell; at 3rd level, you select one 2nd-rank spell, and so on. When you add spells, you might add a higher-rank version of a spell you already have, so you can cast a heightened version of that spell. Your conscious mind also adds additional spells to your repertoire as you gain spells of higher ranks. Though you gain them at the same rate, your spell slots and the spells in your spell repertoire are separate. If a feat or other ability adds a spell to your spell repertoire, such as the spells you gain from your conscious mind, it wouldn't give you another spell slot, and vice versa.

## Swapping Spells In Your Repertoire

As you gain new spells in your repertoire, you might want to replace some of the spells you previously learned. Each time you gain a level and learn new spells, you can swap out one of your old spells for a different spell of the same ranks. This spell can be a cantrip. You can also swap out spells by retraining during downtime.
...
- You can use actions that have the psyche trait. After your unleashed psyche subsides, your mind must recover from the strain of channeling its full power. You can't use Unleash Psyche again for 2 rounds, and you're [stupefied](../Condition/Conditions.aspx-ID=94.md) 1 for 2 rounds.
...
Subconscious mind options can be found [here](../SubconsciousMinds/SubconsciousMinds.aspx.md).
...
Conscious mind options can be found [here](../ConsciousMinds/ConsciousMinds.aspx.md)

## Psychic FeatsLevel 2

At 2nd level and every even-numbered level, you gain a [psychic class feat](../Feat/Feats.aspx-Traits=894.md).

## Skill FeatsLevel 2

At 2nd level and every 2 levels thereafter, you gain a [skill feat](../Feat/Feats.aspx-Traits=144.md). You must be trained or better in the corresponding skill to select a skill feat.

## General FeatsLevel 3

At 3rd level and every 4 levels thereafter, you gain a [general feat](../Feat/Feats.aspx-Traits=78.md).
...
Your deepening connection to your mind grants you more power to fuel your psi amps. Increase the number of Focus Points in your focus pool by 1. As normal, this ability can't increase the size of your focus pool above 3 points.
...
Self-reflection has brought you greater knowledge of yourself and, with it, psychic power. Your proficiency ranks for spell attack modifier and spell DC increase to expert.
...
Training has improved your weapon technique, possibly enhanced by your occult magic. Your proficiency rank for simple weapons and unarmed attacks increases to expert.
...
As you touch a weapon, you glimpse the hands that made and wielded it, teaching you how to inflict greater injuries. You deal 2 additional damage with weapons and unarmed attacks in which you're an expert. This damage increases to 3 if you're a master and 4 if you're legendary.

## Master SpellcasterLevel 15

You've gained access to the deepest corners of your own mind. Your proficiency ranks for spell attack modifier and spell DC increase to master.
...
As your training reaches its peak, you understand not just your own mind, but the collective unconscious from which all psychic power stems. Your proficiency ranks for occult spell attack modifier and spell DC increase to legendary.
