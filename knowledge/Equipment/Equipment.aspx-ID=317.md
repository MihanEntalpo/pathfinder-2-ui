# Arrow-Catching Shield - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=317.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Arrow-Catching ShieldItem 11

### Legacy Content

[Abjuration](../Trait/Traits.aspx-ID=2.md) Magical
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Arrow-Catching_Shield.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Arrow-Catching_Shield.webp%27Source [Core Rulebook pg. 587](../Source/Sources.aspx-ID=1.md)
Price 1,350 gp
