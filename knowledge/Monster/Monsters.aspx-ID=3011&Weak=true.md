# Marsh Giant - Monsters - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Monsters.aspx-ID=3011&Weak=true.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Marsh Giant
...
# [Weak Marsh Giant](./Monsters.aspx-ID=3011.md)Creature 7

Large [Amphibious](../Trait/Traits.aspx-ID=529.md) [Giant](../Trait/Traits.aspx-ID=616.md) [Humanoid](../Trait/Traits.aspx-ID=628.md) [Water](../Trait/Traits.aspx-ID=732.md)
Source [Monster Core pg. 164](../Source/Sources.aspx-ID=221.md)
...
Perception +14; [low-light vision](../MonsterAbility/MonsterAbilities.aspx-ID=69.md)
Languages [Aklo](../Language/Languages.aspx-ID=13.md), [Common](../Language/Languages.aspx-ID=1.md), [Jotun](../Language/Languages.aspx-ID=8.md), [Thalassic](../Language/Languages.aspx-ID=113.md)
Skills [Athletics](../Skill/Skills.aspx-ID=36&Redirected=1.md) +16, Intimidation +13, Nature +13, Religion +15
Str +6, Dex +3, Con +4, Int +0, Wis +3, Cha +1
Items +1 [striking](../Equipment/Equipment.aspx-ID=2829.md) gaff
...
Melee [one-action] gaff +18 [+13/+8] (magical, reach 10 feet, trip, versatile P), Damage 2d6-2+14 bludgeoningMelee [one-action] fist +18 [+14/+10] (agile, reach 10 feet), Damage 2d6-2+14 bludgeoningRanged [one-action] spit +18 [+13/+8] (primal, [range 60 feet](../Trait/Traits.aspx-ID=248.md), water), Damage 5d6-2 bludgeoningOccult Innate Spells DC 21 (-4 dmg); 5th mariner's curse; 2nd augury, [mist](../Spell/Spells.aspx-ID=1606.md)
Drowning Hook [one-action] (primal, water) Requirements A creature is [prone](../Condition/Conditions.aspx-ID=88.md) within the marsh giant's reach; Effect The marsh giant uses its gaff to push the creature down as water bubbles up below it. The target becomes submerged in water until they are no longer prone and must hold their breath if they cannot breathe water. They take 4d6 bludgeoning damage (DC 21 basic Fortitude save) and lose 3 rounds worth of air if they fail the save.Twist the Hook [two-actions] The marsh giant makes a melee Strike with its gaff. If it hits, it twists and yanks the gaff to knock the target [prone](../Condition/Conditions.aspx-ID=88.md) and create an awful wound, dealing 2d6 [persistent bleed damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md) to the creature.
...
| [Ash Giant](./Monsters.aspx-ID=4410.md)
| 11

| [Cave Giant](./Monsters.aspx-ID=4408.md)
| 6

| Cloud Giant
| 11

| [Desert Giant](./Monsters.aspx-ID=4409.md)
| 6
...
| [Marsh Giant](./Monsters.aspx-ID=3011.md)
| 8
...
| [Tide Giant](./Monsters.aspx-ID=4412.md)
| 13

| [Tomb Giant](./Monsters.aspx-ID=4411.md)
| 12
...
Source [Monster Core pg. 164](../Source/Sources.aspx-ID=221.md)
Giants are massive humanoid creatures who live in remote regions throughout the world. They vary widely but are united in their hunger, requiring sustenance of their own element along with the feasts one would expect from such a massive humanoid. Although a simple matter for some giants, more esoteric types find this need a harsh reality. While a massive fistful of ice or snow alongside their meal will satisfy a frost giant, shadow giants hunger for the coagulated shadows of [the Netherworld](../Plane/Planes.aspx-ID=36.md).
