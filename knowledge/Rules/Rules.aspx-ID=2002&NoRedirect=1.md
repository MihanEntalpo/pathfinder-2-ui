# Basics of Play - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=2002&NoRedirect=1.htm`
...
Source [Player Core pg. 6](../Source/Sources.aspx-ID=216.md)
