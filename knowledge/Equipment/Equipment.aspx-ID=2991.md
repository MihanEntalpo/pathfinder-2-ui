# Savior Spike - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2991.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Savior SpikeItem 2

[Consumable](../Trait/Traits.aspx-ID=564.md) [Force](../Trait/Traits.aspx-ID=610.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
Source [GM Core pg. 267](../Source/Sources.aspx-ID=218.md)
Price 7 gp
Usage affixed to armor; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger You attempt to Grab an Edge but haven't rolled
