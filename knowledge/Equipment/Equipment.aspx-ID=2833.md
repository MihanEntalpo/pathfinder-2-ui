# Brilliant - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2833.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)BrilliantItem 12+

[Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 236](../Source/Sources.aspx-ID=218.md)
...
Activate—Shine Bright [one-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md), light); Effect You plunge your weapon into darkness to return the light. Attempt a counteract check with a counteract rank of 5 and a +19 counteract modifier to end a magical darkness effect whose area is within reach of the weapon.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Brilliant (Greater)Item 18

Source [GM Core pg. 236](../Source/Sources.aspx-ID=218.md)
Price 24,000 gp
The save DC is 41, the counteract rank is 9, the counteract modifier is +31, and damage dealt by this weapon ignores the target's resistances to fire, spirit, and vitality
