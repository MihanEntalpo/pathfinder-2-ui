# Peace in Dreams Tea - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4079.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Peace in Dreams TeaItem 6

## This Item may contain spoilers from the Season of Ghosts Adventure Path

Uncommon Consumable Magical Potion [Tea](../Trait/Traits.aspx-ID=738.md)
Source [Season of Ghosts (Hardcover) pg. 300](../Source/Sources.aspx-ID=294.md)
Price 50 gp
Usage held in 1 hand; Bulk L
Activate [one-action] ([manipulate](../Trait/Traits.aspx-ID=645.md))

---

This creamy tea is made from warm soy milk steeped with whole, dried chrysanthemum flowers and honey and brewed from when the sun first touches the horizon to when it has fully set. Consuming this tea causes mild drowsiness, aids in sleep, and protects from harmful mental effects. You gain a +1 item bonus to all saving throws against [mental](../Trait/Traits.aspx-ID=647.md) effects for 1 hour.

---

Activate—Tea Ceremony 10 minutes ([concentrate](../Trait/Traits.aspx-ID=561.md), [manipulate](../Trait/Traits.aspx-ID=645.md)) The effects last for 8 hours, and as long as you’re asleep, the item bonus increases to +2.
