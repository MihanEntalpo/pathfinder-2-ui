# Dispelling Sliver - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2969.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Dispelling SliverItem 17

[Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
Source [GM Core pg. 264](../Source/Sources.aspx-ID=218.md)
Price 2,400 gp
Usage affixed to a weapon; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger Your Strike damages a target

---

Made from a treated sliver of cold iron, this talisman allows you to counteract magical effects. When you activate the dispelling sliver, it attempts to counteract a single spell active on the target (counteract modifier +29), with the effects of an 8th-rank dispel magic spell.
If you activate the talisman on a successful Dispelling Slice, the talisman attempts to counteract all spells active on the target, in addition to your attempt from Dispelling Slice.
