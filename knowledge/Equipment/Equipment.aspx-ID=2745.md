# Religious Symbol - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2745.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Religious SymbolItem 0+

javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Religious_Symbol.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Religious_Symbol.webp%27Source [Player Core pg. 290](../Source/Sources.aspx-ID=216.md)
Bulk &mdash;
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Religious Symbol (Wooden)Item 0

Source [Player Core pg. 290](../Source/Sources.aspx-ID=216.md)
Price 1 sp
Hands 1; Bulk L

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Religious Symbol (Silver)Item 0
