...
Source HTML: `docs/aonprd/Ancestries.aspx-ID=65.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Leshy Details](./Ancestries.aspx-ID=65.md) | Leshy Feats | Universal Ancestry Feats | Leshy Heritages

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Leshy](./Ancestries.aspx-ID=65.md)

[Leshy](../Trait/Traits.aspx-ID=639.md) [Plant](../Trait/Traits.aspx-ID=668.md)
Source [Player Core pg. 57](../Source/Sources.aspx-ID=216.md)
...
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Draconic](../Language/Languages.aspx-ID=2.md), [Elven](../Language/Languages.aspx-ID=4.md), [Gnomish](../Language/Languages.aspx-ID=5.md), [Goblin](../Language/Languages.aspx-ID=6.md), [Halfling](../Language/Languages.aspx-ID=7.md), [Sakvroth](../Language/Languages.aspx-ID=118.md), and any other languages to which you have access (such as the languages prevalent in your region).
