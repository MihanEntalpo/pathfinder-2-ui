# Propulsive Boots - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3101.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Propulsive BootsItem 13

[Invested](../Trait/Traits.aspx-ID=637.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 294](../Source/Sources.aspx-ID=218.md)
Price 3,000 gp
...
Activate—Quickening Stomp [one-action] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Frequency once per day; Effect You stomp three times and gain the quickened condition for 1 minute. You can use the extra action to Stride, Climb, or Swim. (You must still attempt an Athletics check for the Climb and Swim actions unless you have the appropriate movement type.)
