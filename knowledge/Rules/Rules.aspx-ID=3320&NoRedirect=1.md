# Mythic Rules - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3320&NoRedirect=1.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

# [Mythic Rules](./Rules.aspx-ID=3320.md)

Source [War of Immortals pg. 76](../Source/Sources.aspx-ID=232.md)

This section presents the rules for creating mythic characters to play in mythic campaigns.

## [Mythic Characters](./Rules.aspx-ID=3321.md)
...
### [Mythic Proficiency](./Rules.aspx-ID=3322.md)
...
### [Mythic Points](./Rules.aspx-ID=3323.md)
...
#### [Recovering Mythic Points](./Rules.aspx-ID=3325.md)
...
### [Death and Dying as a Mythic Character](./Rules.aspx-ID=3328.md)
...
## [Mythic Progression](./Rules.aspx-ID=3329.md)
...
### [Rewrite Fate](../Action/Actions.aspx-ID=2983.md) [free-action]

[Uncommon](../Trait/Traits.aspx-ID=721.md) [Fortune](../Trait/Traits.aspx-ID=612.md) [Mythic](../Trait/Traits.aspx-ID=835.md)
Source [War of Immortals pg. 78](../Source/Sources.aspx-ID=232.md)
...
### [Mythic Callings](./Rules.aspx-ID=3330.md)
...
#### [Edicts and Anathema](./Rules.aspx-ID=3331.md)
...
## [Designing Mythic Encounters](./Rules.aspx-ID=3332.md)
...
When adventuring in the wilds, these same principles apply, but the obstacles might be mighty rivers, sheer and otherwise unscalable cliffs, or other types of natural boundaries that divide the world and prevent lesser mortals from proceeding.

As the GM of a mythic campaign, it's important for you to know what Callings and feats your characters have available and that you're prepared when the players use these resources to take the story in a different direction.

The essence of mythic adventure is that the players are able to interact with the story and influence the narrative beyond what a normal character can do, and it's important that they be presented opportunities to do so!

### [1st-5th Level](./Rules.aspx-ID=3336.md)
...
### [6th-10th Level](./Rules.aspx-ID=3337.md)
...
### [12th-20th Level](./Rules.aspx-ID=3338.md)
...
## [Mythic Runes](./Rules.aspx-ID=3339.md)
...
## [Mythic Monster Templates](./Rules.aspx-ID=3340.md)
...
### [Basic Mythic Abilities](./Rules.aspx-ID=3341.md)
...
- Recharge [one-action] ([concentrate](../Trait/Traits.aspx-ID=561.md)) Cost 1 Mythic Point; Effect The creature gains one additional use of a spell or ability that is normally only available a limited number of times. For example, a spellcaster can regain an expended slot or use an ability with a frequency of once per day again.
- Remove a Condition [one-action] ([concentrate](../Trait/Traits.aspx-ID=561.md)) Cost 1 Mythic Point; Effect The creature ends one condition affecting it.
- Reroll [free-action] ([fortune](../Trait/Traits.aspx-ID=612.md)) Cost 1 Mythic Point; Trigger The creature fails a check; Effect The creature rerolls the check.
...
| 1
| Mythic resilience (one save) or mythic resistance
...
| 4
| Mythic power (Mythic Skill or Remove a Condition)
...
| 20
| Mythic power (Reroll) or mythic defenses
...
| 23+
| Mythic immunity (Strikes or spells)

## Related Rules

[Mythic Variant Rules](./Rules.aspx-ID=3343.md)
(
Source [War of Immortals Alternate Mythic Rules pg. 2](../Source/Sources.aspx-ID=233.md)
)
