# Terrified Retreat - Feats - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Feats.aspx-ID=5225.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Terrified Retreat](./Feats.aspx-ID=5225.md) Feat 7

General Skill
Source [Player Core pg. 263](../Source/Sources.aspx-ID=216.md)

Prerequisites master in Intimidation

---

When you critically succeed at the Demoralize action, if the target's level is lower than yours, the target is [fleeing](../Condition/Conditions.aspx-ID=74.md) for 1 round.
