# Acid Flask - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2875.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Acid FlaskItem 1+

[Acid](../Trait/Traits.aspx-ID=524.md) [Alchemical](../Trait/Traits.aspx-ID=528.md) [Bomb](../Trait/Traits.aspx-ID=548.md) [Consumable](../Trait/Traits.aspx-ID=564.md) [Splash](../Trait/Traits.aspx-ID=699.md)
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Acid_Flask.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Acid_Flask.webp%27Source [GM Core pg. 244](../Source/Sources.aspx-ID=218.md), [Player Core 2 pg. 283](../Source/Sources.aspx-ID=227.md); There is a more recent version of this item. Click here to view.
Usage held in 1 hand; Bulk L
Activate [one-action] Strike

---

This flask filled with corrosive acid deals 1 acid damage, the listed [persistent acid damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md), and the listed acid splash damage. Many types grant an item bonus to attack rolls.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Acid Flask (Lesser)Item 1

Source [GM Core pg. 244](../Source/Sources.aspx-ID=218.md)
Price 3 gp
The bomb deals 1d6 persistent acid damage and 1 acid splash damage.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Acid Flask (Moderate)Item 3

Source [GM Core pg. 244](../Source/Sources.aspx-ID=218.md)
Price 10 gp
You gain a +1 item bonus to attack rolls. The bomb deals 2d6 persistent acid damage and 2 acid splash damage.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Acid Flask (Greater)Item 11

Source [GM Core pg. 244](../Source/Sources.aspx-ID=218.md)
Price 250 gp
You gain a +2 item bonus to attack rolls. The bomb deals 3d6 persistent acid damage and 3 acid splash damage.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Acid Flask (Major)Item 17
