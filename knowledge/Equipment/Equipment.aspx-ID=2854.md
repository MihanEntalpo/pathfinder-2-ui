# Wounding - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2854.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)WoundingItem 7

[Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 239](../Source/Sources.aspx-ID=218.md)
Price 340 gp
Usage etched onto a piercing or slashing melee weapon; Bulk &mdash;

---

Weapons with wounding runes are said to thirst for blood. When you hit a creature with a wounding weapon, you deal an extra 1d6 [persistent bleed damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md).
