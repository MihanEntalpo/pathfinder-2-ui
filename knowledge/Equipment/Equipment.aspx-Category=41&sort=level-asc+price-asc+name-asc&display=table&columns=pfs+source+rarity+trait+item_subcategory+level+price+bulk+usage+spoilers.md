# Worn Items - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=41&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+item_subcategory+level+price+bulk+usage+spoilers.htm`
...
Source [Core Rulebook pg. 603](../Source/Sources.aspx-ID=1.md)
...
[Click here for the full rules on Worn Items](../Rules/Rules.aspx-ID=768.md).

Quick display options: [Short](./Equipment.aspx-Category=41&sort=level-asc+price-asc+name-asc&display=short.md) | [Table](./Equipment.aspx-Category=41&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+item_subcategory+level+price+bulk+usage+spoilers.md)
