# Hellfire Boots - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3088.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Hellfire BootsItem 13

[Fire](../Trait/Traits.aspx-ID=604.md) [Invested](../Trait/Traits.aspx-ID=637.md) [Occult](../Trait/Traits.aspx-ID=662.md)
Source [GM Core pg. 290](../Source/Sources.aspx-ID=218.md)
Price 3,000 gp
...
Activate—Devil's Dance [two-actions] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Frequency once per minute; Effect You Stride. Each square you move through during your Stride is scorched with hellish flames, becoming hazardous terrain for 1 minute. A creature that moves through one of these spaces takes 3d6 fire damage.
