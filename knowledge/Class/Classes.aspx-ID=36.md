# Ranger - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=36.htm`
...
## [Ranger Details](./Classes.aspx-ID=36.md) | Ranger Feats | Ranger Focus Spells | Ranger Kits | Ranger Sample Builds | [Hunter's Edge](../HuntersEdge/HuntersEdge.aspx.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Ranger

Source [Player Core pg. 152](../Source/Sources.aspx-ID=216.md)
...
Press: Actions with this trait allow you to follow up earlier attacks. An action with the press trait can be used only if you are currently affected by a multiple attack penalty. You can't use a press action when it's not your turn, even if you use the [Ready](../Equipment/Equipment.aspx-ID=2792.md) activity.
...
| 1
| Ancestry and background, attribute boosts, initial proficiencies, hunt prey, hunter’s edge, ranger feat
...
| 15
| Attribute boosts, general feat, greater natural reflexes, greater weapon specialization, perception legend, skill increase
...
[Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) Ranger
Source [Player Core pg. 154](../Source/Sources.aspx-ID=216.md)
...
You always find the weak points in your foes' defenses when they're on unfavorable terrain. Enemies are [off-guard](../Condition/Conditions.aspx-ID=58.md) to you if they're in [difficult terrain](../Rules/Rules.aspx-ID=2366&Redirected=1.md).
...
You move quickly through obstacles, whether they're tumbled stone or tangled undergrowth. You can ignore the effects of [difficult terrain](../Rules/Rules.aspx-ID=2366&Redirected=1.md). As normal for ignoring difficult terrain, this also lets you treat the hindrances of greater difficult terrain as those of difficult terrain.
