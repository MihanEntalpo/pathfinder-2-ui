# Chapter 4: Skills - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=2134.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

[>](./Rules.aspx-ID=2142.md)

# [Chapter 4: Skills](./Rules.aspx-ID=2134.md)

Source [Player Core pg. 225](../Source/Sources.aspx-ID=216.md)
...
The GM sets the DC of a skill check, using the [GM Core guidelines](./Rules.aspx-ID=2627.md) . The DCs you're most likely to encounter frequently are the five simple skill DCs below, which are presented here to give you a sense of what number you'll need to roll to succeed at most tasks.
