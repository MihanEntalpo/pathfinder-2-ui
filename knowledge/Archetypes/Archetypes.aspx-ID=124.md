# Gray Gardener - Archetypes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Archetypes.aspx-ID=124.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Gray Gardener](./Archetypes.aspx-ID=124.md)

### Legacy Content

Source [Night of the Gray Death pg. 64](../Source/Sources.aspx-ID=99.md)
...
Your two identities are completely distinct. You have your current identity's alignment for effects that rely on alignment, though you are eligible for abilities that require a certain alignment (such as a cleric's deity) only if both of your identities qualify. Checks to Recall Knowledge about one of your identities don't reveal information about the other unless the person attempting the check knows both identities are the same person. Effects that detect you based on your identity, such as the [detect alignment](../Spell/Spells.aspx-ID=65.md) spell, work only if you are currently in the identity the effect is trying to detect; otherwise, the effect fails as if the target didn't exist.

To maintain the separation between your identities, some of your abilities have one of two traits: [social](../Trait/Traits.aspx-ID=325.md) or vigilante. You can use social feats only while in your social identity. Your class feats and vigilante feats are associated with your vigilante identity, and using them while in your social identity risks exposing you as a vigilante. This means that if you were particularly meek or inconspicuous before you took this feat, your identity could be at greater risk of exposure. If your identity is exposed to the public, you lose the benefits of Vigilante Dedication to disguising yourself, but you can otherwise use both social and vigilante abilities in either identity unless they rely on your identity being a secret. You can use feats that don't have either trait regardless of your current identity.

Special You can't select another dedication feat until you have gained two other feats from the vigilante archetype.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Executioner Weapon Training Feat 4

### Legacy Content

Archetype
Source [Night of the Gray Death pg. 64](../Source/Sources.aspx-ID=99.md)
Archetype [Gray Gardener](./Archetypes.aspx-ID=124.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Harsh Judgment [one-action] Feat 4
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Voice of Authority Feat 4

### Legacy Content

Archetype [Auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md) Vigilante
Source [Night of the Gray Death pg. 64](../Source/Sources.aspx-ID=99.md)
Archetype [Gray Gardener](./Archetypes.aspx-ID=124.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Discerning Gaze Feat 6

### Legacy Content

Archetype
Source [Night of the Gray Death pg. 65](../Source/Sources.aspx-ID=99.md)
Archetype [Gray Gardener](./Archetypes.aspx-ID=124.md)
Prerequisites Vigilante Dedication; member of the Gray Gardeners
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Frightful Condemnation [free-action] Feat 6
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Accurate Swing Feat 8
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Gardener's Resolve [reaction] Feat 8
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Strident Command Feat 10
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Execution [two-actions] Feat 14
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Terrifying Countenance [free-action] Feat 18
