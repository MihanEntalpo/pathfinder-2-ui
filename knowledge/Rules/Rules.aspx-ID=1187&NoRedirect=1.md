# Chapter 3: Subsystems - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=1187&NoRedirect=1.htm`
...
- Victory Points provides you a framework with which to build your own subsystems, detailing the fundamental structure that Pathfinder uses for its subsystems.
...
[Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) Linguistic
...
Traits A succinct description of the NPC, such as “Famous musician” or “Popular baron.”
...
LE Medium Human Humanoid Penny-pinching landlord
Perception +9
Will +12
...
[Move](../Trait/Traits.aspx-ID=658&Redirected=1.md) Reckless
