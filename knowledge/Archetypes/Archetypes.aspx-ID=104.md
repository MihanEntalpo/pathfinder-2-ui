# Wellspring Mage - Archetypes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Archetypes.aspx-ID=104.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Wellspring Mage](./Archetypes.aspx-ID=104.md)

### Legacy Content

Source [Secrets of Magic pg. 248](../Source/Sources.aspx-ID=96.md)
...
| 1
| Energy Unleashed ([evocation](../Trait/Traits.aspx-ID=65.md)) Raw energy deals 2d6 damage per spell level of the surge (basic Reflex save) in a 10-foot burst.

| 2
| Positive Energy Expulsion (healing, [necromancy](../Trait/Traits.aspx-ID=117.md), positive) Positive energy explodes outward, healing living creatures for 1d8 Hit Points per spell level of the surge in a 20-foot burst. Undead creatures instead take the same amount of positive damage, with a basic Will save.

| 3
| Mass Siphon ([transmutation](../Trait/Traits.aspx-ID=157.md)) Creatures and objects within a 30-foot emanation become nearly weightless until the end of your next turn. Nearly weightless creatures can Climb at their land Speed and can Leap as far upward as they could normally Leap horizontally.

| 4
| Magical Nemesis ([conjuration](../Trait/Traits.aspx-ID=33.md), teleportation) A random creature connected to your magic (or inimical to it) appears within 60 feet. The creature should be of a level approximately equal to the level of an animal summoned by summon animal of the spell level, although it can be of any type. The GM determines the specific creature. The creature is unfriendly to you and friendly to your apparent enemies. After 1 minute, the creature can choose either to return where it came from or to remain. It is not summoned or a minion.

| 5
| Monstrous Transformation (mental, morph, [transmutation](../Trait/Traits.aspx-ID=157.md)) Your head and arms transform into an exaggerated imitation of a creature connected to your magic for 1 minute. The GM determines the creature. You gain a status bonus to weapon and unarmed damage rolls equal to the spell level. At the start of each of your turns while you are transformed, you must succeed at a Will saving throw or be confused until the start of your next turn. On a critical success, you can choose to end the effect entirely, also losing the status bonus.

| 6
| Sudden Gale (air, [evocation](../Trait/Traits.aspx-ID=65.md)) Weather in a 40-foot emanation is disturbed. Strong winds blow in a random direction for 1 minute. Each creature that starts its turn in the area must succeed at a Fortitude save or fall [prone](../Condition/Conditions.aspx-ID=88&Redirected=1.md) (and be pushed 10 feet on a critical failure), and you must succeed at this save immediately after the surge. Any movement against the wind is difficult terrain, or greater difficult terrain while flying.

| 7
| Tremor (earth, [evocation](../Trait/Traits.aspx-ID=65.md)) The earth trembles in a 40-foot emanation. Each creature on a surface must immediately succeed at a Fortitude save or fall prone. The surface then becomes difficult terrain for 1 minute.

| 8
| Oppressive Voice ([divination](../Trait/Traits.aspx-ID=47.md), mental, nonlethal) The voice of your muse, your deity, an ancestor, or another appropriate entity suddenly overwhelms your mind. You must attempt a Will saving throw. You take 1d4 mental damage per spell level with a basic Will save. On a failure, you're also stunned 1 (stunned 2 on a critical failure).

| 9
| Trinket Squall (illusion) Visual illusions of objects related to your magic fall like rain throughout a 40-foot burst for 1 minute, giving concealment in the area. Creatures can attempt to disbelieve this illusion.

| 10
| Antimagic Eruption ([abjuration](../Trait/Traits.aspx-ID=2.md)) The surge attempts to counteract a random spell active on you and on each creature within a 10-foot burst.

| 11
| Mental Broadcast (detection, [divination](../Trait/Traits.aspx-ID=47.md), mental) For 1 minute, everyone within 30 feet of you can hear your surface thoughts.

| 12
| Verdant Clutch ([conjuration](../Trait/Traits.aspx-ID=33.md), plant) Plants and vines grow from all surfaces within 20 feet, causing all creatures in the area to be [immobilized](../Condition/Conditions.aspx-ID=81&Redirected=1.md) unless they succeed at a Reflex save. The Escape DC is equal to the spell DC.

| 13
| Tinge of Terror (emotion, [enchantment](../Trait/Traits.aspx-ID=61.md), fear, mental) All creatures within 20 feet are affected by powerful fright. They attempt a Will save, becoming frightened 1 on a failure or frightened 2 on a critical failure.

| 14
| Strike up the Band ([auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md), illusion) For 1 minute, you are followed by orchestral theme music tied to the emotional content of the actions you're performing. This grants you a +2 status bonus to Diplomacy, Intimidation, and Performance checks, a –2 status penalty to [Deception](../Skill/Skills.aspx-ID=38&Redirected=1.md) checks, and makes certain uses of [Stealth](../Skill/Skills.aspx-ID=48&Redirected=1.md) virtually impossible. It might have other effects as the GM sees fit.

| 15
| Life Sap ([necromancy](../Trait/Traits.aspx-ID=117.md)) The surge drains your life force and strength. You become drained 1 and doomed 1, and you are enfeebled 2 for 1 minute.

| 16
| Ablative Barrier ([abjuration](../Trait/Traits.aspx-ID=2.md)) Energy forms a protective barrier that ablates slowly as creatures in the area take damage. All creatures in a 40-foot burst gain resistance to all damage equal to double the surge's spell level for up to 1 minute. Whenever a creature applies this resistance, the resistance for all affected creatures reduces by 1. The effect ends for all creatures when it reduces to 0.
...
Source [Player Core pg. 215](../Source/Sources.aspx-ID=216.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Wellspring Mage Dedication Feat 2

### Legacy Content

Rare Archetype [Class](../Trait/Traits.aspx-ID=397.md) Dedication
Source [Secrets of Magic pg. 249](../Source/Sources.aspx-ID=96.md)
Archetype [Wellspring Mage](./Archetypes.aspx-ID=104.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Wellspring Control Feat 4
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Urgent Upwelling [reaction] Feat 6
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Energetic Resonance [reaction] Feat 8

### Legacy Content

[Abjuration](../Trait/Traits.aspx-ID=2.md) Sorcerer
Source [Advanced Player's Guide pg. 139](../Source/Sources.aspx-ID=39.md)
Archetype [Wellspring Mage](./Archetypes.aspx-ID=104.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Spell Relay [reaction] Feat 8

### Legacy Content

[Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) Sorcerer
Source [Advanced Player's Guide pg. 139](../Source/Sources.aspx-ID=39.md)
Archetype [Wellspring Mage](./Archetypes.aspx-ID=104.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Surging Might [one-action] Feat 10

### Legacy Content

[Manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md) Metamagic Oracle
Source [Advanced Player's Guide pg. 80](../Source/Sources.aspx-ID=39.md)
Archetype [Wellspring Mage](./Archetypes.aspx-ID=104.md)

---

With a complex gesture, you focus the divine power of your spell to overcome enemies' resistances. If the next action you use is to Cast a Spell, the spell ignores an amount of the target's resistance equal to your level against all the following types of damage: chaotic, evil, good, lawful, negative, and positive. This applies to all damage the spell deals, including [persistent damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md) and damage caused by an ongoing effect of the spell, such as the positive energy within a field of life. This doesn't cause the spell to ignore immunities, only resistances.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Interfering Surge [reaction] Feat 12

### Legacy Content

[Abjuration](../Trait/Traits.aspx-ID=2.md) Archetype
Source [Secrets of Magic pg. 249](../Source/Sources.aspx-ID=96.md)
Archetype [Wellspring Mage](./Archetypes.aspx-ID=104.md)
Prerequisites Wellspring Mage Dedication
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Scintillating Spell [one-action] Feat 16

### Legacy Content

[Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) Light Metamagic Sorcerer
Source [Advanced Player's Guide pg. 141](../Source/Sources.aspx-ID=39.md)
Archetype [Wellspring Mage](./Archetypes.aspx-ID=104.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Echoing Spell [one-action] Feat 18

### Legacy Content

[Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) Metamagic Sorcerer
Source [Advanced Player's Guide pg. 141](../Source/Sources.aspx-ID=39.md)
Archetypes Time Mage, [Wellspring Mage](./Archetypes.aspx-ID=104.md)
