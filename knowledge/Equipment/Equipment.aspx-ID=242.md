# Dust of Disappearance - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=242.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Dust of DisappearanceItem 9

### Legacy Content

Uncommon Consumable Illusion Magical
Source [Core Rulebook pg. 570](../Source/Sources.aspx-ID=1.md)
Price 135 gp
Bulk &mdash;
...
This powder shimmers like a thousand tiny motes of light. Activating the dust by sprinkling it on yourself or a creature within reach casts a 4th-level [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md) spell with a duration of 1 minute on that creature. This invisibility can’t be negated or seen through by any spell of 3rd level or lower or any item of 5th level or lower.
