# Theme Templates - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=797&NoRedirect=1.htm`
...
Source [Character Guide pg. 116](../Source/Sources.aspx-ID=12.md)
...
This entry applies to all creatures that have the theme template applied, regardless of level. For example, if a template states to add the [lawful](../Trait/Traits.aspx-ID=99.md) trait and remove the [chaotic](../Trait/Traits.aspx-ID=25.md) trait, that would alter a creature's alignment from chaotic evil to lawful evil.
