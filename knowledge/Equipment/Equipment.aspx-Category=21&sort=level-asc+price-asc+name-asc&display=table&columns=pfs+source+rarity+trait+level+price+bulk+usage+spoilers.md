# Held Items - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=21&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+price+bulk+usage+spoilers.htm`
...
Source [Core Rulebook pg. 572](../Source/Sources.aspx-ID=1.md)
These items need to be held to use them. Weapons, wands, and staves follow special rules and have their own sections.

[Click here for the full rules on Held Items](../Rules/Rules.aspx-ID=728.md).

Quick display options: [Short](./Equipment.aspx-Category=21&sort=level-asc+price-asc+name-asc&display=short.md) | [Table](./Equipment.aspx-Category=21&sort=level-asc+price-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+price+bulk+usage+spoilers.md)
