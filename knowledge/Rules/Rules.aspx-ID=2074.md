# Chapter 2: Ancestries & Backgrounds - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=2074.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

[>](./Rules.aspx-ID=2098.md)

# [Chapter 2: Ancestries & Backgrounds](./Rules.aspx-ID=2074.md)

Source [Player Core pg. 41](../Source/Sources.aspx-ID=216.md)
...
This tells you the languages that members of the ancestry speak at 1st level. If your Intelligence modifier is +1 or higher, you can select more languages from a list given here. More about languages can be found here.
...
| Common
| Humans, dwarves, elves, halflings, and other common ancestries

| Draconic
| Dragons, reptilian humanoids
...
| Fey
| Fey, centaurs, plant and fungus creatures
...
| Sakvroth
| Subterranean civilizations, serpentfolk
...
| Aklo
| Evil fey, otherworldly monsters
...
| Empyrean
| Angels and other celestials

| Kholo
| The hyena-like kholos

| Necril
| Ghouls, intelligent undead
...
| Shadowtongue
| Nidalese, Netherworld creatures

| Sussuran
| Air elemental creatures, flying creatures

| Thalassic
| Aquatic creatures, water elemental creatures
