# Firecraker Fulu - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4083.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Firecraker FuluItem 1

## This Item may contain spoilers from the Season of Ghosts Adventure Path

Rare Consumable [Fulu](../Trait/Traits.aspx-ID=378.md) Magical Talisman
Source [Season of Ghosts (Hardcover) pg. 301](../Source/Sources.aspx-ID=294.md)
Price 4 gp
Usage affixed to a weapon; Bulk L
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561.md)) Trigger You critically succeed at an attack roll with the affixed weapon.

---

The fulu explodes and showers the area with bright sparks. The struck creature takes an additional 1d4 sonic damage and must succeed at a DC 15 Fortitude save or be [dazzled](../Condition/Conditions.aspx-ID=65.md) for 1 round (or dazzled for 1 minute on a critical failure).
