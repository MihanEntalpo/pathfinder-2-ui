# Force Shield - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2820.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Force ShieldItem 9

[Uncommon](../Trait/Traits.aspx-ID=721.md) [Force](../Trait/Traits.aspx-ID=610.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 234](../Source/Sources.aspx-ID=218.md)
Price 650 gp
Usage held in 1 hand; Bulk L
Base Shield [Steel Shield](../Shield/Shields.aspx-ID=19.md)

---

The edges of this elaborately engraved steel shield (Hardness 8, HP 32, BT 16) bear tiny glass tiles set in mosaic patterns.

Activate—Force Bubble [one-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md), [force](../Trait/Traits.aspx-ID=610.md)); Frequency once per day; Effect The shield surrounds you with a bubble of force that protects you from harm, granting you resistance 5 to physical damage for 1 minute. The activation ends if you cease holding the shield.
