# Lover's Gloves - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3093.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Lover's GlovesItem 8

[Emotion](../Trait/Traits.aspx-ID=590.md) [Invested](../Trait/Traits.aspx-ID=637.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Mental](../Trait/Traits.aspx-ID=647.md)
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Lovers_Gloves.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Lovers_Gloves.webp%27Source [GM Core pg. 292](../Source/Sources.aspx-ID=218.md)
Price 500 gp
Usage worn gloves; Bulk &mdash;
