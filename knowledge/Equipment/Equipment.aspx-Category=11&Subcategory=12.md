# Precious Material Armor - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=11&Subcategory=12.htm`
...
Source [Core Rulebook pg. 555](../Source/Sources.aspx-ID=1.md)
...
Click here for the full rules on Precious Material Armor.
