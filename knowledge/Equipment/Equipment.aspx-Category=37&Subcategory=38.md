# Precious Material Weapons - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=37&Subcategory=38.htm`
...
Source [Core Rulebook pg. 599](../Source/Sources.aspx-ID=1.md)
...
Click here for the full rules on Precious Material Weapons.
