# Bottled Air - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3017.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Bottled AirItem 7

[Air](../Trait/Traits.aspx-ID=527.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 273](../Source/Sources.aspx-ID=218.md)
Price 320 gp
...
Activate—Breath In [one-action] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Effect You draw a breath of air from the bottle. This allows you to breathe even in an airless or toxic environment. Air doesn't escape the mouth of the bottle, so leaving the open bottle in an airless environment doesn't change the environment.
