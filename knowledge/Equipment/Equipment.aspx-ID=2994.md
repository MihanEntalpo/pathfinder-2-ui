# Swift Block Cabochon - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2994.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Swift Block CabochonItem 7

[Uncommon](../Trait/Traits.aspx-ID=721.md) [Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
Source [GM Core pg. 267](../Source/Sources.aspx-ID=218.md)
Price 70 gp
Usage affixed to a shield; Bulk &mdash;
Activate [reaction] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger You take damage from a physical attack while you don't have the affixed shield raised
