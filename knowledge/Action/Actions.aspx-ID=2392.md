# Make an Impression - Actions - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Actions.aspx-ID=2392.htm`

# [Actions](./Actions.aspx.md) | [Activities](./Activities.aspx.md)

---

# [Make an Impression](./Actions.aspx-ID=2392.md)

[Auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md) [Concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md) [Exploration](../Trait/Traits.aspx-ID=595.md) Linguistic Mental
Source [Player Core pg. 239](../Source/Sources.aspx-ID=216.md)
Skill [Diplomacy (Untrained)](../Skill/Skills.aspx-ID=39.md)
