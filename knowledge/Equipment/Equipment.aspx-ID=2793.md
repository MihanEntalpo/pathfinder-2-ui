# Shadow - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2793.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)ShadowItem 5+

[Magical](../Trait/Traits.aspx-ID=644.md) [Shadow](../Trait/Traits.aspx-ID=693.md)
Source [GM Core pg. 227](../Source/Sources.aspx-ID=218.md)
Usage etched onto light or medium armor; Bulk &mdash;

---

Armor etched with this rune takes on a hazy black appearance. You gain a +1 item bonus to [Stealth](../Skill/Skills.aspx-ID=48&Redirected=1.md) checks while wearing the armor.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Shadow (Greater)Item 9

Source [GM Core pg. 227](../Source/Sources.aspx-ID=218.md)
Price 650 gp
The item bonus is +2.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Shadow (Major)Item 17
