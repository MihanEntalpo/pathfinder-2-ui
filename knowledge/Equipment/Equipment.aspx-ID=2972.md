# Emerald Grasshopper - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2972.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Emerald GrasshopperItem 5+
...
Activate [one-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Requirements You are trained in Athletics
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Emerald Grasshopper (Greater)Item 9

Source [GM Core pg. 264](../Source/Sources.aspx-ID=218.md)
Price 150 gp
The distance of your Leap is up to 100 feet horizontally and up to 30 feet vertically. This benefit applies to any other Leaps you make before the end of your turn.
