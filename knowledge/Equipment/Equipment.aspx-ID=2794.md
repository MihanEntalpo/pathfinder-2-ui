# Slick - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2794.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)SlickItem 5+

[Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 227](../Source/Sources.aspx-ID=218.md)
Usage etched onto armor; Bulk &mdash;

---

This property makes armor slippery, as though it were coated with a thin film of oil. You gain a +1 item bonus to [Acrobatics](../Skill/Skills.aspx-ID=34&Redirected=1.md) checks to Escape and Squeeze.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Slick (Greater)Item 8

Source [GM Core pg. 227](../Source/Sources.aspx-ID=218.md)
Price 450 gp
The item bonus is +2.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Slick (Major)Item 16
