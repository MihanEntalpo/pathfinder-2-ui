# Sterling Dynamo - Archetypes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Archetypes.aspx-ID=110.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Sterling Dynamo](./Archetypes.aspx-ID=110.md)
...
Source [Guns & Gears pg. 52](../Source/Sources.aspx-ID=98.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Sterling Dynamo Dedication Feat 2

Uncommon Archetype Dedication
Source [Guns & Gears pg. 52](../Source/Sources.aspx-ID=98.md)
Archetype [Sterling Dynamo](./Archetypes.aspx-ID=110.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Modular Dynamo Feat 4

Archetype
Source [Guns & Gears pg. 53](../Source/Sources.aspx-ID=98.md)
Archetype [Sterling Dynamo](./Archetypes.aspx-ID=110.md)
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Piston Punch [two-actions] Feat 6
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Stasian Smash [two-actions] Feat 8
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Beast Dynamo Howl [two-actions] Feat 10
...
You've incorporated beast tech from Arcadia into your dynamo, adding in components from various terrifying creatures to enhance your prosthesis's capabilities. The beast parts can unleash a disturbing howl as you make a powerful attack with your dynamo. Attempt [Intimidation](../Skill/Skills.aspx-ID=40.md) checks to [Demoralize](../Action/Actions.aspx-ID=2395.md) against each enemy within 30 feet; you don't take a penalty when you attempt to Demoralize a creature that doesn't understand your language. Then, make a dynamo Strike. Reduce the operational time of your sterling dynamo by 1 hour.

## [PFS.aspx.htm](../PFS/PFS.aspx.md)Golem Dynamo Feat 12

Uncommon Archetype
Source [Guns & Gears pg. 53](../Source/Sources.aspx-ID=98.md)
Archetype [Sterling Dynamo](./Archetypes.aspx-ID=110.md)
Prerequisites Sterling Dynamo Dedication
Access You are an [automaton](../Ancestry/Ancestries.aspx-ID=48.md) or are otherwise from the ancient Jistka Imperium.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Soaring Dynamo Feat 18
