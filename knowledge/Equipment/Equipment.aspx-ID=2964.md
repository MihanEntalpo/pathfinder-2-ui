# Basilisk Eye - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2964.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Basilisk EyeItem 9

[Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md) [Talisman](../Trait/Traits.aspx-ID=709.md) [Visual](../Trait/Traits.aspx-ID=727.md)
Source [GM Core pg. 263](../Source/Sources.aspx-ID=218.md)
Price 150 gp
Usage affixed to a shield; Bulk &mdash;
Activate [free-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Trigger You Shield Block a melee attack with the affixed shield.
