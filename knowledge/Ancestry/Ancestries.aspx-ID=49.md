# Poppet - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=49.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Poppet Details](./Ancestries.aspx-ID=49.md) | Poppet Feats | Universal Ancestry Feats | Poppet Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Poppet](./Ancestries.aspx-ID=49.md)

### Legacy Content

Rare Construct Humanoid [Poppet](../Trait/Traits.aspx-ID=418.md)
Source [Grand Bazaar pg. 60](../Source/Sources.aspx-ID=100.md)
PFS Note As of June 1, 2024, all Pathfinder Society agents have access to the poppet ancestry
...
Additional languages equal to your Intelligence modifier (if positive). Choose from [Draconic](../Language/Languages.aspx-ID=2.md), [Dwarven](../Language/Languages.aspx-ID=3.md), [Elven](../Language/Languages.aspx-ID=4.md), [Gnomish](../Language/Languages.aspx-ID=5.md), [Goblin](../Language/Languages.aspx-ID=6.md), [Sylvan](../Language/Languages.aspx-ID=10.md), and any other languages to which you have access (such as the languages prevalent in your region).
