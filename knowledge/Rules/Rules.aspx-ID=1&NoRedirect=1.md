...
Source HTML: `docs/aonprd/Rules.aspx-ID=1&NoRedirect=1.htm`
...
Source [Core Rulebook pg. 7](../Source/Sources.aspx-ID=1.md)
...
can’t apply more than one flaw to
...
If you play a champion, your character's alignment must be one allowed for their [deity](../Deity/Deities.aspx.md) and [cause](../Causes/Causes.aspx.md), and if you play a cleric, your character's alignment must be one allowed for their deity.
