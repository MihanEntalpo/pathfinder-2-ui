# Chime of Opening - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=252.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Chime of OpeningItem 6

### Legacy Content

Uncommon [Evocation](../Trait/Traits.aspx-ID=65.md) Magical
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Chime_of_Opening.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Chime_of_Opening.webp%27Source [Core Rulebook pg. 572](../Source/Sources.aspx-ID=1.md)
Price 235 gp
