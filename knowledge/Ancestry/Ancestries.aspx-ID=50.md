# Skeleton - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=50.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Skeleton Details](./Ancestries.aspx-ID=50.md) | Skeleton Feats | Universal Ancestry Feats | Skeleton Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Skeleton](./Ancestries.aspx-ID=50.md)

### Legacy Content

Rare Skeleton Undead
Source [Book of the Dead pg. 55](../Source/Sources.aspx-ID=118.md)
[PFS Note](../PFS/PFS.aspx.md) Skeletons and other undead do not use the undead creature traits, instead using the Basic Undead Benefits. Skeletons and other undead do not need to breathe unless otherwise stated.
...
[Necril](../Language/Languages.aspx-ID=20.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Aklo](../Language/Languages.aspx-ID=13.md), [Dwarven](../Language/Languages.aspx-ID=3.md), [Elven](../Language/Languages.aspx-ID=4.md), [Infernal](../Language/Languages.aspx-ID=19.md), [Orcish](../Language/Languages.aspx-ID=9.md), [Undercommon](../Language/Languages.aspx-ID=11.md), and any other languages to which you have access (such as languages prevalent in your region).
