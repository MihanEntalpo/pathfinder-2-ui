# Oracle - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=61.htm`
...
## [Oracle Details](./Classes.aspx-ID=61.md) | [Oracle Feats](../Feat/Feats.aspx-Traits=319.md) | Oracle Focus Spells | Oracle Kits | Oracle Sample Builds | [Mysteries](../Mysteries/Mysteries.aspx.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Oracle

Source [Player Core 2 pg. 128](../Source/Sources.aspx-ID=227.md)
...
| 17
| 9th-rank spells, ancestry feat, extreme curse, greater mysterious resolve, skill increase
...
Your oracular curse lists the specific effects of being cursebound, which are cumulative as your curse progresses. You remain cursebound until you Refocus, which reduces your cursebound condition by 1 in addition to restoring a Focus Point. As your curse is a direct result of divine power, you cannot mitigate, reduce, or remove the effects of your curse or any ability with the cursebound trait by any means other than Refocusing. For example, if a cursebound effect makes creatures [concealed](../Condition/Conditions.aspx-ID=62.md) from you, you can't negate that concealed condition through a magic item or spell, such as [sure strike](../Spell/Spells.aspx-ID=1709.md) (though you would still benefit from the other effects of that item or spell). Likewise, [cleanse affliction](../Spell/Spells.aspx-ID=1467.md) and similar abilities don't affect your curse at all.
...
You can harness divine power at a level few others can match. Your proficiency ranks for spell attack modifiers and spell DCs increase to legendary.
