# Beacon Shot - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2921.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Beacon ShotItem 3

[Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 255](../Source/Sources.aspx-ID=218.md)
Price 10 gp
Ammunition [arrow](../Weapon/Weapons.aspx-ID=443.md), [bolt](../Weapon/Weapons.aspx-ID=441.md); Bulk &mdash;
Activate [one-action] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md))

---

The shaft of a beacon shot is studded with flecks of gemstones. When an activated beacon shot hits a target, it embeds itself into that target and spews sparks for 1 minute. If the target is invisible, it becomes merely [hidden](../Condition/Conditions.aspx-ID=79&Redirected=1.md) to creatures who would otherwise be unable to see it. The sparks also negate the concealed condition if the target was otherwise concealed.
