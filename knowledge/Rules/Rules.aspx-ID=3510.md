# Apocryphal Domain Spells - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=3510.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

[>](./Rules.aspx-ID=3511.md)

# [Apocryphal Domain Spells](./Rules.aspx-ID=3510.md)
...
The GM might allow a character who comes from a strange sect or worships an underground aspect of a deity to select an apocryphal domain spell in place of the standard initial or advanced spell for that domain. These characters are typically clerics with [Domain Initiate](../Feat/Feats.aspx-ID=4644.md) but can include other characters with domain spells, like champions with Deity's Domain or oracles with Domain Acumen.
