# Runestone - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3003.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)RunestoneItem 1

[Consumable](../Trait/Traits.aspx-ID=564.md) [Magical](../Trait/Traits.aspx-ID=644.md)
javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Runestone.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Runestone.webp%27Source [GM Core pg. 269](../Source/Sources.aspx-ID=218.md)
Price 3 gp
