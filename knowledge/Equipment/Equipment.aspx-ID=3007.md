# Belt of Long Life - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3007.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Belt of Long LifeItem 17
...
Activate—Call Upon the Ancient Life [one-action] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Frequency once per day; Effect You draw upon the life- giving energy of the tree on the belt to gain rapid healing. For 2d4 rounds, at the start of your turn each round, you recover 15 Hit Points.
