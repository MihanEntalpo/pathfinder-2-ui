# Gossamer Sash - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=4110.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Gossamer SashItem 11

## This Item may contain spoilers from the Season of Ghosts Adventure Path

[Rare](../Trait/Traits.aspx-ID=683.md) [Consumable](../Trait/Traits.aspx-ID=564.md) [Illusion](../Trait/Traits.aspx-ID=629.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [Season of Ghosts (Hardcover) pg. 342](../Source/Sources.aspx-ID=294.md)
Price 250 gp
Usage held in 1 hand; Bulk L
Activate 1 hour ([concentrate](../Trait/Traits.aspx-ID=561.md), [manipulate](../Trait/Traits.aspx-ID=645.md), [move](../Trait/Traits.aspx-ID=658.md))
