# Army Conditions - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=1878&NoRedirect=1.htm`
...
When an army becomes affected by a condition, that condition's effects last until the condition's stated duration ends or the condition is removed. As with character conditions, some army conditions [override others](./Rules.aspx-ID=774.md).
