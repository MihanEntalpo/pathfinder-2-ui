# Samsaran - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=88.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Samsaran Details](./Ancestries.aspx-ID=88.md) | Samsaran Feats | Universal Ancestry Feats | Samsaran Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Samsaran](./Ancestries.aspx-ID=88.md)

javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Samsaran01.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Samsaran01.webp%27javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Samsaran02.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Samsaran02.webp%27[Uncommon](../Trait/Traits.aspx-ID=721.md) [Humanoid](../Trait/Traits.aspx-ID=628.md) [Samsaran](../Trait/Traits.aspx-ID=828.md)
Source [Tian Xia Character Guide pg. 53](../Source/Sources.aspx-ID=230.md)
Blue-skinned people native to Zi Ha, who reincarnate upon death and recall pieces of their past lives. They are [common](../Trait/Traits.aspx-ID=557.md) in Zi Ha, Po Li, and Goka.
...
[Samsaran](../Language/Languages.aspx-ID=69.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Chthonian](../Language/Languages.aspx-ID=114.md), [Diabolic](../Language/Languages.aspx-ID=117.md), [Draconian](../Language/Languages.aspx-ID=156.md), [Empyreal](../Language/Languages.aspx-ID=16.md), [Jotun](../Language/Languages.aspx-ID=162.md), [Petran](../Language/Languages.aspx-ID=109.md), [Pyric](../Language/Languages.aspx-ID=110.md), [Sussuran](../Language/Languages.aspx-ID=111.md), [Thalassic](../Language/Languages.aspx-ID=113.md), and any other languages to which you have access (such as the languages prevalent in your region).
...
Your soul is especially able to return to the cycle of reincarnation. When you're the subject of [raise dead](../Spell/Spells.aspx-ID=1645.md), reincarnate, or a similar ritual that would return you to life, the primary caster uses the outcome one degree of success better than their roll. You always return to life as a samsaran, even if the ritual would reincarnate you into a body of a different ancestry.
