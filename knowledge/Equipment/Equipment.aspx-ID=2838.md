# Flaming - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2838.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)FlamingItem 8+

[Fire](../Trait/Traits.aspx-ID=604.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 237](../Source/Sources.aspx-ID=218.md)
Usage etched onto a weapon; Bulk &mdash;

---

A weapon with this rune is empowered by flickering flame. The weapon deals an additional 1d6 fire damage on a successful Strike, plus 1d10 [persistent fire damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md) on a critical hit.
...
## [PFS.aspx.htm](../PFS/PFS.aspx.md)Flaming (Greater)Item 15
