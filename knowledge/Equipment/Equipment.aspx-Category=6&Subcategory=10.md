# Alchemical Tools - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=6&Subcategory=10.htm`
...
Source [Core Rulebook pg. 554](../Source/Sources.aspx-ID=1.md)
Alchemical tools are consumable items you don’t drink.

Click here for the full rules on Alchemical Tools.
