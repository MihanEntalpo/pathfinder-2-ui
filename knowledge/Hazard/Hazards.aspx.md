# Hazards - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Hazards.aspx.htm`
...
[Click here for the full rules on Hazards](../Rules/Rules.aspx-ID=2846.md).
