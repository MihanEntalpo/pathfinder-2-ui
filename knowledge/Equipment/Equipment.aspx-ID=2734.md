# Merchant's Scale - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2734.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Merchant's ScaleItem 0

javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Merchants_Scale.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Merchants_Scale.webp%27Source [Player Core pg. 290](../Source/Sources.aspx-ID=216.md)
Price 2 sp
Hands 2; Bulk L
