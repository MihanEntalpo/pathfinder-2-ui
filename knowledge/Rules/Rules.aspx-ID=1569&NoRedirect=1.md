# True Names - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=1569&NoRedirect=1.htm`
...
Source [Secrets of Magic pg. 244](../Source/Sources.aspx-ID=96.md)
...
- Arcana, Nature, Occultism, or Religion checks relating to the creature, such as Deciphering its Writing, Identifying its Magic, or Learning its Spells
- [Deception](../Skill/Skills.aspx-ID=38&Redirected=1.md), Diplomacy, and Intimidation checks used on or related to the creature, such as to Coerce it, Gather Information on it, or Impersonate it
