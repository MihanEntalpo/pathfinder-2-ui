# Chapter 6: Equipment - Rules - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rules.aspx-ID=2143.htm`

# [Rules Index](./Rules.aspx.md) | [GM Screen](../GMScreen/GMScreen.aspx.md) | [Player's Guide](../PlayersGuide/PlayersGuide.aspx.md)

---

[>](./Rules.aspx-ID=2221.md)

# [Chapter 6: Equipment](./Rules.aspx-ID=2143.md)

Source [Player Core pg. 267](../Source/Sources.aspx-ID=216.md)
...
## [Carrying Items](./Rules.aspx-ID=2148.md)
...
#### [Interact](./Rules.aspx-ID=2151.md)
...
## [Shoddy Items](./Rules.aspx-ID=2162.md)
...
Certain class features can grant you additional benefits with certain armors. This is called an armor specialization effect. The exact effect depends on which armor group your armor belongs to, as [listed here.](../ArmorGroups/ArmorGroups.aspx.md)
...
Shields have statistics that follow the same rules as armor: Price, Speed Penalty, and Bulk. See armor for the rules for those statistics. Their other statistics are described here.
...
Whenever a shield takes damage, the amount of damage it takes is reduced by this amount. This number is particularly relevant for shields because of the [Shield Block](../Feat/Feats.aspx-ID=5212.md) feat . The rules for Hardness appear here.
...
A shield can be used as a martial weapon for attacks, using the statistics listed for a [shield bash](../Weapon/Weapons.aspx-ID=395.md) on the Martial Melee Weapons table. The shield bash is an option only for shields that weren't designed to be used as weapons. A shield can't have runes added to it. You can also buy and attach a [shield boss](../Weapon/Weapons.aspx-ID=396.md) or [shield spikes](../Weapon/Weapons.aspx-ID=397.md) to a shield to make it a more practical weapon. These can also be found on the Martial Melee Weapons table. These work like other weapons and can even be etched with runes.
...
When making an attack roll, determine the result by rolling 1d20 and adding your attack modifier for the weapon or unarmed attack you're using. Modifiers for melee and ranged attacks are calculated differently—see page 402 for full details.Melee attack roll result = d20 roll + Strength modifier (or optionally Dexterity modifier for a finesse weapon) + proficiency bonus + other bonuses + penalties
...
Classic Firearms
(
Source [Guns & Gears pg. 150](../Source/Sources.aspx-ID=98.md)
)
...
#### [Alchemical Bombs](./Rules.aspx-ID=2210.md)
...
Frame: A wheelchair is typically made from common materials like wood, but they can also be made from steel, other metals, or even rarer materials like dawnsilver. The wheelchairs presented here are made from durable wood. Magic: The wheelchair is considered an extension of yourself. Spells or abilities that change your bodily form also apply to the chair, and it transforms with you so long as you're using it. You can choose what appearance this has.
...
The services listed on [Basic Services and Cuisine](../Equipment/Equipment.aspx-Category=2.md) describe expenditures that can come up during travels and time spent in settlements.
...
Most animals panic in battle unless specifically trained otherwise. When combat begins, they become [frightened](../Condition/Conditions.aspx-ID=76.md) 4 and [fleeing](../Condition/Conditions.aspx-ID=74.md) as long as they're frightened. If you successfully [Command an Animal](../Action/Actions.aspx-ID=2400.md) using [Nature](../Skill/Skills.aspx-ID=43.md), you can keep it from fleeing, though this doesn't remove its frightened condition. If the animal is attacked or damaged, it returns to frightened 4 and fleeing, with the same exceptions.
...
If you want to quickly decide how to spend your starting money when playing a class from this book, start with one of these kits. The Armor, Weapons, and Gear entries include the basics, and the Options entries suggest additional items you might purchase with your leftover money to fit your character. Note that an [adventurer’s pack](../Equipment/Equipment.aspx-ID=2700.md), which is included in each kit, is 1 Bulk and contains a [backpack](../Equipment/Equipment.aspx-ID=2704.md), [bedroll](../Equipment/Equipment.aspx-ID=2706.md), 10 pieces of [chalk](../Equipment/Equipment.aspx-ID=2711.md), [flint and steel](../Equipment/Equipment.aspx-ID=2723.md), 50 feet of [rope](../Equipment/Equipment.aspx-ID=2748.md), 2 weeks’ [rations](../Equipment/Equipment.aspx-ID=2744.md), [soap](../Equipment/Equipment.aspx-ID=2752.md), 5 [torches](../Equipment/Equipment.aspx-ID=2760.md), and a [waterskin](../Equipment/Equipment.aspx-ID=2761.md).

### Alchemist Kit

Source [Player Core 2 pg. 277](../Source/Sources.aspx-ID=227.md)
Price 8 gp, 3 sp, 2 cp; Bulk 3 Bulk, 7 light; Money Left Over 6 gp, 6 sp, 8 cp
Armor [studded leather armor](../Armor/Armor.aspx-ID=42.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md), [sling with 20 bullets](../Weapon/Weapons.aspx-ID=430.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [alchemist's toolkit](../Equipment/Equipment.aspx-ID=2702.md), [caltrops (2 sets)](../Equipment/Equipment.aspx-ID=2708.md)
Options [repair toolkit](../Equipment/Equipment.aspx-ID=2747.md) (2 gp)

### Barbarian Kit

Source [Player Core 2 pg. 277](../Source/Sources.aspx-ID=227.md)
Price 4 gp; Bulk 3 Bulk, 5 light; Money Left Over 11 gp
Armor [hide armor](../Armor/Armor.aspx-ID=44.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md), [javelins (4)](../Weapon/Weapons.aspx-ID=429.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [grappling hook](../Equipment/Equipment.aspx-ID=2725.md)
Options [greataxe](../Weapon/Weapons.aspx-ID=376.md) (2 gp), [greatclub](../Weapon/Weapons.aspx-ID=377.md) (1 gp), [greatsword](../Weapon/Weapons.aspx-ID=379.md) (2 gp), or [battle axe](../Weapon/Weapons.aspx-ID=371.md) and [steel shield](../Shield/Shields.aspx-ID=19.md) (3 gp)

### [Bard Kit](../ClassKits/ClassKits.aspx-ID=17.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 7 gp, 5 sp, 2 cp; Bulk 4 Bulk, 4 light; Money Left Over 7 gp, 4 sp, 8 cp
Armor [studded leather armor](../Armor/Armor.aspx-ID=42.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md), [rapier](../Weapon/Weapons.aspx-ID=391.md), [sling with 20 bullets](../Weapon/Weapons.aspx-ID=430.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [musical instrument (handheld)](../Equipment/Equipment.aspx-ID=2737.md)

### Champion Kit

Source [Player Core 2 pg. 277](../Source/Sources.aspx-ID=227.md)
Price 8 gp, 7 sp; Bulk 3 Bulk, 7 light; Money Left Over 6 gp, 3 sp
Armor [chain mail](../Armor/Armor.aspx-ID=46.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md), [javelins (4)](../Weapon/Weapons.aspx-ID=429.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [crowbar](../Equipment/Equipment.aspx-ID=2718.md), [grappling hook](../Equipment/Equipment.aspx-ID=2725.md)
Options [steel shield](../Shield/Shields.aspx-ID=19.md) (2 gp), your deity's favored weapon (see your [deities entry](../Deity/Deities.aspx.md); use the Price listed in the weapon's entry)

### [Cleric Kit](../ClassKits/ClassKits.aspx-ID=18.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 1 gp, 7 sp; Bulk 1 Bulk, 2 light; Money Left Over 13 gp, 3 sp
Armor [explorer's clothing](../Armor/Armor.aspx-ID=39.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [religious symbol (wooden)](../Equipment/Equipment.aspx-ID=2745.md)
Options your deity's favored weapon (see your [deities entry](../Deity/Deities.aspx.md); use the Price listed in the weapon's entry), [chain mail](../Armor/Armor.aspx-ID=46.md) (6 gp), [healer's toolkit](../Equipment/Equipment.aspx-ID=2727.md) (5 gp)

### [Druid Kit](../ClassKits/ClassKits.aspx-ID=19.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 4 gp; Bulk 4 Bulk, 4 light; Money Left Over 11 gp
Armor [hide armor](../Armor/Armor.aspx-ID=44.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [grappling hook](../Equipment/Equipment.aspx-ID=2725.md)
Options [healer's toolkit](../Equipment/Equipment.aspx-ID=2727.md) (5 gp)

### [Fighter Kit](../ClassKits/ClassKits.aspx-ID=20.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 5 gp, 8 sp; Bulk 2 Bulk, 2 light; Money Left Over 9 gp, 2 sp
Armor [scale mail](../Armor/Armor.aspx-ID=45.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [grappling hook](../Equipment/Equipment.aspx-ID=2725.md)
Options [greatsword](../Weapon/Weapons.aspx-ID=379.md) (2 gp), [longbow](../Weapon/Weapons.aspx-ID=436.md) with 20 [arrows](../Weapon/Weapons.aspx-ID=443.md) (6 gp, 2 sp), or [longsword](../Weapon/Weapons.aspx-ID=386.md) and [steel shield](../Shield/Shields.aspx-ID=19.md) (3 gp)
...
Armor [studded leather armor](../Armor/Armor.aspx-ID=42.md)
Weapons [crossbow with 20 bolts](../Weapon/Weapons.aspx-ID=425.md), [sap](../Weapon/Weapons.aspx-ID=392.md), [shortsword](../Weapon/Weapons.aspx-ID=398.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [crowbar](../Equipment/Equipment.aspx-ID=2718.md)
Options [alchemist’s toolkit](../Equipment/Equipment.aspx-ID=2702.md) (3 gp), simple [manacles](../Equipment/Equipment.aspx-ID=2733.md) (3 gp), [writing set](../Equipment/Equipment.aspx-ID=2762.md) (1 gp)
...
Armor [explorer's clothing](../Armor/Armor.aspx-ID=39.md)
Weapons [darts (10)](../Weapon/Weapons.aspx-ID=426.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [climbing kit](../Equipment/Equipment.aspx-ID=2713.md), [grappling hook](../Equipment/Equipment.aspx-ID=2725.md), smoke ball (lesser)
Options [staff](../Weapon/Weapons.aspx-ID=367.md) (0 gp), [longspear](../Weapon/Weapons.aspx-ID=361.md) (5 sp)
...
Armor [studded leather armor](../Armor/Armor.aspx-ID=42.md)
Weapons [mace](../Weapon/Weapons.aspx-ID=362.md), [sling with 20 bullets](../Weapon/Weapons.aspx-ID=430.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md)
Options [steel shield](../Shield/Shields.aspx-ID=19.md) (2 gp), [healer’s toolkit](../Equipment/Equipment.aspx-ID=2727.md) (5 gp)

### [Ranger Kit](../ClassKits/ClassKits.aspx-ID=21.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 3 gp, 7 sp; Bulk 2 Bulk, 1 light; Money Left Over 11 gp, 3 sp
Armor [leather armor](../Armor/Armor.aspx-ID=41.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md)
Options [longbow](../Weapon/Weapons.aspx-ID=436.md) with 20 [arrows](../Weapon/Weapons.aspx-ID=443.md) (6 gp, 2 sp), [longsword](../Weapon/Weapons.aspx-ID=386.md) and [steel shield](../Shield/Shields.aspx-ID=19.md) (3 gp), 2 [shortswords](../Weapon/Weapons.aspx-ID=398.md) (1 gp, 8 sp)

### [Rogue Kit](../ClassKits/ClassKits.aspx-ID=22.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 6 gp, 2 sp; Bulk 4 Bulk, 1 light; Money Left Over 8 gp, 8 sp
Armor [leather armor](../Armor/Armor.aspx-ID=41.md)
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md), [rapier](../Weapon/Weapons.aspx-ID=391.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md)
Options [thieves' toolkit (3 gp)](../Equipment/Equipment.aspx-ID=2758.md)
...
Weapons [dagger](../Weapon/Weapons.aspx-ID=358.md), [sling with 20 bullets](../Weapon/Weapons.aspx-ID=430.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md)
Options [adventurer’s pack](../Equipment/Equipment.aspx-ID=2700.md), [caltrops](../Equipment/Equipment.aspx-ID=2708.md) (2 sets)
...
Armor [leather armor](../Armor/Armor.aspx-ID=41.md)
Weapons [hand crossbow with 20 bolts](../Weapon/Weapons.aspx-ID=427.md), [rapier](../Weapon/Weapons.aspx-ID=391.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md)
Options [buckler](../Shield/Shields.aspx-ID=17.md) (1 gp), [dueling cape](../Equipment/Equipment.aspx-ID=2721.md) (5 sp), fine [clothing](../Equipment/Equipment.aspx-ID=2715.md) (2 gp), [grappling hook](../Equipment/Equipment.aspx-ID=2725.md) (1 sp), [main-gauche](../Weapon/Weapons.aspx-ID=387.md) (5 sp)

### [Witch Kit](../ClassKits/ClassKits.aspx-ID=23.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 1 gp, 8 sp, 2 cp; Bulk 2 Bulk, 5 light; Money Left Over 13 gp, 1 sp, 8 cp
Armor [explorer's clothing](../Armor/Armor.aspx-ID=39.md)
Weapons [sickle](../Weapon/Weapons.aspx-ID=364.md), [sling with 20 bullets](../Weapon/Weapons.aspx-ID=430.md), [staff](../Weapon/Weapons.aspx-ID=367.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md)
Options [cookware](../Equipment/Equipment.aspx-ID=2717.md) (1 gp), [healer's toolkit](../Equipment/Equipment.aspx-ID=2727.md) (5 gp)

### [Wizard Kit](../ClassKits/ClassKits.aspx-ID=24.md)

Source [Player Core pg. 268](../Source/Sources.aspx-ID=216.md)
Price 2 gp, 6 sp; Bulk 2 Bulk, 2 light; Money Left Over 12 gp, 4 sp
Armor [explorer's clothing](../Armor/Armor.aspx-ID=39.md)
Weapons [staff](../Weapon/Weapons.aspx-ID=367.md)
Gear [adventurer's pack](../Equipment/Equipment.aspx-ID=2700.md), [writing set](../Equipment/Equipment.aspx-ID=2762.md)
Options [crossbow](../Weapon/Weapons.aspx-ID=425.md) with 20 [bolts](../Weapon/Weapons.aspx-ID=441.md) (3 gp, 2 sp)
