# Sneaky Key - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2993.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Sneaky KeyItem 5
...
Activate [one-action] ([manipulate](../Trait/Traits.aspx-ID=645&Redirected=1.md)); Requirements You are trained in Thievery
