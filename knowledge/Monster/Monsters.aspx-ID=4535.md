# Wihsaak - Monsters - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Monsters.aspx-ID=4535.htm`
...
These gaunt, insectile sahkils torment their foes by focusing on a widespread fear of insects and creeping, crawling vermin. Unlike their more subtle cousins, wihsaaks don't lurk in the periphery and instead directly engage their targets, using their unnerving buzzing to disorient and terrify. When encountering multiple foes, wihsaaks attempt to spread fear to everyone before slashing at them with their devastating claws. Many wihsaaks bear heads that resemble the body of a locust, but some may appear as other widely feared insectile creatures.

## Elite | Normal | WeakProficiency without Level

### Print Stat Block

# [Wihsaak](./Monsters.aspx-ID=4535.md)Creature 6

Medium [Fiend](../Trait/Traits.aspx-ID=600.md) [Sahkil](../Trait/Traits.aspx-ID=883.md) [Unholy](../Trait/Traits.aspx-ID=521.md)
Source [Monster Core 2 pg. 275](../Source/Sources.aspx-ID=276.md)
...
Languages [Chthonian](../Language/Languages.aspx-ID=114.md), [Diabolic](../Language/Languages.aspx-ID=117.md), [Empyrean](../Language/Languages.aspx-ID=115.md), [Requian](../Language/Languages.aspx-ID=34.md); telepathy 100 feet
Skills [Acrobatics](../Skill/Skills.aspx-ID=34.md) +13, [Deception](../Skill/Skills.aspx-ID=38.md) +15, [Intimidation](../Skill/Skills.aspx-ID=40.md) +15, [Stealth](../Skill/Skills.aspx-ID=48.md) +15
Str +4, Dex +5, Con +4, Int +1, Wis +2, Cha +3
Easy to Call A sahkil's level is considered 2 lower for the purpose of being conjured by the [binding circle](../Ritual/Rituals.aspx-ID=110.md) ritual (and potentially other rituals, at the GM's discretion), but it's always free to attack or leave instead of negotiate unless the primary caster's check is a critical success.

---

AC 24; Fort +14, Ref +15, Will +14
HP 105; Immunities [fear](../Trait/Traits.aspx-ID=598.md); Weaknesses [holy](../Trait/Traits.aspx-ID=517.md) 5
Swarmwalker Swarms of animals and other unintelligent creatures instinctively leave a wihsaak alone. A wihsaak is immune to the damage from and effects of swarms with an Intelligence of –5.

---

Speed 30 feet, fly 40 feet
Melee [one-action] claw +17 [+12/+7] (finesse, [magical](../Trait/Traits.aspx-ID=644.md), [unholy](../Trait/Traits.aspx-ID=521.md)), Damage 2d10+7 slashing plus 1d4 spiritDivine Innate Spells DC 23; 4th suggestion; 3rd fear, vomit swarm; 2nd blur, [see the unseen](../Spell/Spells.aspx-ID=1663.md); Cantrips (3rd) detect magic
Droning Distraction [one-action] ([auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md), [divine](../Trait/Traits.aspx-ID=579.md), [incapacitation](../Trait/Traits.aspx-ID=631.md), [mental](../Trait/Traits.aspx-ID=647.md)) Effect The wihsaak beats its wings rapidly, creating a buzzing drone that numbs creatures' minds. Each creature within 100 feet must attempt a DC 23 Will save. They are then temporarily immune for 1 minute.
Success The creature is unaffected.
Failure The creature is [confused](../Condition/Conditions.aspx-ID=63.md) and [stupefied](../Condition/Conditions.aspx-ID=94.md) 1 for 1 round.
Critical Failure The creature is confused for 1 round and stupefied 2 for 1 minute.Skip Between [one-action] (divine, [teleportation](../Trait/Traits.aspx-ID=710.md)) The sahkil moves from [the Universe](../Plane/Planes.aspx-ID=26.md) to the [Ethereal Plane](../Plane/Planes.aspx-ID=34.md) or vice-versa. While in the Ethereal Plane, they're unable to affect anything in the Universe, and they cannot be seen by beings or abilities in the Universe, unless these have an ability that can gaze into the Ethereal Plane. While on the Material Plane the inverse is true for anything on the Ethereal Plane. A summoned sahkil can't use Skip Between.
...
| [Esipil](./Monsters.aspx-ID=4533.md)
| 1

| Ijhyeojin
| 14

| [Kimenhul](./Monsters.aspx-ID=4538.md)
| 20

| Nenchuuj
| 19

| [Nucol](./Monsters.aspx-ID=4534.md)
| 4

| [Pakalchi](./Monsters.aspx-ID=4536.md)
| 9
...
| [Wihsaak](./Monsters.aspx-ID=4535.md)
| 6

| [Ximtal](./Monsters.aspx-ID=4537.md)
| 17

# Sahkil

Source [Monster Core 2 pg. 274](../Source/Sources.aspx-ID=276.md)
...
Within the ghostly realm of the [Ethereal Plane](../Plane/Planes.aspx-ID=34.md), sahkils inhabit a terrifying domain known as Xibalba. The Land of Dread is a realm of nightmares made manifest. At the center of this demiplane is a tiered structure known as the Black Pyramid, where the sahkil tormentors rule their brethren and sow fear throughout the mortal realm.
