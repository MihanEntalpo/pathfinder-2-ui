# Cleric - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=33.htm`
...
## [Cleric Details](./Classes.aspx-ID=33.md) | Cleric Feats | Cleric Focus Spells | Cleric Kits | Cleric Sample Builds | [Doctrines](../Doctrines/Doctrines.aspx.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Cleric

Source [Player Core pg. 108](../Source/Sources.aspx-ID=216.md)
...
[Holy](../Trait/Traits.aspx-ID=517.md) and [Unholy](../Trait/Traits.aspx-ID=521.md): These traits mark something, like your character or a spell, that belongs to one side of the battle between [celestials](../Trait/Traits.aspx-ID=551.md) and [fiends](../Trait/Traits.aspx-ID=600.md). Generally, fiends and [undead](../Trait/Traits.aspx-ID=722.md) are susceptible to holy abilities and celestials to unholy ones.

[Sanctified](../Trait/Traits.aspx-ID=519.md): If you are holy or unholy, your sanctified actions and spells gain the same trait.

[Spellshape](../Trait/Traits.aspx-ID=513.md): These actions tweak your spells. You must use a spellshape action directly before Casting the Spell you want to alter. If you use any action (including free actions and reactions) other than Cast a Spell directly after, you waste the benefits of the spellshape action. Effects added by a spellshape action are part of the spell's effect, not of the spellshape action.
...
At 1st level, you can prepare two 1st-rank spells and five cantrips each morning from the common spells on the [divine](../SpellLists/SpellLists.aspx-Tradition=2.md) spell list or from other divine spells to which you gain access and learn via Learn a Spell. Prepared spells remain available to you until you cast them or until you prepare your spells again. The number of spells you can prepare each day is called your spell slots.
...
You've learned how to inflict greater injuries with your weapons. You deal 2 additional damage with weapons and unarmed attacks in which you are an expert. This damage increases to 3 if you're a master, and to 4 if you're legendary.
