# Call Spirit - Rituals - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rituals.aspx-ID=112.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Call SpiritRitual 5

[Uncommon](../Trait/Traits.aspx-ID=721.md) Spirit
Source [Player Core pg. 391](../Source/Sources.aspx-ID=216.md)
...
Critical Success The spirit is particularly cooperative, and even if it has strong reasons to deceive you, it takes a –2 circumstance penalty to its [Deception](../Skill/Skills.aspx-ID=38&Redirected=1.md) checks.
