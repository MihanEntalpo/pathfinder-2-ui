# Bard - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=32.htm`
...
## [Bard Details](./Classes.aspx-ID=32.md) | [Bard Feats](../Feat/Feats.aspx-Traits=19.md) | Bard Focus Spells | Bard Kits | Bard Sample Builds | [Muses](../Muses/Muses.aspx.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Bard

Source [Player Core pg. 94](../Source/Sources.aspx-ID=216.md)
...
[Composition](../Trait/Traits.aspx-ID=559.md): To cast a composition cantrip or focus spell, you use a type of [Performance](../Skill/Skills.aspx-ID=45.md). If the spell requires an auditory performance, you might recite a poem, sing a song, or perform a dramatic monologue. If the spell requires a visual performance, you might dance or pantomime. You can cast only one composition spell each turn, and you can have only one active at a time. If you cast a new composition spell, any ongoing effects from your previous composition spell end immediately.
...
You learn the counter performance composition spell, protecting against [auditory](../Trait/Traits.aspx-ID=541&Redirected=1.md) and visual effects.
...
At 2nd level and every even-numbered level, you gain a [bard class feat](../Feat/Feats.aspx-Traits=19.md).
