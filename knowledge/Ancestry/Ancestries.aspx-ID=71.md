# Athamaru - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=71.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Athamaru Details](./Ancestries.aspx-ID=71.md) | Athamaru Feats | Universal Ancestry Feats | Athamaru Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Athamaru](./Ancestries.aspx-ID=71.md)

javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Athamaru01.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Athamaru01.webp%27javascript:if(confirm(%27https://2e.aonprd.com/Images/Ancestries/Athamaru02.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Ancestries/Athamaru02.webp%27Uncommon Amphibious [Athamaru](../Trait/Traits.aspx-ID=741.md) Humanoid
Source [Howl of the Wild pg. 17](../Source/Sources.aspx-ID=226.md)
...
Athamarus are strongly motivated by community, and most who choose to leave their community to adventure have a good reason why. Many begin adventuring to protect their community or solve a particular problem, while others are thrust out into the wider world after a tragedy. The [animal whisperer](../Background/Backgrounds.aspx-ID=408.md), [emissary](../Background/Backgrounds.aspx-ID=420.md), and [sailor](../Background/Backgrounds.aspx-ID=439.md) backgrounds complement athamarus well. Eel-mounted champions or rangers often serve as athamaru community protectors, and those who want to connect with others train as bards. Though athamaru spellcasters are typically rare, some use their strong relationship to the natural world to become druids.
...
Additional languages equal to your Intelligence modifier (if positive). Choose from [Alghollthu](../Language/Languages.aspx-ID=24.md), [Azlanti](../Language/Languages.aspx-ID=49.md), [Fey](../Language/Languages.aspx-ID=119.md), [Tien](../Language/Languages.aspx-ID=173.md), and any other languages to which you have access (such as the languages prevalent in your region).

## Low-Light Vision

You can see in dim light as though it were bright light, so you ignore the [concealed](../Condition/Conditions.aspx-ID=62.md) condition due to dim light.
