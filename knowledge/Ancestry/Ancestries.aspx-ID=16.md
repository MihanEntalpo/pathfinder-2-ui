# Shoony - Ancestries - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Ancestries.aspx-ID=16.htm`

# [Ancestries](./Ancestries.aspx.md) | [Versatile Heritages](./Ancestries.aspx-Versatile=true.md)

## [Shoony Details](./Ancestries.aspx-ID=16.md) | Shoony Feats | Universal Ancestry Feats | Shoony Heritages

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Shoony](./Ancestries.aspx-ID=16.md)

### Legacy Content

Rare Humanoid [Shoony](../Trait/Traits.aspx-ID=296.md)
Source [Pathfinder #153: Life's Long Shadows pg. 72](../Source/Sources.aspx-ID=29.md)
...
[Shoony](../Language/Languages.aspx-ID=56.md)
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [Dwarven](../Language/Languages.aspx-ID=3.md), [Gnomish](../Language/Languages.aspx-ID=5.md), [Goblin](../Language/Languages.aspx-ID=6.md), [Halfling](../Language/Languages.aspx-ID=7.md), [Terran](../Language/Languages.aspx-ID=22.md), and any other languages to which you have access (such as the languages prevalent in your region).
