# Curse Maelstrom Dedication - Feats - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Feats.aspx-ID=8470.htm`

# [All Archetypes](../Archetypes/Archetypes.aspx.md)[Artifact](../Archetypes/Archetypes.aspx-Category=9.md) | [Class](../Archetypes/Archetypes.aspx-Category=7.md) | [Combat Style](../Archetypes/Archetypes.aspx-Category=1.md) | [Core](../Archetypes/Archetypes.aspx-Category=2.md) | [Faction](../Archetypes/Archetypes.aspx-Category=3.md) | [Multiclass](../Archetypes/Archetypes.aspx-Category=4.md) | [Mystical](../Archetypes/Archetypes.aspx-Category=5.md) | [Mythic](../Archetypes/Archetypes.aspx-Category=10.md) | [Profession](../Archetypes/Archetypes.aspx-Category=6.md) | [Undead](../Archetypes/Archetypes.aspx-Category=8.md)

---

There is a Legacy version here.

# [PFS.aspx.htm](../PFS/PFS.aspx.md)[Curse Maelstrom Dedication](./Feats.aspx-ID=8470.md) Feat 2

[Rare](../Trait/Traits.aspx-ID=683.md) [Archetype](../Trait/Traits.aspx-ID=535.md) [Dedication](../Trait/Traits.aspx-ID=572.md)
Source [Dark Archives (Remastered) pg. 168](../Source/Sources.aspx-ID=293.md)
[PFS Note](../PFS/PFS.aspx.md) The DC of the Curse Maelstrom's Expel Maelstrom is the higher of the character's spell DC or class DC.
Archetype [Curse Maelstrom](../Archetypes/Archetypes.aspx-ID=347.md)
Prerequisites You are cursed or have previously been cursed.

---

A horrible curse has left a lingering stain on your soul, and its effects continue to plague you even if the curse's other effects have ended. You can choose to suppress it, but if you instead let it manifest, you can channel its power in your favor. During an encounter, when you succeed at a check, the GM can offer to have you roll again, taking the second result. This is a [misfortune](../Trait/Traits.aspx-ID=654.md) effect. If you do so, you enter a curse maelstrom state. If the misfortune effect is somehow canceled or negated (by a [fortune](../Trait/Traits.aspx-ID=612.md) effect, for example), you don't enter a curse maelstrom state.
...
Expel Maelstrom [one-action] ([curse](../Trait/Traits.aspx-ID=566.md), [occult](../Trait/Traits.aspx-ID=662.md)) Requirements You're in a curse maelstrom state; Effect You expel the maelstrom from your body, sending the energy to reside in one unlucky creature within 60 feet. Your curse maelstrom state ends. The result depends on the creature's Will save.
...
Critical Failure The maelstrom pitches the creature into a single fit of utter misfortune before burrowing into its soul. As failure, but the creature also must roll twice and take the lower result on its next saving throw or skill check; this is a [misfortune](../Trait/Traits.aspx-ID=654.md) effect.

## Curse Maelstrom Dedication Leads To...

[Accursed Magic](./Feats.aspx-ID=8474.md), [Counter Curse](./Feats.aspx-ID=8475.md), [Familiar Oddities](./Feats.aspx-ID=8471.md), [Share Burden](./Feats.aspx-ID=8473.md), [Torrential Backlash](./Feats.aspx-ID=8476.md), [Unnerving Expansion](./Feats.aspx-ID=8472.md)
