# Bloodletting Kukri - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2862.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Bloodletting KukriItem 6

[Uncommon](../Trait/Traits.aspx-ID=721.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 241](../Source/Sources.aspx-ID=218.md)
Price 240 gp
Usage held in 1 hand; Bulk L
Base Weapon [Kukri](../Weapon/Weapons.aspx-ID=413.md)

---

This +1 striking kukri has a crimson blade that shimmers eerily in bright light. On a critical hit, the kukri deals 1d8 [persistent bleed damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md). If the target didn't already have persistent bleed damage when you scored the critical hit, you also gain 1d8 temporary Hit Points for 1 minute.
