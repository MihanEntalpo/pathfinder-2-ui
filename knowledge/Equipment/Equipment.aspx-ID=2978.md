# Ghost Dust - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2978.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Ghost DustItem 16

[Consumable](../Trait/Traits.aspx-ID=564.md) [Illusion](../Trait/Traits.aspx-ID=629.md) [Occult](../Trait/Traits.aspx-ID=662.md) [Talisman](../Trait/Traits.aspx-ID=709.md)
Source [GM Core pg. 265](../Source/Sources.aspx-ID=218.md)
Price 1,800 gp
Usage affixed to armor; Bulk &mdash;
Activate [one-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Requirements You are trained in Stealth

---

This small vial is filled with a grayish-green dust rendered from dried ectoplasm. When you activate the dust, it casts a 4th-rank [invisibility](../Spell/Spells.aspx-ID=1577&Redirected=1.md) spell on you. You may then Stride or Step. You can instead Burrow, Climb, Fly, or Swim if you have the corresponding Speed.
