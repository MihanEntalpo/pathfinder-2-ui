# Spellbook (Blank) - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2753.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Spellbook (Blank)Item 0

javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Spellbook.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Spellbook.webp%27Source [Player Core pg. 292](../Source/Sources.aspx-ID=216.md)
Price 1 gp
Hands 1; Bulk L
