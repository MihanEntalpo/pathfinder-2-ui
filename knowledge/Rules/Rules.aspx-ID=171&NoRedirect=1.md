...
Source HTML: `docs/aonprd/Rules.aspx-ID=171&NoRedirect=1.htm`
...
Source [Core Rulebook pg. 233](../Source/Sources.aspx-ID=1.md)
...
The actions you can perform with a given skill are sorted into those you can use untrained and those that require you to be trained in the skill, as shown under each [skill](../Skill/Skills.aspx.md). The untrained and trained actions of each skill appear in separate sections within the skill's description.
