# Specific Shields - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-Category=28&Subcategory=30.htm`
...
Source [Core Rulebook pg. 587](../Source/Sources.aspx-ID=1.md)
These shields have unique abilities that differentiate them from their typical counterparts.

Click here for the full rules on Specific Shields.
