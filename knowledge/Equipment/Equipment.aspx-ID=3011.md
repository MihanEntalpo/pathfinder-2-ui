# Headwrap of Wisdom - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=3011.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)Headwrap of WisdomItem 17

[Apex](../Trait/Traits.aspx-ID=532.md) [Invested](../Trait/Traits.aspx-ID=637.md) [Magical](../Trait/Traits.aspx-ID=644.md)
Source [GM Core pg. 270](../Source/Sources.aspx-ID=218.md)
Price 15,000 gp
Usage worn circlet; Bulk &mdash;
...
Activate—Consider the Consequences [one-action] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md)); Frequency once per day; Effect When you are considering a course of action, you get a gut feeling about whether it's a good idea. You gain the effects of an augury spell, except that you receive the result from your own instincts rather than an external source.

Activate—Reclaim Your Mind [reaction] ([concentrate](../Trait/Traits.aspx-ID=561&Redirected=1.md), fortune); Frequency once per hour; Trigger You fail a saving throw against an effect that makes you confused, fascinated, or stupefied ; Effect The headwrap of wisdom clears your mind. You can reroll the saving throw and use the better result.
