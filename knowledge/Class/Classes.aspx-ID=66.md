# Commander - Classes - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Classes.aspx-ID=66.htm`
...
## [Commander Details](./Classes.aspx-ID=66.md) | [Commander Feats](../Feat/Feats.aspx-Traits=855.md) | Commander Sample Builds | [Tactics](../Tactics/Tactics.aspx.md)

---

# [PFS.aspx.htm](../PFS/PFS.aspx.md)Commander

javascript:if(confirm(%27https://2e.aonprd.com/Images/Classes/Iconic_Ulka_Oathshriek.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Classes/Iconic_Ulka_Oathshriek.webp%27
Source [Battlecry! pg. 21](../Source/Sources.aspx-ID=268.md)
...
Trained in [Society](../Skill/Skills.aspx-ID=47.md) and [Warfare Lore](../Skill/Skills.aspx-ID=41.md)
...
As long as your banner is visible and in your possession, it provides an aura that gives you and all allies in a 30-foot [emanation](../Rules/Rules.aspx-ID=2387.md) a +1 status bonus to Will saves and DCs against fear effects. You can pause or resume this effect as part of any action you would typically use to stow or retrieve your banner. If your banner is destroyed or stolen, allies currently benefiting from its bonuses become [frightened](../Condition/Conditions.aspx-ID=76.md) 1. This effect has the [aura](../Trait/Traits.aspx-ID=542.md), [emotion](../Trait/Traits.aspx-ID=590.md), [mental](../Trait/Traits.aspx-ID=647.md), and [visual](../Trait/Traits.aspx-ID=727.md) traits.
...
At 1st level and every even-numbered level, you gain a [commander class feat](../Feat/Feats.aspx-Traits=855.md).
