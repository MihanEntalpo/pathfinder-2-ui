# Feats - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Feats.aspx-Traits=144&sort=level-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+prerequisite+summary+spoilers.htm`
...
Quick display options: [Short](./Feats.aspx-Traits=144&sort=level-asc+name-asc&display=short.md) | [Table](./Feats.aspx-Traits=144&sort=level-asc+name-asc&display=table&columns=pfs+source+rarity+trait+level+prerequisite+summary+spoilers.md) | [Grouped by Level](./Feats.aspx-Traits=144&sort=level-asc+name-asc&display=grouped&group-fields=level&link-layout=vertical-with-summary.md)
