# Stone-Breasted Owl - Monsters - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Monsters.aspx-ID=4238.htm`
...
# [Stone-Breasted Owl](./Monsters.aspx-ID=4238.md)Creature 5

[Uncommon](../Trait/Traits.aspx-ID=721.md) Small [Beast](../Trait/Traits.aspx-ID=547.md) [Incorporeal](../Trait/Traits.aspx-ID=632.md) [Spirit](../Trait/Traits.aspx-ID=737.md)
Source [Gatewalkers (Hardcover) pg. 269](../Source/Sources.aspx-ID=290.md)
[Recall Knowledge](../Rules/Rules.aspx-ID=2638.md) DC 22 (includes +2 from Uncommon) &bull; Beast ([Arcana](../Skill/Skills.aspx-ID=35.md), [Nature](../Skill/Skills.aspx-ID=43.md)), Spirit ([Occultism](../Skill/Skills.aspx-ID=44.md))
Perception +15; [darkvision](../MonsterAbility/MonsterAbilities.aspx-ID=59.md)
...
Skills [Acrobatics](../Skill/Skills.aspx-ID=34.md) +12, [Diplomacy](../Skill/Skills.aspx-ID=39.md) +13, [Nature](../Skill/Skills.aspx-ID=43.md) +14, [Survival](../Skill/Skills.aspx-ID=49.md) +12
Str +0, Dex +3, Con +0, Int +2, Wis +5, Cha +2

---

AC 22; Fort +9, Ref +12, Will +15
HP 75; Immunities [disease](../Trait/Traits.aspx-ID=578.md), [paralyzed](../Condition/Conditions.aspx-ID=85.md), [poison](../Trait/Traits.aspx-ID=669.md), precision; Resistances all damage 5 (except [force](../Trait/Traits.aspx-ID=610.md), [ghost touch](../Equipment/Equipment.aspx-ID=2840.md), or [spirit](../Trait/Traits.aspx-ID=737.md); double resistance vs. non-magical)
Warning Hoot [free-action] ([auditory](../Trait/Traits.aspx-ID=541.md)) Trigger The stone-breasted owl is about to roll a Perception or [Survival](../Skill/Skills.aspx-ID=49.md) check to determine initiative; Effect The stone-breasted owl lets out a hoot to warn allies, granting each ally a +1 circumstance bonus to their initiative roll.

---

Speed 10 feet, fly 40 feet
Melee [one-action] talon +13 [+9/+5] (agile, [finesse](../Trait/Traits.aspx-ID=602.md), [magical](../Trait/Traits.aspx-ID=644.md)), Damage 2d6+3 forcePrimal Innate Spells DC 25; 3rd [cleanse affliction](../Spell/Spells.aspx-ID=1467.md), heal (×2); 2nd [clear mind](../Spell/Spells.aspx-ID=1469.md), [sound body](../Spell/Spells.aspx-ID=1679.md); 1st [cleanse cuisine](../Spell/Spells.aspx-ID=1468.md), detect poison; Cantrips (2nd) guidance, [know the way](../Spell/Spells.aspx-ID=1582.md), stabilize; Constant (5th) [truespeech](../Spell/Spells.aspx-ID=1728.md)
Bond with Mortal [two-actions] (mental, [primal](../Trait/Traits.aspx-ID=676.md)) Frequency once per day; Effect The spirit guide forms a bond with a mortal creature. While the bond exists, the spirit guide's current and maximum Hit Points increase by 14, the spirit guide gains a +2 status bonus to attack and damage rolls, and the spirit guide and bonded mortal can communicate telepathically as long as they're on the same plane. The spirit guide can be bonded with only one mortal at a time, and can take this action again to end the bond or to form a new bond (which also ends the old bond). The bond ends if the spirit guide or the mortal dies.
This bond strengthens the spirit guide's connection to [the Universe](../Plane/Planes.aspx-ID=26.md). While bonded, the spirit guide loses the [incorporeal](../Trait/Traits.aspx-ID=632.md) and [spirit](../Trait/Traits.aspx-ID=737.md) traits, loses their immunities and resistances, and changes their Strikes to deal the appropriate physical damage (typically piercing or slashing) instead of force damage.Bonded Strike [two-actions] Requirements The spirit guide is currently Bonded with a Mortal; Effect The spirit guide makes a talon Strike. If this attack hits, the bonded mortal can spend their reaction to Strike the same target.Empowered Healing When the stone-breasted owl casts [heal](../Spell/Spells.aspx-ID=1554.md), it rolls d10s instead of d8s.
