# Commune - Rituals - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Rituals.aspx-ID=114.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)CommuneRitual 6

[Uncommon](../Trait/Traits.aspx-ID=721.md) [Prediction](../Trait/Traits.aspx-ID=674.md)
Source [Player Core pg. 301](../Source/Sources.aspx-ID=216.md)
Cast 1 day; Cost rare incense worth a total value of 150 gp; Secondary Casters 1
Primary Check Nature (master), Occultism (master), or Religion (master); Secondary Checks Nature, Occultism, or Religion (whichever is used for the primary check)
