# Caltrops - Equipment - Archives of Nethys: Pathfinder 2nd Edition Database

Source HTML: `docs/aonprd/Equipment.aspx-ID=2708.htm`
...
# [PFS.aspx.htm](../PFS/PFS.aspx.md)CaltropsItem 0

javascript:if(confirm(%27https://2e.aonprd.com/Images/Treasure/Caltrops.webp \n\nThis file was not retrieved by Teleport Ultra, because it was unavailable, or its retrieval was aborted, or the project was stopped too soon. \n\nDo you want to open it from the server?%27))window.location=%27https://2e.aonprd.com/Images/Treasure/Caltrops.webp%27Source [Player Core pg. 287](../Source/Sources.aspx-ID=216.md)
Price 3 sp
Hands 1; Bulk L

---

These four-pronged metal spikes can damage a creature's feet. You can scatter caltrops in an empty square adjacent to you with an Interact action. The first creature that moves into that square must succeed at a DC 14 [Acrobatics](../Skill/Skills.aspx-ID=34&Redirected=1.md) check or take 1d4 piercing damage and 1 [persistent bleed damage](../Condition/Conditions.aspx-ID=86&Redirected=1.md). A creature taking persistent bleed damage from caltrops takes a –5-foot penalty to its Speed. Spending an Interact action to pluck the caltrops free reduces the DC to stop the bleeding. Once a creature takes damage from caltrops, enough are ruined that other creatures moving into the square are safe. Deployed caltrops can be salvaged and reused if no creatures took damage from them. Otherwise, enough are ruined that they can't be salvaged.
